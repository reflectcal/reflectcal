...
rflect.cal.ui.EventPaneShort.prototype.enterDocument = function() {
  ...
  this.checkboxAllDay_ = this.getDomHelper().getElement(`${this.getId()}event-all-day`);
  ...
  if (isNativeTimeInput) {
    ...
    this.labelStart_ = this.getDomHelper().getElement(`${this.getId()}label-start`);
    this.labelEnd_ = this.getDomHelper().getElement(`${this.getId()}label-end`);
    ...
    this.labelEndDate_ = this.getDomHelper().getElement(`${this.getId()}label-end-date`);
    this.labelEndTime_ = this.getDomHelper().getElement(`${this.getId()}label-end-time`);

  }


  this.textAreaDesc_ = this.getDomHelper().getElement(`${this.getId()}event-description`);
 ...
 * @private
 */
rflect.cal.ui.EventPaneShort.prototype.getTimeInputsNative_ = function() {
  return [this.getDomHelper().getElement(`${this.getId()}event-start-date`),
      this.getDomHelper().getElement(`${this.getId()}event-start-datetime`),
      this.getDomHelper().getElement(`${this.getId()}event-end-date`),
      this.getDomHelper().getElement(`${this.getId()}event-end-datetime`)];
}
 ...
 * @private
 */
rflect.cal.ui.EventPaneShort.prototype.getTimeInputsCustom_ = function() {
  return [this.getDomHelper().getElement(`${this.getId()}event-start-date`),
      this.getDomHelper().getElement(`${this.getId()}event-start-time`),
      this.getDomHelper().getElement(`${this.getId()}event-end-date`),
      this.getDomHelper().getElement(`${this.getId()}event-end-time`)];
}
 ...
 * @private
 */
rflect.cal.ui.EventPaneShort.prototype.createTimeAutoCompletes_ = function(
 ...
 */
rflect.cal.ui.EventPaneShort.prototype.updateLabels_ = function(aAllDay){
  if (this.navigator_.isNativeTimeInput()) {
 ...
 * @private
 */
rflect.cal.ui.EventPaneShort.prototype.onInputFocus_ = function(aEvent) {
 ...
 * @private
 */
rflect.cal.ui.EventPaneShort.prototype.onTimeInputMouseDown_ = function(aEvent) {
  var target = /**@type{Element}*/(aEvent.target);
  if (target == this.inputStartTime_) {
    this.updateAC_(this.startTimeAC_);
  } else if (target == this.inputEndTime_) {
 ...
 */
rflect.cal.ui.EventPaneShort.prototype.updateAC_ = function(aAC) {
 ...
 * @param {goog.events.Event} aEvent Event object.
 */
rflect.cal.ui.EventPaneShort.prototype.onCheck_ = function(aEvent) {
 ...
 * @private
 */
rflect.cal.ui.EventPaneShort.prototype.showTimeInputs_ = function(aShow) {
  if (this.navigator_.isNativeTimeInput()){
 ...
 * @private
 */
rflect.cal.ui.EventPaneShort.prototype.displayDates_ = function() {
  var eh = this.eventManager.eventHolder;
 ...
 * @private
 */
rflect.cal.ui.EventPaneShort.prototype.displayDatesNative_ = function(aStartDate,
    aUIEndDate) {
  var formatStringDate = rflect.cal.ui.EventPaneShort.NATIVE_DATE_INPUT_FORMAT;
  ...
  rflect.cal.ui.EventPaneShort.markInput(true, this.inputStartDate_);
  rflect.cal.ui.EventPaneShort.markInput(true, this.inputStartDateTime_);
  rflect.cal.ui.EventPaneShort.markInput(true, this.inputEndDate_);
  rflect.cal.ui.EventPaneShort.markInput(true, this.inputEndDateTime_);
}
 ...
 * @see {rflect.cal.ui.EventPaneShort.prototype.displayDatesNative_}
 * @private
 */
rflect.cal.ui.EventPaneShort.prototype.displayDatesCustom_ = function(aStartDate,
    aUIEndDate) {
  var formatStringDate = rflect.cal.ui.EventPaneShort.getDateFormatString();
  ...
  rflect.cal.ui.EventPaneShort.markInput(true, this.inputStartDate_);
  rflect.cal.ui.EventPaneShort.markInput(true, this.inputStartTime_);
  rflect.cal.ui.EventPaneShort.markInput(true, this.inputEndDate_);
  rflect.cal.ui.EventPaneShort.markInput(true, this.inputEndTime_);
}
 ...
 * goog.date.DateTime}}
 */
rflect.cal.ui.EventPaneShort.prototype.scanDatesCustom_ = function() {
  var valid = false;
  ...
  rflect.cal.ui.EventPaneShort.markInput(validStartDate, this.inputStartDate_);
  rflect.cal.ui.EventPaneShort.markInput(validEndDate, this.inputEndDate_);
  rflect.cal.ui.EventPaneShort.markInput(validStartTime, this.inputStartTime_);
  rflect.cal.ui.EventPaneShort.markInput(validEndTime, this.inputEndTime_);
 ...
 * goog.date.DateTime}}
 */
rflect.cal.ui.EventPaneShort.prototype.scanDatesNative_ = function() {
  var valid = false;
  var startDate = new goog.date.DateTime();
  ...
  var parserDate = new goog.i18n.DateTimeParse(
      rflect.cal.ui.EventPaneShort.NATIVE_DATE_INPUT_FORMAT);
  ...
  rflect.cal.ui.EventPaneShort.markInput(validStartDate, this.inputStartDate_);
  rflect.cal.ui.EventPaneShort.markInput(validEndDate, this.inputEndDate_);
  rflect.cal.ui.EventPaneShort.markInput(validStartDateTime,
      this.inputStartDateTime_);
  rflect.cal.ui.EventPaneShort.markInput(validEndDateTime, this.inputEndDateTime_);
