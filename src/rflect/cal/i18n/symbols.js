...
/**
 * Date/time formatting symbols for locale en, mobile.
 */
rflect.cal.i18n.Symbols_en_MOBILE = {
  NOW: 'Now',
  NEW_EVENT: 'New event',
  DAY: 'Day',
  WEEK: 'Week',
...
/**
 * Date/time formatting symbols for locale ru, mobile.
 */
rflect.cal.i18n.Symbols_ru_MOBILE = {
  NOW: 'Сейчас',
  NEW_EVENT: 'Новое событие',
  DAY: 'День',
  WEEK: 'Неделя',
...
/**
 * Date/time formatting symbols for locale by, mobile.
 */
rflect.cal.i18n.Symbols_by_MOBILE = {
  NOW: 'Зараз',
  NEW_EVENT: 'Новая падзея',
  DAY: 'Дзень',
  WEEK: 'Тыдзень',
...
/**
 * Date/time formatting symbols for locale fr, mobile.
 */
rflect.cal.i18n.Symbols_fr_MOBILE = {
  NOW: 'présent',
  NEW_EVENT: 'Nouvel',
  DAY: 'Jour',
  WEEK: 'Semaine',
...
if (rflect.MOBILE) {
  ...
  if (goog.LOCALE == 'en') {
    rflect.cal.i18n.Symbols = rflect.cal.i18n.Symbols_en_MOBILE;
  } else if (goog.LOCALE == 'ru') {
    rflect.cal.i18n.Symbols = rflect.cal.i18n.Symbols_ru_MOBILE;
  } else if (goog.LOCALE == 'by') {
    rflect.cal.i18n.Symbols = rflect.cal.i18n.Symbols_by_MOBILE;
  } else if (goog.LOCALE == 'fr') {
    rflect.cal.i18n.Symbols = rflect.cal.i18n.Symbols_fr_MOBILE;
  } else {
    rflect.cal.i18n.Symbols = rflect.cal.i18n.Symbols_en_MOBILE;
  }
