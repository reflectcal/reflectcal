...
/**
 * @fileoverview Tristate checkbox widget. Implementation differs from Google in
 * following:
 * 1. Another default renderer.
 * 2. Could listen to touchend event for changing its state
 * TODO: touch-related functionality should be removed once touch events are
 * supported in Closure.
 */
...
goog.inherits(rflect.ui.Checkbox, goog.ui.Control);
 ...
 * @private
 */
rflect.ui.Checkbox.prototype.label_ = null;


/**
 * @return {goog.ui.Checkbox.State} Checked state of the checkbox.
 */
rflect.ui.Checkbox.prototype.getChecked = function() {
 ...
 * @override
 */
rflect.ui.Checkbox.prototype.isChecked = function() {
 ...
 */
rflect.ui.Checkbox.prototype.isUnchecked = function() {
 ...
 */
rflect.ui.Checkbox.prototype.isUndetermined = function() {
 ...
 * @override
 */
rflect.ui.Checkbox.prototype.setChecked = function(checked) {
 ...
 */
rflect.ui.Checkbox.prototype.setCheckedInternal = function(checked) {
 ...
 *     reacts to clicks.
 */
rflect.ui.Checkbox.prototype.setLabel = function(label) {
 ...
 * </ul>
 */
rflect.ui.Checkbox.prototype.toggle = function() {
...
/** @override */
rflect.ui.Checkbox.prototype.enterDocument = function() {
 ...
 * @override
 */
rflect.ui.Checkbox.prototype.setEnabled = function(enabled) {
 ...
 * @private
 */
rflect.ui.Checkbox.prototype.handleClickOrSpace_ = function(e) {
  e.stopPropagation();
...
/** @override */
rflect.ui.Checkbox.prototype.handleKeyEventInternal = function(e) {
