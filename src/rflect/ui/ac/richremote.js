...
goog.provide('rflect.ui.ac.RichRemote');

goog.require('rflect.ui.ac.AutoComplete');
goog.require('rflect.ui.ac.Remote');
goog.require('rflect.ui.ac.Renderer');
goog.require('rflect.ui.ac.RichInputHandler');
goog.require('rflect.ui.ac.RichRemoteArrayMatcher');
 ...
 *     "gost" => "ghost".
 * @constructor
 * @extends {rflect.ui.ac.Remote}
 */
rflect.ui.ac.RichRemote = function(url, input, opt_multi, opt_useSimilar) {
   ...
   * @type {rflect.ui.ac.Renderer}
   * @private
   */
  var renderer = new rflect.ui.ac.Renderer(null, customRenderer);
  this.renderer_ = renderer;

  /**
   * A remote matcher that parses rich results returned by the server.
   * @type {rflect.ui.ac.RichRemoteArrayMatcher}
   * @private
   */
  var matcher = new rflect.ui.ac.RichRemoteArrayMatcher(url,
      !opt_useSimilar);
  this.matcher_ = matcher;

  /**
   * An input handler that calls select on a row when it is selected.
   * @type {rflect.ui.ac.RichInputHandler}
   * @private
   */
  var inputhandler = new rflect.ui.ac.RichInputHandler(null, null,
      !!opt_multi, 300);
...
goog.inherits(rflect.ui.ac.RichRemote, rflect.ui.ac.Remote);
 ...
 */
rflect.ui.ac.RichRemote.prototype.setRowFilter = function(rowFilter) {
