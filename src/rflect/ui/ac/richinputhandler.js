...
goog.provide('rflect.ui.ac.RichInputHandler');
 ...
 * @constructor
 * @extends {rflect.ui.ac.InputHandler}
 */
rflect.ui.ac.RichInputHandler = function(opt_separators, opt_literals,
    opt_multi, opt_throttleTime) {
  rflect.ui.ac.InputHandler.call(this, opt_separators, opt_literals,
      opt_multi, opt_throttleTime);
};
goog.inherits(rflect.ui.ac.RichInputHandler, rflect.ui.ac.InputHandler);
 ...
 * @override
 */
rflect.ui.ac.RichInputHandler.prototype.selectRow = function(row) {
  var suppressUpdate = rflect.ui.ac.RichInputHandler.superClass_
