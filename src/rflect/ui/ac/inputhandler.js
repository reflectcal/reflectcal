...
goog.provide('rflect.ui.ac.InputHandler');
 ...
 */
rflect.ui.ac.InputHandler = function(opt_separators, opt_literals,
  ...
  this.setSeparators(opt_separators ||
      rflect.ui.ac.InputHandler.STANDARD_LIST_SEPARATORS);
...
goog.inherits(rflect.ui.ac.InputHandler, goog.Disposable);
 ...
 * @private
 */
rflect.ui.ac.InputHandler.REQUIRES_ASYNC_BLUR_ =
 ...
 * @const
 */
rflect.ui.ac.InputHandler.QUOTE_LITERALS = '"';


/**
 * The AutoComplete instance this inputhandler is associated with.
 * @type {rflect.ui.ac.AutoComplete}
 */
rflect.ui.ac.InputHandler.prototype.ac_;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.separators_;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.defaultSeparator_;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.trimmer_;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.separatorCheck_;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.whitespaceWrapEntries_ = true;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.generateNewTokenOnLiteral_ = true;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.upsideDown_ = false;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.separatorUpdates_ = true;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.separatorSelects_ = true;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.activeTimeoutId_ = null;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.activeElement_ = null;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.lastValue_ = '';
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.waitingForIme_ = false;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.rowJustSelected_ = false;
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.updateDuringTyping_ = true;


/**
 * Attach an instance of an AutoComplete
 * @param {rflect.ui.ac.AutoComplete} ac Autocomplete object.
 */
rflect.ui.ac.InputHandler.prototype.attachAutoComplete = function(ac) {
  this.ac_ = ac;
};
 ...
 * @return {rflect.ui.ac.AutoComplete} The associated autocomplete instance.
 */
rflect.ui.ac.InputHandler.prototype.getAutoComplete = function() {
  return this.ac_;
};
 ...
 */
rflect.ui.ac.InputHandler.prototype.getActiveElement = function() {
 ...
 */
rflect.ui.ac.InputHandler.prototype.getValue = function() {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setValue = function(value) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.getCursorPosition = function() {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setCursorPosition = function(pos) {
 ...
 *     input handler too.
 */
rflect.ui.ac.InputHandler.prototype.attachInput = function(target) {
 ...
 *     input handler from.
 */
rflect.ui.ac.InputHandler.prototype.detachInput = function(target) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.attachInputs = function(var_args) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.detachInputs = function(var_args) {
  for (var i = 0; i < arguments.length; i++) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.selectRow = function(row, opt_multi) {
 ...
 * @protected
 */
rflect.ui.ac.InputHandler.prototype.setTokenText =
...
/** @override */
rflect.ui.ac.InputHandler.prototype.disposeInternal = function() {
  rflect.ui.ac.InputHandler.superClass_.disposeInternal.call(this);
 ...
 */
rflect.ui.ac.InputHandler.prototype.setSeparators = function(separators) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setUpsideDown = function(upsideDown) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setWhitespaceWrapEntries =
    function(newValue) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setGenerateNewTokenOnLiteral =
    function(newValue) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setTrimmingRegExp = function(trimmer) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setPreventDefaultOnTab = function(newValue) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setSeparatorCompletes = function(newValue) {
 ...
 * @param {boolean} newValue Whether to autocomplete on separators.
 */
rflect.ui.ac.InputHandler.prototype.setSeparatorSelects = function(newValue) {
  this.separatorSelects_ = newValue;
};
 ...
 */
rflect.ui.ac.InputHandler.prototype.getThrottleTime = function() {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setRowJustSelected = function(justSelected) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setThrottleTime = function(time) {
  if (time < 0) {
    this.timer_.dispose();
    this.timer_ = null;
    return;
 ...
 */
rflect.ui.ac.InputHandler.prototype.getUpdateDuringTyping = function() {
 ...
 */
rflect.ui.ac.InputHandler.prototype.setUpdateDuringTyping = function(value) {
 ...
 * @protected
 */
rflect.ui.ac.InputHandler.prototype.handleKeyEvent = function(e) {
  switch (e.keyCode) {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.handleSeparator_ = function(e) {
 ...
 * @protected
 */
rflect.ui.ac.InputHandler.prototype.needKeyUpListener = function() {
  return false;
};
 ...
 * @protected
 */
rflect.ui.ac.InputHandler.prototype.handleKeyUp = function(e) {
  return false;
};
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.addEventHandlers_ = function() {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.removeEventHandlers_ = function() {
  this.eh_.unlisten(
      this.keyHandler_, goog.events.KeyHandler.EventType.KEY, this.onKey_);
 ...
 * @protected
 */
rflect.ui.ac.InputHandler.prototype.handleFocus = function(e) {
 ...
 * @protected
 */
rflect.ui.ac.InputHandler.prototype.processFocus = function(target) {
 ...
 * @protected
 */
rflect.ui.ac.InputHandler.prototype.handleBlur = function(opt_e) {
  // Phones running iOS prior to version 4.2.
  if (rflect.ui.ac.InputHandler.REQUIRES_ASYNC_BLUR_) {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.processBlur_ = function() {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.onTick_ = function(e) {
  this.update();
};
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.onKeyDownOnInactiveElement_ = function(e) {
  this.handleFocus(e);
};
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.onKey_ = function(e) {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.onKeyPress_ = function(e) {
  if (this.waitingForIme_ &&
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.onKeyUp_ = function(e) {
  if (this.waitingForIme_ &&
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.onMouseDown_ = function(e) {
  if (this.ac_) {
 ...
 * @protected
 */
rflect.ui.ac.InputHandler.prototype.handleMouseDown = function(e) {
};
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.startWaitingForIme_ = function() {
  if (this.waitingForIme_) {
    return;
  }
  this.eh_.listen(
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.stopWaitingForIme_ = function() {
  if (!this.waitingForIme_) {
    return;
  }
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.onIeKeyPress_ = function(e) {
 ...
 */
rflect.ui.ac.InputHandler.prototype.update = function(opt_force) {
  if (this.activeElement_ &&
 ...
 * @protected
 */
rflect.ui.ac.InputHandler.prototype.parseToken = function() {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.moveUp_ = function() {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.moveDown_ = function() {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.parseToken_ = function() {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.trim_ = function(text) {
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.getTokenIndex_ = function(text, caret) {
 ...
 * {@link rflect.ui.ac.InputHandler.prototype.separators_} and creates
 * an array of tokens.  Each token may contain additional whitespace and
 * formatting marks.  If necessary use
 * {@link rflect.ui.ac.InputHandler.prototype.trim_} to clean up the
 * entries.
 *
 ...
 * @private
 */
rflect.ui.ac.InputHandler.prototype.splitInput_ = function(text) {
  if (!this.multi_) {
    return [text];
  }
