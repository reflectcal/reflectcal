...
goog.provide('rflect.ui.ac.AutoComplete');
goog.provide('rflect.ui.ac.AutoComplete.EventType');
 ...
 */
rflect.ui.ac.AutoComplete = function(matcher, renderer, selectionHandler) {
  ...
  goog.events.listen(renderer, [
    rflect.ui.ac.AutoComplete.EventType.HILITE,
    rflect.ui.ac.AutoComplete.EventType.SELECT,
    rflect.ui.ac.AutoComplete.EventType.CANCEL_DISMISS,
    rflect.ui.ac.AutoComplete.EventType.DISMISS], this);
...
goog.inherits(rflect.ui.ac.AutoComplete, goog.events.EventTarget);
 ...
 * @private
 */
rflect.ui.ac.AutoComplete.prototype.maxMatches_ = 10;
 ...
 * @private
 */
rflect.ui.ac.AutoComplete.prototype.autoHilite_ = true;
 ...
 * @private
 */
rflect.ui.ac.AutoComplete.prototype.allowFreeSelect_ = false;
 ...
 * @private
 */
rflect.ui.ac.AutoComplete.prototype.wrap_ = false;
 ...
 * @private
 */
rflect.ui.ac.AutoComplete.prototype.triggerSuggestionsOnUpdate_ = false;
 ...
 * @enum {string}
 */
rflect.ui.ac.AutoComplete.EventType = {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.getRenderer = function() {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.handleEvent = function(e) {
  if (e.target == this.renderer_) {
    switch (e.type) {
      case rflect.ui.ac.AutoComplete.EventType.HILITE:
        this.hiliteId(/** @type {number} */ (e.row));
        break;

      case rflect.ui.ac.AutoComplete.EventType.SELECT:
        this.selectHilited();
        break;

      case rflect.ui.ac.AutoComplete.EventType.CANCEL_DISMISS:
        this.cancelDelayedDismiss();
        break;

      case rflect.ui.ac.AutoComplete.EventType.DISMISS:
        this.dismissOnDelay();
        break;
    }
  }
 ...
 */
rflect.ui.ac.AutoComplete.prototype.setMaxMatches = function(max) {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.setAutoHilite = function(autoHilite) {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.setAllowFreeSelect =
 ...
 */
rflect.ui.ac.AutoComplete.prototype.setWrap = function(wrap) {
  this.wrap_ = wrap;
};
 ...
 *     new suggestions.
 */
rflect.ui.ac.AutoComplete.prototype.setTriggerSuggestionsOnUpdate = function(
 ...
 *     field.
 */
rflect.ui.ac.AutoComplete.prototype.setToken = function(token, opt_fullString) {
 ...
 *     UI.
 */
rflect.ui.ac.AutoComplete.prototype.getTarget = function() {
  return this.target_;
};
 ...
 *     autocomplete UI.
 */
rflect.ui.ac.AutoComplete.prototype.setTarget = function(target) {
  this.target_ = target;
};
 ...
 */
rflect.ui.ac.AutoComplete.prototype.isOpen = function() {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.getRowCount = function() {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.hiliteNext = function() {
 ...
 * @return {boolean} Returns true on a successful hilite.
 */
rflect.ui.ac.AutoComplete.prototype.hilitePrev = function() {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.hiliteId = function(id) {
  this.hiliteId_ = id;
 ...
 */
rflect.ui.ac.AutoComplete.prototype.hiliteIndex = function(index) {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.selectHilited = function() {
  ...
  if (index != -1) {
    ...
    if (!suppressUpdate) {
      this.dispatchEvent({
        type: rflect.ui.ac.AutoComplete.EventType.UPDATE,
        row: selectedRow
      });
      if (this.triggerSuggestionsOnUpdate_) {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.hasHighlight = function() {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.dismiss = function() {
  this.hiliteId_ = -1;
  this.token_ = null;
  ...
  this.dispatchEvent(rflect.ui.ac.AutoComplete.EventType.SUGGESTIONS_UPDATE);
  this.dispatchEvent(rflect.ui.ac.AutoComplete.EventType.DISMISS);
};
 ...
 */
rflect.ui.ac.AutoComplete.prototype.dismissOnDelay = function() {
 ...
 * @private
 */
rflect.ui.ac.AutoComplete.prototype.immediatelyCancelDelayedDismiss_ =
    function() {
  if (this.dismissTimer_) {
    window.clearTimeout(this.dismissTimer_);
    this.dismissTimer_ = null;
 ...
 */
rflect.ui.ac.AutoComplete.prototype.cancelDelayedDismiss = function() {
...
/** @override */
rflect.ui.ac.AutoComplete.prototype.disposeInternal = function() {
  rflect.ui.ac.AutoComplete.superClass_.disposeInternal.call(this);
 ...
 *     Otherwise a RenderOptions object.
 */
rflect.ui.ac.AutoComplete.prototype.renderRows = function(rows, opt_options) {
 ...
 * @protected
 */
rflect.ui.ac.AutoComplete.prototype.getIndexOfId = function(id) {
 ...
 * @private
 */
rflect.ui.ac.AutoComplete.prototype.getIdOfIndex_ = function(index) {
 ...
 */
rflect.ui.ac.AutoComplete.prototype.attachInputs = function(var_args) {
  // Delegate to the input handler
  var inputHandler = /** @type {rflect.ui.ac.InputHandler} */
 ...
 */
rflect.ui.ac.AutoComplete.prototype.detachInputs = function(var_args) {
  // Delegate to the input handler
  var inputHandler = /** @type {rflect.ui.ac.InputHandler} */
      (this.selectionHandler_);
 ...
 */
rflect.ui.ac.AutoComplete.prototype.attachInputWithAnchor = function(
 ...
 */
rflect.ui.ac.AutoComplete.prototype.update = function(opt_force) {
  var inputHandler = /** @type {rflect.ui.ac.InputHandler} */
      (this.selectionHandler_);
