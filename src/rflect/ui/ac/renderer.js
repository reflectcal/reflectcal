...
goog.provide('rflect.ui.ac.Renderer');
goog.provide('rflect.ui.ac.Renderer.CustomRenderer');
 ...
 */
rflect.ui.ac.Renderer = function(opt_parentNode, opt_customRenderer,
...
goog.inherits(rflect.ui.ac.Renderer, goog.events.EventTarget);
 ...
 * @private
 */
rflect.ui.ac.Renderer.prototype.anchorElement_;
 ...
 * @private
 */
rflect.ui.ac.Renderer.prototype.widthProvider_;
 ...
 * @const
 */
rflect.ui.ac.Renderer.DELAY_BEFORE_MOUSEOVER = 300;
 ...
 */
rflect.ui.ac.Renderer.prototype.getElement = function() {
 ...
 */
rflect.ui.ac.Renderer.prototype.setWidthProvider = function(widthProvider) {
 ...
 */
rflect.ui.ac.Renderer.prototype.setTopAlign = function(align) {
 ...
 *     the target element.
 */
rflect.ui.ac.Renderer.prototype.getTopAlign = function() {
 ...
 */
rflect.ui.ac.Renderer.prototype.setRightAlign = function(align) {
 ...
 */
rflect.ui.ac.Renderer.prototype.getRightAlign = function() {
 ...
 */
rflect.ui.ac.Renderer.prototype.setUseStandardHighlighting =
 ...
 *     True by default.
 */
rflect.ui.ac.Renderer.prototype.setMatchWordBoundary =
 ...
 */
rflect.ui.ac.Renderer.prototype.setHighlightAllTokens =
 ...
 *     no animation).
 */
rflect.ui.ac.Renderer.prototype.setMenuFadeDuration = function(duration) {
 ...
 */
rflect.ui.ac.Renderer.prototype.setAnchorElement = function(anchor) {
 ...
 * @protected
 */
rflect.ui.ac.Renderer.prototype.getAnchorElement = function() {
 ...
 *     this node.
 */
rflect.ui.ac.Renderer.prototype.renderRows = function(rows, token, opt_target) {
  this.token_ = token;
  this.rows_ = rows;
  this.hilitedRow_ = -1;
 ...
 * Hide the object.
 */
rflect.ui.ac.Renderer.prototype.dismiss = function() {
  if (this.target_) {
 ...
 * Show the object.
 */
rflect.ui.ac.Renderer.prototype.show = function() {
  if (!this.visible_) {
    this.visible_ = true;
 ...
 */
rflect.ui.ac.Renderer.prototype.isVisible = function() {
 ...
 */
rflect.ui.ac.Renderer.prototype.hiliteRow = function(index) {
  var rowDiv = index >= 0 && index < this.rowDivs_.length ?
      this.rowDivs_[index] : undefined;

  var evtObj = {type: rflect.ui.ac.AutoComplete.EventType.ROW_HILITE,
    rowNode: rowDiv};
 ...
 */
rflect.ui.ac.Renderer.prototype.hiliteNone = function() {
 ...
 *     hilited.
 */
rflect.ui.ac.Renderer.prototype.hiliteId = function(id) {
  if (id == -1) {
    this.hiliteRow(-1);
  } else {
 ...
 * @private
 */
rflect.ui.ac.Renderer.prototype.setMenuClasses_ = function(elt) {
 ...
 * @private
 */
rflect.ui.ac.Renderer.prototype.maybeCreateElement_ = function() {
  if (!this.element_) {
 ...
 * down.
 */
rflect.ui.ac.Renderer.prototype.redraw = function() {
 ...
 * @protected
 */
rflect.ui.ac.Renderer.prototype.getAnchorCorner = function() {
 ...
 */
rflect.ui.ac.Renderer.prototype.reposition = function() {
 ...
 */
rflect.ui.ac.Renderer.prototype.setAutoPosition = function(auto) {
 ...
 * @protected
 */
rflect.ui.ac.Renderer.prototype.getAutoPosition = function() {
 ...
 * @protected
 */
rflect.ui.ac.Renderer.prototype.getTarget = function() {
  return this.target_;
};
 ...
 * @protected
 */
rflect.ui.ac.Renderer.prototype.disposeInternal = function() {
  if (this.element_) {
 ...
 * @private
 */
rflect.ui.ac.Renderer.prototype.renderRowContents_ =
 ...
 * @private
 */
rflect.ui.ac.Renderer.prototype.hiliteMatchingText_ =
 ...
 * @private
 */
rflect.ui.ac.Renderer.prototype.getTokenRegExp_ = function(tokenOrArray) {
  var token = '';
 ...
 */
rflect.ui.ac.Renderer.prototype.renderRowHtml = function(row, token) {
 ...
 * @private
 */
rflect.ui.ac.Renderer.prototype.getRowFromEventTarget_ = function(et) {
 ...
 * @private
 */
rflect.ui.ac.Renderer.prototype.handleMouseOver_ = function(e) {
  var index = this.getRowFromEventTarget_(/** @type {Element} */ (e.target));
  if (index >= 0) {
    if ((goog.now() - this.startRenderingRows_) <
        rflect.ui.ac.Renderer.DELAY_BEFORE_MOUSEOVER) {
      return;
    }

    this.dispatchEvent({
      type: rflect.ui.ac.AutoComplete.EventType.HILITE,
      row: this.rows_[index].id
    });
  }
};
 ...
 * @constructor
 */
rflect.ui.ac.Renderer.CustomRenderer = function() {
};


/**
 * Renders the autocomplete box. May be set to null.
 * @type {function(rflect.ui.ac.Renderer, Element, Array, string)|
 *        null|undefined}
 * param {rflect.ui.ac.Renderer} renderer The autocomplete renderer.
 ...
 */
rflect.ui.ac.Renderer.CustomRenderer.prototype.render = function(
 ...
 * @param {Node} node The node to render into.
 */
rflect.ui.ac.Renderer.CustomRenderer.prototype.renderRow =
    function(row, token, node) {
};
