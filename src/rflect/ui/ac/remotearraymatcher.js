...
goog.provide('rflect.ui.ac.RemoteArrayMatcher');
 ...
 */
rflect.ui.ac.RemoteArrayMatcher = function(url, opt_noSimilar) {
...
goog.inherits(rflect.ui.ac.RemoteArrayMatcher, goog.Disposable);
 ...
 * @private
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.method_ = 'GET';
 ...
 * @private
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.content_ = undefined;
 ...
 * @private
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.headers_ = null;
 ...
 * @private
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.lastListenerKey_ = null;
 ...
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.setMethod = function(method) {
  this.method_ = method;
};
 ...
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.setContent = function(content) {
 ...
 *     request.
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.setHeaders = function(headers) {
 ...
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.setTimeoutInterval =
    function(interval) {
 ...
 * @protected
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.buildUrl = function(uri,
 ...
 * @protected
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.shouldRequestMatches =
 ...
 * @protected
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.parseResponseText = function(
    responseText) {
 ...
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.xhrCallback = function(token,
    matchHandler, event) {
 ...
 */
rflect.ui.ac.RemoteArrayMatcher.prototype.requestMatchingRows =
...
/** @override */
rflect.ui.ac.RemoteArrayMatcher.prototype.disposeInternal = function() {
  this.xhr_.dispose();
  rflect.ui.ac.RemoteArrayMatcher.superClass_.disposeInternal.call(
      this);
};
