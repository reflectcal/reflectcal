...
rflect.Root.__create(function(var_arg, month, date, hour, minute, second,
     ...
     * @param {Date|rflect.datetime.DateTime}     Date object to compare [Required]
     * @return {number}  1 = this is greater than date. -1 = this is lessthan date. 0 = values are equal
     * @public
     */
    ...
    toJSONString: function DateTime_toJSONString() {
        return goog.json.serialize(this.toVector());
    },
