...
(function() {
  ...
  g._startDateTime = _.process(_.set([g.date,g.time,g.expression], g.generalDelimiter, g.whiteSpace), t.finish);
  g.start = function(s) {
    try {
...
Date._parse = Date.safeParse;
Date.safeParse = function(s) {
  var r = null;
  if (!s) {
    return null;
  }
