...
function $rflect$date$DateShim$$($dateObj_opt_year_or_date$$, $opt_month$$2$$, $opt_date$$3$$, $opt_hours$$3$$, $opt_minutes$$2$$, $opt_seconds$$2$$, $opt_milliseconds$$1$$) {
  $goog$isNumber$$($dateObj_opt_year_or_date$$) ? (this.setYear($dateObj_opt_year_or_date$$ || 0), this.setMonth($opt_month$$2$$ || 0), this.setDate($opt_date$$3$$ || 0), this.setHours($opt_hours$$3$$ || 0), this.setMinutes($opt_minutes$$2$$ || 0), this.setSeconds($opt_seconds$$2$$ || 0), this.setMilliseconds($opt_milliseconds$$1$$ || 0)) : ($dateObj_opt_year_or_date$$ = $goog$isObject$$($dateObj_opt_year_or_date$$) ? $dateObj_opt_year_or_date$$ : new Date, this.setYear($dateObj_opt_year_or_date$$.getFullYear()), 
  this.setMonth($dateObj_opt_year_or_date$$.getMonth()), this.setDate($dateObj_opt_year_or_date$$.getDate()), this.$day_$ = $dateObj_opt_year_or_date$$.getDay(), $dateObj_opt_year_or_date$$.setHours && (this.setHours($dateObj_opt_year_or_date$$.getHours()), this.setMinutes($dateObj_opt_year_or_date$$.getMinutes()), this.setSeconds($dateObj_opt_year_or_date$$.getSeconds()), this.setMilliseconds($dateObj_opt_year_or_date$$.getMilliseconds())))
}
