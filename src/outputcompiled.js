...
function $rflect$cal$MainPaneBuilder$buildWeekBlockChip_$$($aSb$$44$$, $aOffset$$22$$, $aEventManager$$2_event$$5$$, $aChip$$5$$, $aTotalCols_lastCol$$1$$, $aStartCol_width$$17$$, $aColSpan$$) {
  var $pixelStart_shift$$ = 24 * $aChip$$5$$.start / 30, $pixelHeight$$ = 24 * ($aChip$$5$$.end - $aChip$$5$$.start) / 30, $widthQuant$$ = 100 / $aTotalCols_lastCol$$1$$, $aEventManager$$2_event$$5$$ = $aEventManager$$2_event$$5$$.$events_$[$aChip$$5$$.$eventId$], $aTotalCols_lastCol$$1$$ = $aStartCol_width$$17$$ == $aTotalCols_lastCol$$1$$ - 1;
