...
$JSCompiler_prototypeAlias$$.$onMouseMove_$ = function $$JSCompiler_prototypeAlias$$$$onMouseMove_$$($aEvent$$15$$) {
  var $index$$63$$ = $rflect$string$getNumericIndex$$($aEvent$$15$$.target.id);
  this.$selectionMask$.$dragStarted_$ && $rflect$string$buildClassNameRe$$("goog-date-picker-date").test($aEvent$$15$$.target.className) && (this.$selectionMask$.update($index$$63$$), $aEvent$$15$$.preventDefault())
};
...
$JSCompiler_prototypeAlias$$.$onMainBodyAction_$ = function $$JSCompiler_prototypeAlias$$$$onMainBodyAction_$$($JSCompiler_StaticMethods_shiftToPoint$self$$inline_912_aEvent$$17$$) {
  switch($JSCompiler_StaticMethods_getId$$($JSCompiler_StaticMethods_shiftToPoint$self$$inline_912_aEvent$$17$$.target)) {
    case "nb1":
      $goog$events$dispatchEvent$$(this.$mainBody_$, "toppanenow") && ($JSCompiler_StaticMethods_shiftToPoint$self$$inline_912_aEvent$$17$$ = this.$timeManager$, $JSCompiler_StaticMethods_setBasis$$($JSCompiler_StaticMethods_shiftToPoint$self$$inline_912_aEvent$$17$$, $JSCompiler_alias_VOID$$), $JSCompiler_StaticMethods_calculatePeriodStart$$($JSCompiler_StaticMethods_shiftToPoint$self$$inline_912_aEvent$$17$$), $JSCompiler_StaticMethods_generateDaySeries$$($JSCompiler_StaticMethods_shiftToPoint$self$$inline_912_aEvent$$17$$), 
...
$JSCompiler_prototypeAlias$$.$onDateSelect_$ = function $$JSCompiler_prototypeAlias$$$$onDateSelect_$$($aEvent$$18$$) {
  ...
  if(!$aEvent$$18$$.$isInMask$) {
    ...
    $JSCompiler_StaticMethods_setBasis$$($JSCompiler_StaticMethods_shiftToPoint$self$$inline_921$$, $aEvent$$18$$.$date$);
