...
function $goog$string$padNumber$$($num$$4$$, $length$$14$$) {
  var $s$$13$$ = $goog$isDef$$($JSCompiler_alias_VOID$$) ? $num$$4$$.toFixed($JSCompiler_alias_VOID$$) : "" + $num$$4$$, $index$$44_length$$inline_52$$ = $s$$13$$.indexOf(".");
  -1 == $index$$44_length$$inline_52$$ && ($index$$44_length$$inline_52$$ = $s$$13$$.length);
  $index$$44_length$$inline_52$$ = Math.max(0, $length$$14$$ - $index$$44_length$$inline_52$$);
  return Array($index$$44_length$$inline_52$$ + 1).join("0") + $s$$13$$
}
...
if($ua$$inline_55$$ = $goog$userAgent$getUserAgentString$$()) {
  ...
  $goog$userAgent$detectedMobile_$$ = ($goog$userAgent$detectedWebkit_$$ = !$goog$userAgent$detectedOpera_$$ && -1 != $ua$$inline_55$$.indexOf("WebKit")) && -1 != $ua$$inline_55$$.indexOf("Mobile");
...
var $goog$userAgent$OPERA$$ = $goog$userAgent$detectedOpera_$$, $goog$userAgent$IE$$ = $goog$userAgent$detectedIe_$$, $goog$userAgent$GECKO$$ = $goog$userAgent$detectedGecko_$$, $goog$userAgent$WEBKIT$$ = $goog$userAgent$detectedWebkit_$$, $goog$userAgent$MOBILE$$ = $goog$userAgent$detectedMobile_$$, $goog$userAgent$PLATFORM$$, $navigator$$inline_58$$ = $goog$userAgent$getNavigator$$();
$goog$userAgent$PLATFORM$$ = $navigator$$inline_58$$ && $navigator$$inline_58$$.platform || "";
...
a: {
  ...
  if($goog$userAgent$IE$$) {
    var $docMode$$inline_65$$, $doc$$inline_855$$ = $goog$global$$.document;
    $docMode$$inline_65$$ = $doc$$inline_855$$ ? $doc$$inline_855$$.documentMode : $JSCompiler_alias_VOID$$;
    if($docMode$$inline_65$$ > parseFloat($version$$inline_61$$)) {
      $goog$userAgent$VERSION$$ = "" + $docMode$$inline_65$$;
      break a
    }
  }
...
function $goog$userAgent$isVersion$$($version$$8$$) {
  var $JSCompiler_temp$$47_order$$inline_70$$;
  if(!($JSCompiler_temp$$47_order$$inline_70$$ = $goog$userAgent$isVersionCache_$$[$version$$8$$])) {
    $JSCompiler_temp$$47_order$$inline_70$$ = 0;
    for(var $v1Subs$$inline_71$$ = $goog$string$trim$$("" + $goog$userAgent$VERSION$$).split("."), $v2Subs$$inline_72$$ = $goog$string$trim$$("" + $version$$8$$).split("."), $subCount$$inline_73$$ = Math.max($v1Subs$$inline_71$$.length, $v2Subs$$inline_72$$.length), $subIdx$$inline_74$$ = 0;0 == $JSCompiler_temp$$47_order$$inline_70$$ && $subIdx$$inline_74$$ < $subCount$$inline_73$$;$subIdx$$inline_74$$++) {
      ...
      do {
        ...
        $JSCompiler_temp$$47_order$$inline_70$$ = ((0 == $v1Comp$$inline_79$$[1].length ? 0 : parseInt($v1Comp$$inline_79$$[1], 10)) < (0 == $v2Comp$$inline_80$$[1].length ? 0 : parseInt($v2Comp$$inline_80$$[1], 10)) ? -1 : (0 == $v1Comp$$inline_79$$[1].length ? 0 : parseInt($v1Comp$$inline_79$$[1], 10)) > (0 == $v2Comp$$inline_80$$[1].length ? 0 : parseInt($v2Comp$$inline_80$$[1], 10)) ? 1 : 0) || ((0 == $v1Comp$$inline_79$$[2].length) < (0 == $v2Comp$$inline_80$$[2].length) ? -1 : (0 == $v1Comp$$inline_79$$[2].length) > 
        (0 == $v2Comp$$inline_80$$[2].length) ? 1 : 0) || ($v1Comp$$inline_79$$[2] < $v2Comp$$inline_80$$[2] ? -1 : $v1Comp$$inline_79$$[2] > $v2Comp$$inline_80$$[2] ? 1 : 0)
      }while(0 == $JSCompiler_temp$$47_order$$inline_70$$)
    }
    $JSCompiler_temp$$47_order$$inline_70$$ = $goog$userAgent$isVersionCache_$$[$version$$8$$] = 0 <= $JSCompiler_temp$$47_order$$inline_70$$
  }
  return $JSCompiler_temp$$47_order$$inline_70$$
}
...
function $goog$asserts$assert$$($condition$$1$$, $opt_message$$8$$, $var_args$$35$$) {
  if(!$condition$$1$$) {
    var $givenArgs$$inline_87$$ = Array.prototype.slice.call(arguments, 2), $message$$inline_90$$ = "Assertion failed";
    if($opt_message$$8$$) {
      var $message$$inline_90$$ = $message$$inline_90$$ + (": " + $opt_message$$8$$), $args$$inline_91$$ = $givenArgs$$inline_87$$
    }
    $JSCompiler_alias_THROW$$(new $goog$asserts$AssertionError$$("" + $message$$inline_90$$, $args$$inline_91$$ || []))
  }
}
...
$JSCompiler_prototypeAlias$$.$init$ = function $$JSCompiler_prototypeAlias$$$$init$$($e$$11$$, $opt_currentTarget$$1$$) {
  ...
  if($relatedTarget$$) {
    if($goog$userAgent$GECKO$$) {
      var $JSCompiler_inline_result$$96$$;
      a: {
        try {
          $goog$reflect$sinkValue$$($relatedTarget$$.nodeName);
          $JSCompiler_inline_result$$96$$ = $JSCompiler_alias_TRUE$$;
          break a
        }catch($e$$inline_99$$) {
        }
        $JSCompiler_inline_result$$96$$ = $JSCompiler_alias_FALSE$$
      }
      $JSCompiler_inline_result$$96$$ || ($relatedTarget$$ = $JSCompiler_alias_NULL$$)
    }
  }else {
...
function $goog$events$handleBrowserEvent_$$($key$$46$$, $opt_evt$$) {
  ...
  if(!$goog$events$BrowserFeature$HAS_W3C_EVENT_SUPPORT$$) {
    ...
    if($hasCapture$$2$$) {
      ...
      a: {
        var $evt$$14_useReturnValue$$inline_102$$ = $JSCompiler_alias_FALSE$$;
        if(0 == $ieEvent_retval$$1$$.keyCode) {
          try {
            $ieEvent_retval$$1$$.keyCode = -1;
            break a
          }catch($ex$$inline_103$$) {
            $evt$$14_useReturnValue$$inline_102$$ = $JSCompiler_alias_TRUE$$
          }
        }
        if($evt$$14_useReturnValue$$inline_102$$ || $ieEvent_retval$$1$$.returnValue == $JSCompiler_alias_VOID$$) {
          $ieEvent_retval$$1$$.returnValue = $JSCompiler_alias_TRUE$$
        }
      }
    }
    $evt$$14_useReturnValue$$inline_102$$ = new $goog$events$BrowserEvent$$;
    $evt$$14_useReturnValue$$inline_102$$.$init$($ieEvent_retval$$1$$, this);
    $ieEvent_retval$$1$$ = $JSCompiler_alias_TRUE$$;
    try {
      if($hasCapture$$2$$) {
        for(var $ancestors$$1$$ = [], $parent$$3$$ = $evt$$14_useReturnValue$$inline_102$$.currentTarget;$parent$$3$$;$parent$$3$$ = $parent$$3$$.parentNode) {
          $ancestors$$1$$.push($parent$$3$$)
        }
        $targetsMap$$1$$ = $map$$6$$[$JSCompiler_alias_TRUE$$];
        $targetsMap$$1$$.$remaining_$ = $targetsMap$$1$$.$count_$;
        for(var $i$$59$$ = $ancestors$$1$$.length - 1;!$evt$$14_useReturnValue$$inline_102$$.$propagationStopped_$ && 0 <= $i$$59$$ && $targetsMap$$1$$.$remaining_$;$i$$59$$--) {
          $evt$$14_useReturnValue$$inline_102$$.currentTarget = $ancestors$$1$$[$i$$59$$], $ieEvent_retval$$1$$ &= $goog$events$fireListeners_$$($targetsMap$$1$$, $ancestors$$1$$[$i$$59$$], $be$$1_type$$67$$, $JSCompiler_alias_TRUE$$, $evt$$14_useReturnValue$$inline_102$$)
        }
        if($hasBubble$$1$$) {
          $targetsMap$$1$$ = $map$$6$$[$JSCompiler_alias_FALSE$$];
          $targetsMap$$1$$.$remaining_$ = $targetsMap$$1$$.$count_$;
          for($i$$59$$ = 0;!$evt$$14_useReturnValue$$inline_102$$.$propagationStopped_$ && $i$$59$$ < $ancestors$$1$$.length && $targetsMap$$1$$.$remaining_$;$i$$59$$++) {
            $evt$$14_useReturnValue$$inline_102$$.currentTarget = $ancestors$$1$$[$i$$59$$], $ieEvent_retval$$1$$ &= $goog$events$fireListeners_$$($targetsMap$$1$$, $ancestors$$1$$[$i$$59$$], $be$$1_type$$67$$, $JSCompiler_alias_FALSE$$, $evt$$14_useReturnValue$$inline_102$$)
          }
        }
      }else {
        $ieEvent_retval$$1$$ = $goog$events$fireListener$$($listener$$41$$, $evt$$14_useReturnValue$$inline_102$$)
      }
    }finally {
      $ancestors$$1$$ && ($ancestors$$1$$.length = 0), $evt$$14_useReturnValue$$inline_102$$.$dispose$()
    }
...
$JSCompiler_prototypeAlias$$.$getWeekNumber$ = function $$JSCompiler_prototypeAlias$$$$getWeekNumber$$() {
  var $cutoffSameWeek$$inline_114_d$$inline_112$$ = new Date(this.getFullYear(), this.getMonth(), this.getDate()), $firstday$$inline_113$$ = this.$firstDayOfWeek_$ || 0, $cutoffSameWeek$$inline_114_d$$inline_112$$ = $cutoffSameWeek$$inline_114_d$$inline_112$$.valueOf() + 864E5 * (((this.$firstWeekCutOffDay_$ || 3) - $firstday$$inline_113$$ + 7) % 7 - (($cutoffSameWeek$$inline_114_d$$inline_112$$.getDay() + 6) % 7 - $firstday$$inline_113$$ + 7) % 7);
  return Math.floor(Math.round(($cutoffSameWeek$$inline_114_d$$inline_112$$ - (new Date((new Date($cutoffSameWeek$$inline_114_d$$inline_112$$)).getFullYear(), 0, 1)).valueOf()) / 864E5) / 7) + 1
};
...
$rflect$cal$events$EventManager$$.prototype.$run$ = function $$rflect$cal$events$EventManager$$$$$run$$() {
  ...
  this.$allDayChips$[0] = [];
  for(var $allDayChipsCounter$$inline_131_allDayChipsLength$$ = this.$weekChips$.length = 0, $counter$$9$$ = 0, $length$$26$$ = $daySeries$$.length;$counter$$9$$ < $length$$26$$;$counter$$9$$++) {
    var $counter$$inline_133_yearKey$$ = $daySeries$$[$counter$$9$$].getFullYear();
    if($JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$)) {
      var $dayOfYearKey_length$$inline_134$$ = $daySeries$$[$counter$$9$$].$getDayOfYear$();
      this.$dayChips$.push($rflect$cal$events$EventManager$getNestedChips_$$(this.$chipsByDay_$, $counter$$inline_133_yearKey$$, $dayOfYearKey_length$$inline_134$$) || []);
      var $aKnownChipIds$$inline_124_weekKey$$ = $knownChipsIds$$, $aDayNumber$$inline_127$$ = $counter$$9$$, $aTotalDays$$inline_128$$ = $length$$26$$, $allDayChips$$inline_130$$ = this.$allDayChips$[0], $chips$$inline_132$$ = $JSCompiler_alias_VOID$$;
      if($chips$$inline_132$$ = $rflect$cal$events$EventManager$getNestedChips_$$(this.$allDayChipsByDay_$, $counter$$inline_133_yearKey$$, $dayOfYearKey_length$$inline_134$$)) {
        $counter$$inline_133_yearKey$$ = 0;
        for($dayOfYearKey_length$$inline_134$$ = $chips$$inline_132$$.length;$counter$$inline_133_yearKey$$ < $dayOfYearKey_length$$inline_134$$;$counter$$inline_133_yearKey$$++) {
          var $id$$inline_135_newChip$$inline_136$$ = $chips$$inline_132$$[$counter$$inline_133_yearKey$$].$eventId$;
          $aKnownChipIds$$inline_124_weekKey$$[$id$$inline_135_newChip$$inline_136$$] || ($aKnownChipIds$$inline_124_weekKey$$[$id$$inline_135_newChip$$inline_136$$] = 1, $id$$inline_135_newChip$$inline_136$$ = $chips$$inline_132$$[$counter$$inline_133_yearKey$$].$clone$(), $id$$inline_135_newChip$$inline_136$$.start = $aDayNumber$$inline_127$$, $id$$inline_135_newChip$$inline_136$$.$endIsCut$ = $aTotalDays$$inline_128$$ - $aDayNumber$$inline_127$$ < $id$$inline_135_newChip$$inline_136$$.end, $id$$inline_135_newChip$$inline_136$$.end = 
          $id$$inline_135_newChip$$inline_136$$.$endIsCut$ ? $aTotalDays$$inline_128$$ : $aDayNumber$$inline_127$$ + $id$$inline_135_newChip$$inline_136$$.end, $allDayChips$$inline_130$$[$allDayChipsCounter$$inline_131_allDayChipsLength$$++] = $id$$inline_135_newChip$$inline_136$$)
        }
      }
    }else {
      $JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$) && 0 == $counter$$9$$ % 7 && ($aKnownChipIds$$inline_124_weekKey$$ = $daySeries$$[$counter$$9$$].$getWeekNumber$(), this.$weekChips$.push($rflect$cal$events$EventManager$getNestedChips_$$(this.$chipsByWeek_$, $counter$$inline_133_yearKey$$, $aKnownChipIds$$inline_124_weekKey$$) || []))
    }
  }
};
...
function $JSCompiler_StaticMethods_unlisten$$($JSCompiler_StaticMethods_unlisten$self$$, $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$, $i$$inline_145_type$$71$$, $listener$$inline_140_opt_fn$$2$$, $capture$$inline_143_opt_capture$$3$$, $opt_handler$$11_opt_handler$$inline_142$$) {
  if($goog$isArray$$($i$$inline_145_type$$71$$)) {
    for(var $i$$62$$ = 0;$i$$62$$ < $i$$inline_145_type$$71$$.length;$i$$62$$++) {
      $JSCompiler_StaticMethods_unlisten$$($JSCompiler_StaticMethods_unlisten$self$$, $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$, $i$$inline_145_type$$71$$[$i$$62$$], $listener$$inline_140_opt_fn$$2$$, $capture$$inline_143_opt_capture$$3$$, $opt_handler$$11_opt_handler$$inline_142$$)
    }
  }else {
    a: {
      $listener$$inline_140_opt_fn$$2$$ = $listener$$inline_140_opt_fn$$2$$ || $JSCompiler_StaticMethods_unlisten$self$$;
      $opt_handler$$11_opt_handler$$inline_142$$ = $opt_handler$$11_opt_handler$$inline_142$$ || $JSCompiler_StaticMethods_unlisten$self$$.$handler_$ || $JSCompiler_StaticMethods_unlisten$self$$;
      $capture$$inline_143_opt_capture$$3$$ = !!$capture$$inline_143_opt_capture$$3$$;
      if($key$$49_listener$$43_listenerArray$$inline_144_src$$18$$ = $goog$events$getListeners_$$($key$$49_listener$$43_listenerArray$$inline_144_src$$18$$, $i$$inline_145_type$$71$$, $capture$$inline_143_opt_capture$$3$$)) {
        for($i$$inline_145_type$$71$$ = 0;$i$$inline_145_type$$71$$ < $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$.length;$i$$inline_145_type$$71$$++) {
          if(!$key$$49_listener$$43_listenerArray$$inline_144_src$$18$$[$i$$inline_145_type$$71$$].$removed$ && $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$[$i$$inline_145_type$$71$$].$listener$ == $listener$$inline_140_opt_fn$$2$$ && $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$[$i$$inline_145_type$$71$$].capture == $capture$$inline_143_opt_capture$$3$$ && $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$[$i$$inline_145_type$$71$$].$handler$ == $opt_handler$$11_opt_handler$$inline_142$$) {
            $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$ = $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$[$i$$inline_145_type$$71$$];
            break a
          }
        }
      }
      $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$ = $JSCompiler_alias_NULL$$
    }
    $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$ && ($key$$49_listener$$43_listenerArray$$inline_144_src$$18$$ = $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$.key, $goog$events$unlistenByKey$$($key$$49_listener$$43_listenerArray$$inline_144_src$$18$$), $goog$array$remove$$($JSCompiler_StaticMethods_unlisten$self$$.$keys_$, $key$$49_listener$$43_listenerArray$$inline_144_src$$18$$))
  }
...
function $goog$dom$classes$add$$($element$$7$$, $var_args$$50$$) {
  for(var $classes$$ = $goog$dom$classes$get$$($element$$7$$), $args$$3_args$$inline_148$$ = $goog$array$slice$$(arguments, 1), $expectedCount$$ = $classes$$.length + $args$$3_args$$inline_148$$.length, $classes$$inline_147$$ = $classes$$, $i$$inline_149$$ = 0;$i$$inline_149$$ < $args$$3_args$$inline_148$$.length;$i$$inline_149$$++) {
    $goog$array$contains$$($classes$$inline_147$$, $args$$3_args$$inline_148$$[$i$$inline_149$$]) || $classes$$inline_147$$.push($args$$3_args$$inline_148$$[$i$$inline_149$$])
  }
...
function $JSCompiler_StaticMethods_getDocumentScroll$$($JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_153$$) {
  var $doc$$inline_152_win$$inline_154$$ = $JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_153$$.$document_$, $JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_153$$ = !$goog$userAgent$WEBKIT$$ && $goog$dom$isCss1CompatMode_$$($doc$$inline_152_win$$inline_154$$) ? $doc$$inline_152_win$$inline_154$$.documentElement : $doc$$inline_152_win$$inline_154$$.body, $doc$$inline_152_win$$inline_154$$ = $doc$$inline_152_win$$inline_154$$.parentWindow || $doc$$inline_152_win$$inline_154$$.defaultView;
  return new $goog$math$Coordinate$$($doc$$inline_152_win$$inline_154$$.pageXOffset || $JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_153$$.scrollLeft, $doc$$inline_152_win$$inline_154$$.pageYOffset || $JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_153$$.scrollTop)
}
...
function $JSCompiler_StaticMethods_getFirstElementChild$$($JSCompiler_StaticMethods_getFirstElementChild$self$$, $node$$6$$) {
  var $JSCompiler_temp$$45_node$$inline_156$$;
  if($node$$6$$.firstElementChild != $JSCompiler_alias_VOID$$) {
    $JSCompiler_temp$$45_node$$inline_156$$ = $node$$6$$.firstElementChild
  }else {
    for($JSCompiler_temp$$45_node$$inline_156$$ = $node$$6$$.firstChild;$JSCompiler_temp$$45_node$$inline_156$$ && 1 != $JSCompiler_temp$$45_node$$inline_156$$.nodeType;) {
      $JSCompiler_temp$$45_node$$inline_156$$ = $JSCompiler_temp$$45_node$$inline_156$$.nextSibling
    }
  }
  return $JSCompiler_temp$$45_node$$inline_156$$
}
...
function $goog$style$getVisibleRectForElement$$($el$$6_element$$43$$) {
  for(var $visibleRect$$ = new $goog$math$Box$$(0, Infinity, Infinity, 0), $dom_winSize$$ = $goog$dom$getDomHelper$$($el$$6_element$$43$$), $body$$2_scrollX$$ = $dom_winSize$$.$document_$.body, $documentElement$$ = $dom_winSize$$.$document_$.documentElement, $scrollEl_scrollY$$ = !$goog$userAgent$WEBKIT$$ && $goog$dom$isCss1CompatMode_$$($dom_winSize$$.$document_$) ? $dom_winSize$$.$document_$.documentElement : $dom_winSize$$.$document_$.body;$el$$6_element$$43$$ = $goog$style$getOffsetParent$$($el$$6_element$$43$$);) {
    if((!$goog$userAgent$IE$$ || 0 != $el$$6_element$$43$$.clientWidth) && (!$goog$userAgent$WEBKIT$$ || 0 != $el$$6_element$$43$$.clientHeight || $el$$6_element$$43$$ != $body$$2_scrollX$$) && $el$$6_element$$43$$ != $body$$2_scrollX$$ && $el$$6_element$$43$$ != $documentElement$$ && "visible" != $goog$style$getStyle_$$($el$$6_element$$43$$, "overflow")) {
      var $pos$$1$$ = $goog$style$getPageOffset$$($el$$6_element$$43$$), $client_el$$inline_159$$;
      $client_el$$inline_159$$ = $el$$6_element$$43$$;
      if($goog$userAgent$GECKO$$ && !$goog$userAgent$isVersion$$("1.9")) {
        var $left$$inline_160$$ = parseFloat($goog$style$getComputedStyle$$($client_el$$inline_159$$, "borderLeftWidth"));
        if($goog$style$isRightToLeft$$($client_el$$inline_159$$)) {
          var $scrollbarWidth$$inline_161$$ = $client_el$$inline_159$$.offsetWidth - $client_el$$inline_159$$.clientWidth - $left$$inline_160$$ - parseFloat($goog$style$getComputedStyle$$($client_el$$inline_159$$, "borderRightWidth")), $left$$inline_160$$ = $left$$inline_160$$ + $scrollbarWidth$$inline_161$$
        }
        $client_el$$inline_159$$ = new $goog$math$Coordinate$$($left$$inline_160$$, parseFloat($goog$style$getComputedStyle$$($client_el$$inline_159$$, "borderTopWidth")))
      }else {
        $client_el$$inline_159$$ = new $goog$math$Coordinate$$($client_el$$inline_159$$.clientLeft, $client_el$$inline_159$$.clientTop)
      }
      $pos$$1$$.x += $client_el$$inline_159$$.x;
      $pos$$1$$.y += $client_el$$inline_159$$.y;
...
function $JSCompiler_StaticMethods_setId$$($JSCompiler_StaticMethods_setId$self$$, $id$$4$$) {
  if($JSCompiler_StaticMethods_setId$self$$.$parent_$ && $JSCompiler_StaticMethods_setId$self$$.$parent_$.$childIndex_$) {
    var $obj$$inline_857$$ = $JSCompiler_StaticMethods_setId$self$$.$parent_$.$childIndex_$, $key$$inline_858$$ = $JSCompiler_StaticMethods_setId$self$$.$id_$;
    $key$$inline_858$$ in $obj$$inline_857$$ && delete $obj$$inline_857$$[$key$$inline_858$$];
...
function $JSCompiler_StaticMethods_addChild$$($JSCompiler_StaticMethods_addChild$self$$, $child$$11$$) {
  var $index$$inline_178$$ = $JSCompiler_StaticMethods_addChild$self$$.$children_$ ? $JSCompiler_StaticMethods_addChild$self$$.$children_$.length : 0;
  ...
  (0 > $index$$inline_178$$ || $index$$inline_178$$ > ($JSCompiler_StaticMethods_addChild$self$$.$children_$ ? $JSCompiler_StaticMethods_addChild$self$$.$children_$.length : 0)) && $JSCompiler_alias_THROW$$(Error("Child component index out of bounds"));
  ...
  if($child$$11$$.getParent() == $JSCompiler_StaticMethods_addChild$self$$) {
    var $contentElement$$inline_180_key$$inline_865$$ = $JSCompiler_StaticMethods_getId$$($child$$11$$);
    $JSCompiler_StaticMethods_addChild$self$$.$childIndex_$[$contentElement$$inline_180_key$$inline_865$$] = $child$$11$$;
  ...
  $goog$array$splice$$($JSCompiler_StaticMethods_addChild$self$$.$children_$, $index$$inline_178$$, 0, $child$$11$$);
  $child$$11$$.$inDocument_$ && $JSCompiler_StaticMethods_addChild$self$$.$inDocument_$ && $child$$11$$.getParent() == $JSCompiler_StaticMethods_addChild$self$$ ? ($contentElement$$inline_180_key$$inline_865$$ = $JSCompiler_StaticMethods_addChild$self$$.$getContentElement$(), $contentElement$$inline_180_key$$inline_865$$.insertBefore($child$$11$$.$getElement$(), $contentElement$$inline_180_key$$inline_865$$.childNodes[$index$$inline_178$$] || $JSCompiler_alias_NULL$$)) : $JSCompiler_StaticMethods_addChild$self$$.$inDocument_$ && 
...
$JSCompiler_prototypeAlias$$.removeChild = function $$JSCompiler_prototypeAlias$$$removeChild$($child$$15$$, $opt_unrender$$) {
  if($child$$15$$) {
    ...
    if($id$$7$$ && $child$$15$$) {
      var $obj$$inline_872$$ = this.$childIndex_$;
      $id$$7$$ in $obj$$inline_872$$ && delete $obj$$inline_872$$[$id$$7$$];
...
$JSCompiler_prototypeAlias$$.$decorate$ = function $$JSCompiler_prototypeAlias$$$$decorate$$($control$$3$$, $element$$79$$) {
  ...
  $goog$array$forEach$$($classNames$$1$$, function($className$$18_state$$inline_201$$) {
    if(!$hasRendererClassName$$ && $className$$18_state$$inline_201$$ == $rendererClassName$$) {
      ...
      if(!$hasStructuralClassName$$ && $className$$18_state$$inline_201$$ == $structuralClassName$$) {
        ...
        if(!this.$stateByClass_$) {
          ...
          var $obj$$inline_1144$$ = this.$classByState_$, $transposed$$inline_1145$$ = {}, $key$$inline_1146$$;
          for($key$$inline_1146$$ in $obj$$inline_1144$$) {
            $transposed$$inline_1145$$[$obj$$inline_1144$$[$key$$inline_1146$$]] = $key$$inline_1146$$
          }
          this.$stateByClass_$ = $transposed$$inline_1145$$
        }
        $className$$18_state$$inline_201$$ = parseInt(this.$stateByClass_$[$className$$18_state$$inline_201$$], 10);
        $state$$2$$ = $JSCompiler_temp_const$$14$$ | (isNaN($className$$18_state$$inline_201$$) ? 0 : $className$$18_state$$inline_201$$)
      }
    }
  }, this);
...
$JSCompiler_prototypeAlias$$.$setAllowTextSelection$ = function $$JSCompiler_prototypeAlias$$$$setAllowTextSelection$$($element$$82$$, $allow$$) {
  var $unselectable$$inline_213_value$$inline_216$$ = !$allow$$, $descendants$$inline_215$$ = $goog$userAgent$IE$$ || $goog$userAgent$OPERA$$ ? $element$$82$$.getElementsByTagName("*") : $JSCompiler_alias_NULL$$;
  if($goog$style$unselectableStyle_$$) {
    if($unselectable$$inline_213_value$$inline_216$$ = $unselectable$$inline_213_value$$inline_216$$ ? "none" : "", $element$$82$$.style[$goog$style$unselectableStyle_$$] = $unselectable$$inline_213_value$$inline_216$$, $descendants$$inline_215$$) {
    ...
    if($goog$userAgent$IE$$ || $goog$userAgent$OPERA$$) {
      if($unselectable$$inline_213_value$$inline_216$$ = $unselectable$$inline_213_value$$inline_216$$ ? "on" : "", $element$$82$$.setAttribute("unselectable", $unselectable$$inline_213_value$$inline_216$$), $descendants$$inline_215$$) {
...
function $JSCompiler_StaticMethods_getClassNames$$($JSCompiler_StaticMethods_getClassNames$self$$, $control$$10$$) {
  var $cssClass_extraClassNames$$1_state$$inline_225$$ = $JSCompiler_StaticMethods_getClassNames$self$$.$getCssClass$(), $classNames$$2$$ = [$cssClass_extraClassNames$$1_state$$inline_225$$], $classNames$$inline_226_structuralCssClass$$ = $JSCompiler_StaticMethods_getClassNames$self$$.$getCssClass$();
  $classNames$$inline_226_structuralCssClass$$ != $cssClass_extraClassNames$$1_state$$inline_225$$ && $classNames$$2$$.push($classNames$$inline_226_structuralCssClass$$);
  $cssClass_extraClassNames$$1_state$$inline_225$$ = $control$$10$$.$state_$;
  for($classNames$$inline_226_structuralCssClass$$ = [];$cssClass_extraClassNames$$1_state$$inline_225$$;) {
    var $mask$$inline_227$$ = $cssClass_extraClassNames$$1_state$$inline_225$$ & -$cssClass_extraClassNames$$1_state$$inline_225$$;
    $classNames$$inline_226_structuralCssClass$$.push($JSCompiler_StaticMethods_getClassForState$$($JSCompiler_StaticMethods_getClassNames$self$$, $mask$$inline_227$$));
    $cssClass_extraClassNames$$1_state$$inline_225$$ &= ~$mask$$inline_227$$
  }
  $classNames$$2$$.push.apply($classNames$$2$$, $classNames$$inline_226_structuralCssClass$$);
  ($cssClass_extraClassNames$$1_state$$inline_225$$ = $control$$10$$.$extraClassNames_$) && $classNames$$2$$.push.apply($classNames$$2$$, $cssClass_extraClassNames$$1_state$$inline_225$$);
...
function $goog$ui$Control$$($content$$3$$, $JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$, $opt_domHelper$$1$$) {
  $goog$ui$Component$$.call(this, $opt_domHelper$$1$$);
  if(!$JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$) {
    for(var $JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$ = this.constructor, $key$$inline_234_rendererCtor$$inline_235$$;$JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$;) {
      $key$$inline_234_rendererCtor$$inline_235$$ = $goog$getUid$$($JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$);
      if($key$$inline_234_rendererCtor$$inline_235$$ = $goog$ui$registry$defaultRenderers_$$[$key$$inline_234_rendererCtor$$inline_235$$]) {
        break
      }
      $JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$ = $JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$.$superClass_$ ? $JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$.$superClass_$.constructor : $JSCompiler_alias_NULL$$
    }
    $JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$ = $key$$inline_234_rendererCtor$$inline_235$$ ? $goog$isFunction$$($key$$inline_234_rendererCtor$$inline_235$$.$getInstance$) ? $key$$inline_234_rendererCtor$$inline_235$$.$getInstance$() : new $key$$inline_234_rendererCtor$$inline_235$$ : $JSCompiler_alias_NULL$$
  }
  this.$renderer_$ = $JSCompiler_temp$$42_componentCtor$$inline_233_opt_renderer$$;
...
$JSCompiler_prototypeAlias$$.$createDom$ = function $$JSCompiler_prototypeAlias$$$$createDom$$() {
  ...
  var $ariaRole$$inline_262$$ = this.$preferredAriaRole_$ || this.$renderer_$.$getAriaRole$();
  $ariaRole$$inline_262$$ && $goog$dom$a11y$setRole$$($element$$91$$, $ariaRole$$inline_262$$);
...
$JSCompiler_prototypeAlias$$.$decorateInternal$ = function $$JSCompiler_prototypeAlias$$$$decorateInternal$$($element$$93$$) {
  ...
  var $ariaRole$$inline_270$$ = this.$preferredAriaRole_$ || this.$renderer_$.$getAriaRole$();
  $ariaRole$$inline_270$$ && $goog$dom$a11y$setRole$$($element$$93$$, $ariaRole$$inline_270$$);
...
$JSCompiler_prototypeAlias$$.$setEnabled$ = function $$JSCompiler_prototypeAlias$$$$setEnabled$$($enable$$8$$) {
  var $parent$$inline_277$$ = this.getParent();
  if((!$parent$$inline_277$$ || "function" != typeof $parent$$inline_277$$.isEnabled || $parent$$inline_277$$.isEnabled()) && $JSCompiler_StaticMethods_isTransitionAllowed$$(this, 1, !$enable$$8$$)) {
...
$JSCompiler_prototypeAlias$$.$performActionInternal$ = function $$JSCompiler_prototypeAlias$$$$performActionInternal$$($e$$31$$) {
  ...
  if($JSCompiler_StaticMethods_isAutoState$$(this, 64)) {
    var $actionEvent_open$$inline_283$$ = !(this.$state_$ & 64);
    $JSCompiler_StaticMethods_isTransitionAllowed$$(this, 64, $actionEvent_open$$inline_283$$) && this.$setState$(64, $actionEvent_open$$inline_283$$)
  }
  $actionEvent_open$$inline_283$$ = new $goog$events$Event$$("action", this);
  $e$$31$$ && ($actionEvent_open$$inline_283$$.altKey = $e$$31$$.altKey, $actionEvent_open$$inline_283$$.ctrlKey = $e$$31$$.ctrlKey, $actionEvent_open$$inline_283$$.metaKey = $e$$31$$.metaKey, $actionEvent_open$$inline_283$$.shiftKey = $e$$31$$.shiftKey, $actionEvent_open$$inline_283$$.$platformModifierKey$ = $e$$31$$.$platformModifierKey$);
  return this.dispatchEvent($actionEvent_open$$inline_283$$)
};
...
$JSCompiler_prototypeAlias$$.$decorate$ = function $$JSCompiler_prototypeAlias$$$$decorate$$($button$$2$$, $element$$100$$) {
  var $element$$100$$ = $goog$ui$ButtonRenderer$$.$superClass_$.$decorate$.call(this, $button$$2$$, $element$$100$$), $value$$inline_294$$ = this.$getValue$($element$$100$$);
  $button$$2$$.$value_$ = $value$$inline_294$$;
...
$JSCompiler_prototypeAlias$$.$decorate$ = function $$JSCompiler_prototypeAlias$$$$decorate$$($button$$15$$, $element$$116$$) {
  ...
  var $JSCompiler_inline_result$$302_inner$$inline_307_outer$$inline_306$$;
  a: {
    if(($JSCompiler_inline_result$$302_inner$$inline_307_outer$$inline_306$$ = $JSCompiler_StaticMethods_getFirstElementChild$$($button$$15$$.$getDomHelper$(), $element$$116$$)) && -1 != $JSCompiler_inline_result$$302_inner$$inline_307_outer$$inline_306$$.className.indexOf(this.$getCssClass$() + "-outer-box")) {
      if(($JSCompiler_inline_result$$302_inner$$inline_307_outer$$inline_306$$ = $JSCompiler_StaticMethods_getFirstElementChild$$($button$$15$$.$getDomHelper$(), $JSCompiler_inline_result$$302_inner$$inline_307_outer$$inline_306$$)) && -1 != $JSCompiler_inline_result$$302_inner$$inline_307_outer$$inline_306$$.className.indexOf(this.$getCssClass$() + "-inner-box")) {
        $JSCompiler_inline_result$$302_inner$$inline_307_outer$$inline_306$$ = $JSCompiler_alias_TRUE$$;
        break a
      }
    }
    $JSCompiler_inline_result$$302_inner$$inline_307_outer$$inline_306$$ = $JSCompiler_alias_FALSE$$
  }
  $JSCompiler_inline_result$$302_inner$$inline_307_outer$$inline_306$$ || $element$$116$$.appendChild($JSCompiler_StaticMethods_createButton$$(this, $element$$116$$.childNodes, $button$$15$$.$getDomHelper$()));
...
function $goog$i18n$TimeZone$createTimeZone$$($offset$$inline_895_str$$inline_312_timeZoneData$$) {
  if("number" == typeof $offset$$inline_895_str$$inline_312_timeZoneData$$) {
    var $tz$$1_tz$$inline_311$$ = new $goog$i18n$TimeZone$$;
    $tz$$1_tz$$inline_311$$.$standardOffset_$ = $offset$$inline_895_str$$inline_312_timeZoneData$$;
    var $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$;
    $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$ = $offset$$inline_895_str$$inline_312_timeZoneData$$;
    if(0 == $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$) {
      $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$ = "Etc/GMT"
    }else {
      var $parts$$inline_893$$ = ["Etc/GMT", 0 > $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$ ? "-" : "+"];
      $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$ = Math.abs($JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$);
      $parts$$inline_893$$.push(Math.floor($JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$ / 60) % 100);
      $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$ %= 60;
      0 != $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$ && $parts$$inline_893$$.push(":", $goog$string$padNumber$$($JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$, 2));
      $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$ = $parts$$inline_893$$.join("")
    }
    $tz$$1_tz$$inline_311$$.$timeZoneId_$ = $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$;
    0 == $offset$$inline_895_str$$inline_312_timeZoneData$$ ? $offset$$inline_895_str$$inline_312_timeZoneData$$ = "UTC" : ($JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$ = ["UTC", 0 > $offset$$inline_895_str$$inline_312_timeZoneData$$ ? "+" : "-"], $offset$$inline_895_str$$inline_312_timeZoneData$$ = Math.abs($offset$$inline_895_str$$inline_312_timeZoneData$$), $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$.push(Math.floor($offset$$inline_895_str$$inline_312_timeZoneData$$ / 
    60) % 100), $offset$$inline_895_str$$inline_312_timeZoneData$$ %= 60, 0 != $offset$$inline_895_str$$inline_312_timeZoneData$$ && $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$.push(":", $offset$$inline_895_str$$inline_312_timeZoneData$$), $offset$$inline_895_str$$inline_312_timeZoneData$$ = $JSCompiler_inline_result$$891_offset$$inline_892_parts$$inline_896$$.join(""));
    $tz$$1_tz$$inline_311$$.$tzNames_$ = [$offset$$inline_895_str$$inline_312_timeZoneData$$, $offset$$inline_895_str$$inline_312_timeZoneData$$];
    $tz$$1_tz$$inline_311$$.$transitions_$ = [];
    return $tz$$1_tz$$inline_311$$
  }
  $tz$$1_tz$$inline_311$$ = new $goog$i18n$TimeZone$$;
  $tz$$1_tz$$inline_311$$.$timeZoneId_$ = $offset$$inline_895_str$$inline_312_timeZoneData$$.id;
  $tz$$1_tz$$inline_311$$.$standardOffset_$ = -$offset$$inline_895_str$$inline_312_timeZoneData$$.std_offset;
  $tz$$1_tz$$inline_311$$.$tzNames_$ = $offset$$inline_895_str$$inline_312_timeZoneData$$.names;
  $tz$$1_tz$$inline_311$$.$transitions_$ = $offset$$inline_895_str$$inline_312_timeZoneData$$.transitions;
  return $tz$$1_tz$$inline_311$$
}
...
function $JSCompiler_StaticMethods_formatField_$$($opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$, $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$, $dateForDate$$1$$, $dateForTime$$1$$) {
  var $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ = $opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$.length;
  switch($opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$.charAt(0)) {
    case "G":
      return $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$ = 0 < $dateForDate$$1$$.getFullYear() ? 1 : 0, 4 <= $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? $goog$i18n$DateTimeSymbols_en$$.$ERANAMES$[$date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$] : $goog$i18n$DateTimeSymbols_en$$.$ERAS$[$date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$];
    case "y":
      return $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$ = $dateForDate$$1$$.getFullYear(), 0 > $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$ && ($date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$ = -$date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$), 
      2 == $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? $goog$string$padNumber$$($date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$ % 100, 2) : "" + $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$;
    case "M":
      return $JSCompiler_StaticMethods_formatMonth_$$($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$, $dateForDate$$1$$);
    case "k":
      return $goog$string$padNumber$$($dateForTime$$1$$.getHours() || 24, $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$);
    case "S":
      return($dateForTime$$1$$.getTime() % 1E3 / 1E3).toFixed(Math.min(3, $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$)).substr(2) + (3 < $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? $goog$string$padNumber$$(0, $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ - 3) : "");
    case "E":
      return $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$ = $dateForDate$$1$$.getDay(), 4 <= $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? $goog$i18n$DateTimeSymbols_en$$.$WEEKDAYS$[$date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$] : $goog$i18n$DateTimeSymbols_en$$.$SHORTWEEKDAYS$[$date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$];
    case "a":
      return $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ = $dateForTime$$1$$.getHours(), $goog$i18n$DateTimeSymbols_en$$.$AMPMS$[12 <= $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ && 24 > $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? 1 : 0];
    case "h":
      return $goog$string$padNumber$$($dateForTime$$1$$.getHours() % 12 || 12, $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$);
    case "K":
      return $goog$string$padNumber$$($dateForTime$$1$$.getHours() % 12, $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$);
    case "H":
      return $goog$string$padNumber$$($dateForTime$$1$$.getHours(), $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$);
    case "c":
      return $JSCompiler_StaticMethods_formatStandaloneDay_$$($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$, $dateForDate$$1$$);
    case "L":
      return $JSCompiler_StaticMethods_formatStandaloneMonth_$$($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$, $dateForDate$$1$$);
    case "Q":
      return $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$ = Math.floor($dateForDate$$1$$.getMonth() / 3), 4 > $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? $goog$i18n$DateTimeSymbols_en$$.$SHORTQUARTERS$[$date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$] : $goog$i18n$DateTimeSymbols_en$$.$QUARTERS$[$date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$];
    case "d":
      return $goog$string$padNumber$$($dateForDate$$1$$.getDate(), $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$);
    case "m":
      return $goog$string$padNumber$$($dateForTime$$1$$.getMinutes(), $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$);
    case "s":
      return $goog$string$padNumber$$($dateForTime$$1$$.getSeconds(), $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$);
    case "v":
      return $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ = $JSCompiler_alias_VOID$$ || $goog$i18n$TimeZone$createTimeZone$$($date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$.getTimezoneOffset()), $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$.$timeZoneId_$;
    case "z":
      return $opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$ = $JSCompiler_alias_VOID$$ || $goog$i18n$TimeZone$createTimeZone$$($date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$.getTimezoneOffset()), 4 > $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? $opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$.$tzNames_$[0 < $JSCompiler_StaticMethods_getDaylightAdjustment$$($opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$, 
      $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$) ? 2 : 0] : $opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$.$tzNames_$[0 < $JSCompiler_StaticMethods_getDaylightAdjustment$$($opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$, $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$) ? 3 : 1];
    case "Z":
      return $opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$ = $JSCompiler_alias_VOID$$ || $goog$i18n$TimeZone$createTimeZone$$($date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$.getTimezoneOffset()), 4 > $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? ($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ = 
      -($opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$.$standardOffset_$ - $JSCompiler_StaticMethods_getDaylightAdjustment$$($opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$, $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$)), $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$ = [0 > $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? 
      "-" : "+"], $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ = Math.abs($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$), $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$.push($goog$string$padNumber$$(Math.floor($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ / 
      60) % 100, 2), $goog$string$padNumber$$($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ % 60, 2))) : ($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ = $opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$.$standardOffset_$ - $JSCompiler_StaticMethods_getDaylightAdjustment$$($opt_timeZone$$inline_345_opt_timeZone$$inline_350_patternStr$$, $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$), 
      $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$ = ["GMT"], $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$.push(0 >= $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ ? "+" : "-"), $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ = 
      Math.abs($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$), $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$.push($goog$string$padNumber$$(Math.floor($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ / 60) % 100, 2), ":", $goog$string$padNumber$$($JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ % 
      60, 2))), $JSCompiler_temp$$848_count$$27_hours$$inline_331_offset$$inline_1148_offset$$inline_900_opt_timeZone$$inline_340$$ = $date$$40_parts$$inline_1149_parts$$inline_901_value$$inline_317_value$$inline_322_value$$inline_327_value$$inline_336$$.join("");
    default:
      return""
  }
}
  ...
  for(var $offset$$24$$ = 0, $length$$28$$ = $rflect$cal$MiniCalBuilder$HTML_PARTS_$$.length;++$offset$$24$$ < $length$$28$$ - 1;) {
    switch($aSb$$3$$.append($rflect$cal$MiniCalBuilder$HTML_PARTS_$$[$offset$$24$$]), $offset$$24$$) {
      ...
      case 3:
        ...
        break;
      case 5:
        var $aSb$$inline_366_aSb$$inline_368$$ = $aSb$$3$$;
        $aSb$$inline_366_aSb$$inline_368$$.append(this.$timeManager_$.$basis$.getYear());
        $aSb$$inline_366_aSb$$inline_368$$.append("&nbsp;");
        $aSb$$inline_366_aSb$$inline_368$$.append($goog$i18n$DateTimeSymbols_en$$.$MONTHS$[this.$timeManager_$.$basis$.getMonth()]);
        break;
      case 8:
        for(var $aSb$$inline_366_aSb$$inline_368$$ = $aSb$$3$$, $aOffset$$inline_369$$ = $offset$$24$$, $dayNamesFirstNumber$$inline_370$$ = $goog$i18n$DateTimeSymbols_en$$.$FIRSTDAYOFWEEK$, $dayNameNumber$$inline_371$$ = 0, $counter$$inline_372$$ = 0;7 > $counter$$inline_372$$;$counter$$inline_372$$++) {
          0 < $counter$$inline_372$$ && $aSb$$inline_366_aSb$$inline_368$$.append($rflect$cal$MiniCalBuilder$HTML_PARTS_$$[$aOffset$$inline_369$$]), $dayNameNumber$$inline_371$$ = ($dayNamesFirstNumber$$inline_370$$ + $counter$$inline_372$$ + 1) % 7, $aSb$$inline_366_aSb$$inline_368$$.append($goog$i18n$DateTimeSymbols_en$$.$WEEKDAYS$[$dayNameNumber$$inline_371$$].charAt(0).toUpperCase()), $aSb$$inline_366_aSb$$inline_368$$.append($rflect$cal$MiniCalBuilder$HTML_PARTS_$$[$aOffset$$inline_369$$ + 1])
        }
        $offset$$24$$++;
        break;
      case 11:
...
function $rflect$date$moveToDayOfWeekIfNeeded$$($aDate$$3_date$$inline_378$$) {
  var $JSCompiler_temp$$23_diff$$inline_377$$;
  0 != $JSCompiler_StaticMethods_getWeekday$$($aDate$$3_date$$inline_378$$) && ($JSCompiler_temp$$23_diff$$inline_377$$ = (($goog$i18n$DateTimeSymbols_en$$.$FIRSTDAYOFWEEK$ + 0 + 1) % 7 - $aDate$$3_date$$inline_378$$.getDay() + -7) % 7, $aDate$$3_date$$inline_378$$ = $aDate$$3_date$$inline_378$$.$clone$(), $aDate$$3_date$$inline_378$$.add(new $goog$date$Interval$$(0, 0, 0 === $JSCompiler_temp$$23_diff$$inline_377$$ ? $JSCompiler_temp$$23_diff$$inline_377$$ + -7 : $JSCompiler_temp$$23_diff$$inline_377$$)));
  return $JSCompiler_temp$$23_diff$$inline_377$$ = $aDate$$3_date$$inline_378$$
}
...
$JSCompiler_prototypeAlias$$.$equals$ = function $$JSCompiler_prototypeAlias$$$$equals$$($aOther$$, $opt_bitmask$$) {
  var $diff$$inline_396$$ = 0, $bitmask$$inline_397$$ = $opt_bitmask$$ || 63;
  $bitmask$$inline_397$$ & 1 && ($diff$$inline_396$$ = this.getYear() - $aOther$$.getFullYear());
  0 == $diff$$inline_396$$ && $bitmask$$inline_397$$ & 2 && ($diff$$inline_396$$ = this.getMonth() - $aOther$$.getMonth());
  0 == $diff$$inline_396$$ && $bitmask$$inline_397$$ & 4 && ($diff$$inline_396$$ = this.getDate() - $aOther$$.getDate());
  0 == $diff$$inline_396$$ && $bitmask$$inline_397$$ & 8 && ($diff$$inline_396$$ = this.getHours() - $aOther$$.getHours());
...
$JSCompiler_prototypeAlias$$.$clone$ = function $$JSCompiler_prototypeAlias$$$$clone$$() {
  ...
  var $aWeekNumber$$inline_409$$ = this.$getWeekNumber$();
  $date$$45$$.$weekNumber_$ = $aWeekNumber$$inline_409$$;
  return $date$$45$$
};
...
$JSCompiler_prototypeAlias$$.$run$ = function $$JSCompiler_prototypeAlias$$$$run$$() {
  ...
  var $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = 0;
  switch(this.$configuration$) {
    case 1:
      $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = 1;
      break;
    case 2:
      $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = this.$daysNumber$;
      break;
    case 3:
      $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = 7;
      break;
    case 4:
      $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = this.$daysNumber$;
      break;
    ...
    ;
    case 5:
      var $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = 0, $date$$inline_423_firstDayOfMonth$$inline_422$$ = this.$basis$.$clone$();
      $date$$inline_423_firstDayOfMonth$$inline_422$$.setDate(1);
      this.$start_$.$equals$($date$$inline_423_firstDayOfMonth$$inline_422$$) || ($daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = $JSCompiler_StaticMethods_getWeekday$$($date$$inline_423_firstDayOfMonth$$inline_422$$) - $JSCompiler_StaticMethods_getWeekday$$(this.$start_$));
      $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = 7 == this.$configuration$ ? 42 : 0 == ($daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ + $goog$date$getNumberOfDaysInMonth$$(this.$basis$.getFullYear(), this.$basis$.getMonth())) % 7 ? $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ + $goog$date$getNumberOfDaysInMonth$$(this.$basis$.getFullYear(), this.$basis$.getMonth()) : $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ + 
      $goog$date$getNumberOfDaysInMonth$$(this.$basis$.getFullYear(), this.$basis$.getMonth()) - ($daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ + $goog$date$getNumberOfDaysInMonth$$(this.$basis$.getFullYear(), this.$basis$.getMonth())) % 7 + 7
  }
  this.$daySeries$.length = 0;
  $date$$inline_423_firstDayOfMonth$$inline_422$$ = new $rflect$date$DateShim$$(this.$start_$);
  $date$$inline_423_firstDayOfMonth$$inline_422$$.$dayOfYear_$ = this.$start_$.$getDayOfYear$();
  var $aWeekNumber$$inline_910_counter$$inline_424$$ = this.$start_$.$getWeekNumber$();
  $date$$inline_423_firstDayOfMonth$$inline_422$$.$weekNumber_$ = $aWeekNumber$$inline_910_counter$$inline_424$$;
  for($aWeekNumber$$inline_910_counter$$inline_424$$ = 0;$aWeekNumber$$inline_910_counter$$inline_424$$ < $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$;$aWeekNumber$$inline_910_counter$$inline_424$$++) {
    this.$daySeries$[$aWeekNumber$$inline_910_counter$$inline_424$$] = $date$$inline_423_firstDayOfMonth$$inline_422$$, $date$$inline_423_firstDayOfMonth$$inline_422$$ = $rflect$date$getTomorrow$$($date$$inline_423_firstDayOfMonth$$inline_422$$)
  }
  this.$interval$.start = this.$start_$.getTime();
  this.$interval$.end = (new $goog$date$Date$$($date$$inline_423_firstDayOfMonth$$inline_422$$)).getTime();
  $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = new Date;
  if(this.$isInNowPoint$ = this.$interval$.contains(+$daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$) && (5 != this.$configuration$ || this.$basis$.getMonth() == $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$.getMonth())) {
    $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$ = new Date, this.$currentDay_$ = new $rflect$date$DateShim$$($daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$.getFullYear(), $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$.getMonth(), $daysNumber$$inline_420_difference$$inline_421_now$$inline_914_today$$inline_425$$.getDate())
  }
};
$JSCompiler_prototypeAlias$$.shift = function $$JSCompiler_prototypeAlias$$$shift$($aDirection$$1$$) {
  var $daysNumber$$inline_429$$ = 0;
  switch(this.$configuration$) {
    case 1:
    ...
    ;
    case 4:
      $daysNumber$$inline_429$$ = this.$daysNumber$ * $aDirection$$1$$;
      this.$basis$.add(new $goog$date$Interval$$(0, 0, $daysNumber$$inline_429$$));
      break;
    case 7:
    ;
    case 5:
...
function $JSCompiler_StaticMethods_build_$$($JSCompiler_StaticMethods_build_$self$$, $aSb$$10$$) {
  for(var $sb$$3$$ = $aSb$$10$$ || new $goog$string$StringBuffer$$, $counter$$13$$ = 0, $length$$33$$ = $JSCompiler_StaticMethods_build_$self$$.$rects_$.length;$counter$$13$$ < $length$$33$$;$counter$$13$$++) {
    var $JSCompiler_StaticMethods_buildUnit_$self$$inline_431$$ = $JSCompiler_StaticMethods_build_$self$$, $aSb$$inline_432$$ = $sb$$3$$, $aRect$$inline_433$$ = $JSCompiler_StaticMethods_build_$self$$.$rects_$[$counter$$13$$];
    $aSb$$inline_432$$.append('<div class="mask');
    $JSCompiler_StaticMethods_buildUnit_$self$$inline_431$$.$additionalClassNames$ && ($aSb$$inline_432$$.append(" "), $aSb$$inline_432$$.append($JSCompiler_StaticMethods_buildUnit_$self$$inline_431$$.$additionalClassNames$));
    $aSb$$inline_432$$.append('" style="left:');
    $aSb$$inline_432$$.append(Math.floor($aRect$$inline_433$$.left));
    $aSb$$inline_432$$.append("px;top:");
    $aSb$$inline_432$$.append(Math.floor($aRect$$inline_433$$.top));
    $aSb$$inline_432$$.append("px;width:");
    $aSb$$inline_432$$.append(Math.ceil($aRect$$inline_433$$.width));
    $aSb$$inline_432$$.append("px;height:");
    $aSb$$inline_432$$.append(Math.ceil($aRect$$inline_433$$.height));
    $aSb$$inline_432$$.append('px">');
    $aSb$$inline_432$$.append("</div>")
  }
...
$JSCompiler_prototypeAlias$$.$init$ = function $$JSCompiler_prototypeAlias$$$$init$$($JSCompiler_inline_result$$435_aConfiguration$$1_cell$$inline_438$$, $startSelectionIndex$$, $endSelectionIndex_minCell$$inline_439$$) {
  $rflect$cal$SelectionMask$$.prototype.$init$.call(this, $JSCompiler_inline_result$$435_aConfiguration$$1_cell$$inline_438$$);
  ...
  if(5 == this.$configuration_$) {
    this.$initialized_$ = $JSCompiler_alias_FALSE$$, this.$startCell_$ = $JSCompiler_StaticMethods_getCellBySelectionIndex_$$($startSelectionIndex$$), this.$currentCell_$ = $JSCompiler_StaticMethods_getCellBySelectionIndex_$$($endSelectionIndex_minCell$$inline_439$$), this.$update_$(), this.close()
  }else {
    this.$dragStarted_$ = $JSCompiler_alias_TRUE$$;
    if(this.$initialized_$) {
      var $JSCompiler_inline_result$$435_aConfiguration$$1_cell$$inline_438$$ = $JSCompiler_StaticMethods_getCellBySelectionIndex_$$($startSelectionIndex$$), $endSelectionIndex_minCell$$inline_439$$ = -1 == $JSCompiler_StaticMethods_compareCells_$$(this, this.$visibleStartCell_$, this.$visibleCurrentCell_$) ? this.$visibleStartCell_$ : this.$visibleCurrentCell_$, $maxCell$$inline_440$$ = 1 == $JSCompiler_StaticMethods_compareCells_$$(this, this.$visibleStartCell_$, this.$visibleCurrentCell_$) ? this.$visibleStartCell_$ : 
      this.$visibleCurrentCell_$;
      $_log$$("cell", $JSCompiler_inline_result$$435_aConfiguration$$1_cell$$inline_438$$);
      $_log$$("minCell", $endSelectionIndex_minCell$$inline_439$$);
      $_log$$("maxCell", $maxCell$$inline_440$$);
      $JSCompiler_inline_result$$435_aConfiguration$$1_cell$$inline_438$$ = 0 <= $JSCompiler_StaticMethods_compareCells_$$(this, $JSCompiler_inline_result$$435_aConfiguration$$1_cell$$inline_438$$, $endSelectionIndex_minCell$$inline_439$$) && 0 >= $JSCompiler_StaticMethods_compareCells_$$(this, $JSCompiler_inline_result$$435_aConfiguration$$1_cell$$inline_438$$, $maxCell$$inline_440$$)
    }else {
      $JSCompiler_inline_result$$435_aConfiguration$$1_cell$$inline_438$$ = $JSCompiler_alias_FALSE$$
    }
    this.$indexIsInMask_$ = $JSCompiler_inline_result$$435_aConfiguration$$1_cell$$inline_438$$;
...
$JSCompiler_prototypeAlias$$.$startDrag$ = function $$JSCompiler_prototypeAlias$$$$startDrag$$($e$$37$$) {
  var $doc$$inline_462_isMouseDown$$ = "mousedown" == $e$$37$$.type;
  if(this.$enabled_$ && !this.$dragging_$ && (!$doc$$inline_462_isMouseDown$$ || $JSCompiler_StaticMethods_isMouseActionButton$$($e$$37$$))) {
    ...
    var $doc$$inline_462_isMouseDown$$ = this.$document_$, $docEl$$inline_463$$ = $doc$$inline_462_isMouseDown$$.documentElement, $useCapture$$inline_464$$ = !$goog$fx$Dragger$HAS_SET_CAPTURE_$$;
    $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $doc$$inline_462_isMouseDown$$, ["touchmove", "mousemove"], this.$handleMove_$, $useCapture$$inline_464$$);
    $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $doc$$inline_462_isMouseDown$$, ["touchend", "mouseup"], this.$endDrag$, $useCapture$$inline_464$$);
    $goog$fx$Dragger$HAS_SET_CAPTURE_$$ ? ($docEl$$inline_463$$.setCapture($JSCompiler_alias_FALSE$$), $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $docEl$$inline_463$$, "losecapture", this.$endDrag$)) : $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $goog$dom$getWindow$$($doc$$inline_462_isMouseDown$$), "blur", this.$endDrag$);
    $goog$userAgent$IE$$ && this.$ieDragStartCancellingOn_$ && $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $doc$$inline_462_isMouseDown$$, "dragstart", $goog$events$Event$preventDefault$$);
    this.$scrollTarget_$ && $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, this.$scrollTarget_$, "scroll", this.$onScroll_$, $useCapture$$inline_464$$);
...
;function $goog$ui$PopupBase$$($opt_element$$12$$, $opt_type$$7$$) {
  ...
  var $elt$$inline_472$$ = $opt_element$$12$$ || $JSCompiler_alias_NULL$$;
  $JSCompiler_StaticMethods_ensureNotVisible_$$(this);
  this.$element_$ = $elt$$inline_472$$;
...
function $JSCompiler_StaticMethods_manageBackgroundDom_$$($JSCompiler_StaticMethods_manageBackgroundDom_$self$$) {
  if($JSCompiler_StaticMethods_manageBackgroundDom_$self$$.$useIframeMask_$ && !$JSCompiler_StaticMethods_manageBackgroundDom_$self$$.$bgIframeEl_$) {
    var $JSCompiler_inline_result$$485$$;
    $JSCompiler_inline_result$$485$$ = $JSCompiler_StaticMethods_manageBackgroundDom_$self$$.$getDomHelper$().$createDom$("iframe", {frameborder:0, style:"border:0;vertical-align:bottom;", src:'javascript:""'});
    $JSCompiler_StaticMethods_manageBackgroundDom_$self$$.$bgIframeEl_$ = $JSCompiler_inline_result$$485$$;
...
$JSCompiler_prototypeAlias$$.$enterDocument$ = function $$JSCompiler_prototypeAlias$$$$enterDocument$$() {
  ...
  if(this.$bgIframeEl_$) {
    var $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$ = this.$getElement$();
    $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$.parentNode && $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$.parentNode.insertBefore(this.$bgIframeEl_$, $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$)
  }
  $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$ = this.$getElement$();
  $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$.parentNode && $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$.parentNode.insertBefore(this.$bgEl_$, $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$);
  $goog$ui$ModalPopup$$.$superClass_$.$enterDocument$.call(this);
  $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$ = this.$getElement$();
  $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$.parentNode && $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$.parentNode.insertBefore(this.$tabCatcherElement_$, $refNode$$inline_1152_refNode$$inline_1155_refNode$$inline_492$$.nextSibling);
...
function $goog$structs$forEach$$($col$$6$$, $f$$39$$, $opt_obj$$35$$) {
  if("function" == typeof $col$$6$$.forEach) {
    ...
    if($goog$isArrayLike$$($col$$6$$) || $goog$isString$$($col$$6$$)) {
      ...
      var $keys$$1_rv$$inline_495$$;
      if("function" == typeof $col$$6$$.$getKeys$) {
        $keys$$1_rv$$inline_495$$ = $col$$6$$.$getKeys$()
      }else {
        if("function" != typeof $col$$6$$.$getValues$) {
          if($goog$isArrayLike$$($col$$6$$) || $goog$isString$$($col$$6$$)) {
            $keys$$1_rv$$inline_495$$ = [];
            for(var $l$$inline_496_values$$5$$ = $col$$6$$.length, $i$$inline_497_l$$14$$ = 0;$i$$inline_497_l$$14$$ < $l$$inline_496_values$$5$$;$i$$inline_497_l$$14$$++) {
              $keys$$1_rv$$inline_495$$.push($i$$inline_497_l$$14$$)
            }
          }else {
            $keys$$1_rv$$inline_495$$ = $goog$object$getKeys$$($col$$6$$)
          }
        }else {
          $keys$$1_rv$$inline_495$$ = $JSCompiler_alias_VOID$$
        }
      }
      for(var $l$$inline_496_values$$5$$ = $goog$structs$getValues$$($col$$6$$), $i$$inline_497_l$$14$$ = $l$$inline_496_values$$5$$.length, $i$$85$$ = 0;$i$$85$$ < $i$$inline_497_l$$14$$;$i$$85$$++) {
        $f$$39$$.call($opt_obj$$35$$, $l$$inline_496_values$$5$$[$i$$85$$], $keys$$1_rv$$inline_495$$ && $keys$$1_rv$$inline_495$$[$i$$85$$], $col$$6$$)
      }
    }
  }
}
;function $goog$structs$Map$$($opt_map$$, $var_args$$71$$) {
  this.$map_$ = {};
  this.$keys_$ = [];
  var $argLength$$2_keys$$inline_501$$ = arguments.length;
  if(1 < $argLength$$2_keys$$inline_501$$) {
    $argLength$$2_keys$$inline_501$$ % 2 && $JSCompiler_alias_THROW$$(Error("Uneven number of arguments"));
    for(var $i$$90_values$$inline_502$$ = 0;$i$$90_values$$inline_502$$ < $argLength$$2_keys$$inline_501$$;$i$$90_values$$inline_502$$ += 2) {
      this.set(arguments[$i$$90_values$$inline_502$$], arguments[$i$$90_values$$inline_502$$ + 1])
    }
  }else {
    if($opt_map$$) {
      $opt_map$$ instanceof $goog$structs$Map$$ ? ($argLength$$2_keys$$inline_501$$ = $opt_map$$.$getKeys$(), $i$$90_values$$inline_502$$ = $opt_map$$.$getValues$()) : ($argLength$$2_keys$$inline_501$$ = $goog$object$getKeys$$($opt_map$$), $i$$90_values$$inline_502$$ = $goog$object$getValues$$($opt_map$$));
      for(var $i$$inline_503$$ = 0;$i$$inline_503$$ < $argLength$$2_keys$$inline_501$$.length;$i$$inline_503$$++) {
        this.set($argLength$$2_keys$$inline_501$$[$i$$inline_503$$], $i$$90_values$$inline_502$$[$i$$inline_503$$])
      }
    }
  }
}
...
function $JSCompiler_StaticMethods_setDraggingEnabled_$$($JSCompiler_StaticMethods_setDraggingEnabled_$self$$, $enabled$$2$$) {
  if($JSCompiler_StaticMethods_setDraggingEnabled_$self$$.$getElement$()) {
    var $element$$inline_509$$ = $JSCompiler_StaticMethods_setDraggingEnabled_$self$$.$titleEl_$, $className$$inline_510$$ = $JSCompiler_StaticMethods_setDraggingEnabled_$self$$.$class_$ + "-title-draggable";
    $enabled$$2$$ ? $goog$dom$classes$add$$($element$$inline_509$$, $className$$inline_510$$) : $goog$dom$classes$remove$$($element$$inline_509$$, $className$$inline_510$$)
  }
...
$JSCompiler_prototypeAlias$$.$createDom$ = function $$JSCompiler_prototypeAlias$$$$createDom$$() {
  ...
  var $JSCompiler_StaticMethods_attachToElement$self$$inline_517_element$$123$$ = this.$getElement$();
  $goog$asserts$assert$$($JSCompiler_StaticMethods_attachToElement$self$$inline_517_element$$123$$, "getElement() returns null");
  ...
  $goog$dom$append$$($JSCompiler_StaticMethods_attachToElement$self$$inline_517_element$$123$$, this.$titleEl_$, this.$contentEl_$ = $dom$$3$$.$createDom$("div", this.$class_$ + "-content"), this.$buttonEl_$ = $dom$$3$$.$createDom$("div", this.$class_$ + "-buttons"));
  this.$titleId_$ = this.$titleEl_$.id;
  $goog$dom$a11y$setRole$$($JSCompiler_StaticMethods_attachToElement$self$$inline_517_element$$123$$, "dialog");
  $JSCompiler_StaticMethods_attachToElement$self$$inline_517_element$$123$$.setAttribute("aria-labelledby", this.$titleId_$ || "");
  this.$content_$ && (this.$contentEl_$.innerHTML = this.$content_$);
  $goog$style$showElement$$(this.$titleCloseEl_$, this.$hasTitleCloseButton_$);
  this.$buttons_$ && ($JSCompiler_StaticMethods_attachToElement$self$$inline_517_element$$123$$ = this.$buttons_$, $JSCompiler_StaticMethods_attachToElement$self$$inline_517_element$$123$$.$element_$ = this.$buttonEl_$, $JSCompiler_StaticMethods_attachToElement$self$$inline_517_element$$123$$.$render$());
...
$JSCompiler_prototypeAlias$$.$decorateInternal$ = function $$JSCompiler_prototypeAlias$$$$decorateInternal$$($JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$) {
  $goog$ui$Dialog$$.$superClass_$.$decorateInternal$.call(this, $JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$);
  $JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$ = this.$class_$ + "-content";
  (this.$contentEl_$ = $goog$dom$getElementsByTagNameAndClass_$$($JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$, this.$getElement$())[0]) ? this.$content_$ = this.$contentEl_$.innerHTML : (this.$contentEl_$ = this.$getDomHelper$().$createDom$("div", $JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$), this.$content_$ && (this.$contentEl_$.innerHTML = this.$content_$), this.$getElement$().appendChild(this.$contentEl_$));
  var $JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$ = this.$class_$ + "-title", $titleTextClass$$ = this.$class_$ + "-title-text", $titleCloseClass$$ = this.$class_$ + "-title-close";
  (this.$titleEl_$ = $goog$dom$getElementsByTagNameAndClass_$$($JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$, this.$getElement$())[0]) ? (this.$titleTextEl_$ = $goog$dom$getElementsByTagNameAndClass_$$($titleTextClass$$, this.$titleEl_$)[0], this.$titleCloseEl_$ = $goog$dom$getElementsByTagNameAndClass_$$($titleCloseClass$$, this.$titleEl_$)[0], this.$titleEl_$.id || (this.$titleEl_$.id = $JSCompiler_StaticMethods_getId$$(this))) : 
  (this.$titleEl_$ = this.$getDomHelper$().$createDom$("div", {className:$JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$, id:$JSCompiler_StaticMethods_getId$$(this)}), this.$getElement$().insertBefore(this.$titleEl_$, this.$contentEl_$));
  this.$titleId_$ = this.$titleEl_$.id;
  ...
  $goog$style$showElement$$(this.$titleCloseEl_$, this.$hasTitleCloseButton_$);
  $JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$ = this.$class_$ + "-buttons";
  (this.$buttonEl_$ = $goog$dom$getElementsByTagNameAndClass_$$($JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$, this.$getElement$())[0]) ? (this.$buttons_$ = new $goog$ui$Dialog$ButtonSet$$(this.$getDomHelper$()), this.$buttons_$.$decorate$(this.$buttonEl_$)) : (this.$buttonEl_$ = this.$getDomHelper$().$createDom$("div", $JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$), this.$getElement$().appendChild(this.$buttonEl_$), 
  this.$buttons_$ && ($JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$ = this.$buttons_$, $JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$.$element_$ = this.$buttonEl_$, $JSCompiler_StaticMethods_attachToElement$self$$inline_524_buttonsClass_contentClass_element$$124_titleClass$$.$render$()), $goog$style$showElement$$(this.$buttonEl_$, !!this.$buttons_$));
  $JSCompiler_StaticMethods_setBackgroundElementOpacity$$(this, this.$backgroundElementOpacity_$)
};
$JSCompiler_prototypeAlias$$.$enterDocument$ = function $$JSCompiler_prototypeAlias$$$$enterDocument$$() {
  ...
  if(!this.$modal_$ && (this.$modal_$ = $JSCompiler_alias_FALSE$$, this.$inDocument_$)) {
    var $dom$$inline_533$$ = this.$getDomHelper$(), $bg$$inline_534$$ = this.$getBackgroundElement$();
    $dom$$inline_533$$.removeNode(this.$bgIframeEl_$);
    $dom$$inline_533$$.removeNode($bg$$inline_534$$)
  }
};
$JSCompiler_prototypeAlias$$.$exitDocument$ = function $$JSCompiler_prototypeAlias$$$$exitDocument$$() {
  this.$isVisible$() && this.$setVisible$($JSCompiler_alias_FALSE$$);
...
$JSCompiler_prototypeAlias$$.$onButtonClick_$ = function $$JSCompiler_prototypeAlias$$$$onButtonClick_$$($button$$18_e$$58_el$$inline_545_key$$69$$) {
  a: {
    for($button$$18_e$$58_el$$inline_545_key$$69$$ = $button$$18_e$$58_el$$inline_545_key$$69$$.target;$button$$18_e$$58_el$$inline_545_key$$69$$ != $JSCompiler_alias_NULL$$ && $button$$18_e$$58_el$$inline_545_key$$69$$ != this.$buttonEl_$;) {
      if("BUTTON" == $button$$18_e$$58_el$$inline_545_key$$69$$.tagName) {
        break a
      }
      $button$$18_e$$58_el$$inline_545_key$$69$$ = $button$$18_e$$58_el$$inline_545_key$$69$$.parentNode
    }
    $button$$18_e$$58_el$$inline_545_key$$69$$ = $JSCompiler_alias_NULL$$
  }
  if($button$$18_e$$58_el$$inline_545_key$$69$$ && !$button$$18_e$$58_el$$inline_545_key$$69$$.disabled) {
    var $button$$18_e$$58_el$$inline_545_key$$69$$ = $button$$18_e$$58_el$$inline_545_key$$69$$.name, $caption$$3$$ = this.$buttons_$.get($button$$18_e$$58_el$$inline_545_key$$69$$);
    this.dispatchEvent(new $goog$ui$Dialog$Event$$($button$$18_e$$58_el$$inline_545_key$$69$$, $caption$$3$$)) && this.$setVisible$($JSCompiler_alias_FALSE$$)
  }
};
  ...
  if("keydown" == $e$$59$$.type) {
    ...
    if(13 == $e$$59$$.keyCode) {
      if("BUTTON" == $isSpecialFormElement_target$$50$$.tagName) {
        ...
        if($buttonSet$$) {
          var $defaultKey$$ = $buttonSet$$.$defaultButton_$, $JSCompiler_temp$$38_buttons$$inline_549_defaultButton$$1$$;
          if($JSCompiler_temp$$38_buttons$$inline_549_defaultButton$$1$$ = $defaultKey$$) {
            a: {
              $JSCompiler_temp$$38_buttons$$inline_549_defaultButton$$1$$ = $buttonSet$$.$element_$.getElementsByTagName("BUTTON");
              for(var $i$$inline_550$$ = 0, $nextButton$$inline_551$$;$nextButton$$inline_551$$ = $JSCompiler_temp$$38_buttons$$inline_549_defaultButton$$1$$[$i$$inline_550$$];$i$$inline_550$$++) {
                if($nextButton$$inline_551$$.name == $defaultKey$$ || $nextButton$$inline_551$$.id == $defaultKey$$) {
                  $JSCompiler_temp$$38_buttons$$inline_549_defaultButton$$1$$ = $nextButton$$inline_551$$;
                  break a
                }
              }
              $JSCompiler_temp$$38_buttons$$inline_549_defaultButton$$1$$ = $JSCompiler_alias_NULL$$
            }
          }
          ...
          $JSCompiler_temp$$38_buttons$$inline_549_defaultButton$$1$$ && (!$JSCompiler_temp$$38_buttons$$inline_549_defaultButton$$1$$.disabled && !$isSpecialFormElement_target$$50$$) && ($cancel_key$$70$$ = $defaultKey$$)
        }
      }
...
for(var $rflect$pagevis$nameOfHiddenProperty_$$, $rflect$pagevis$nameOfVisibilityChangeEvent$$, $rflect$pagevis$VENDOR_HIDDEN_NAMES$$ = ["hidden", "msHidden", "mozHidden", "webkitHidden"], $rflect$pagevis$VENDOR_VISIBILITYCHANGE_NAMES$$ = ["visibilitychange", "msvisibilitychange", "mozvisibilitychange", "webkitvisibilitychange"], $vendorCounter$$inline_571$$ = 0;$vendorCounter$$inline_571$$ < $rflect$pagevis$VENDOR_HIDDEN_NAMES$$.length;$vendorCounter$$inline_571$$++) {
  if($rflect$pagevis$VENDOR_HIDDEN_NAMES$$[$vendorCounter$$inline_571$$] in document) {
    $rflect$pagevis$nameOfHiddenProperty_$$ = $rflect$pagevis$VENDOR_HIDDEN_NAMES$$[$vendorCounter$$inline_571$$];
    $rflect$pagevis$nameOfVisibilityChangeEvent$$ = $rflect$pagevis$VENDOR_VISIBILITYCHANGE_NAMES$$[$vendorCounter$$inline_571$$];
    break
  }
}
...
$goog$positioning$AnchoredPosition$$.prototype.$reposition$ = function $$goog$positioning$AnchoredPosition$$$$$reposition$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, $movableCorner$$1_size$$inline_947$$, $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$) {
  var $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$ = this.element, $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ = this.$corner$, $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ = this.$overflow_$, $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$, $o$$inline_1158_parent$$inline_595_rect$$inline_928$$ = 
  $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.offsetParent;
  if($o$$inline_1158_parent$$inline_595_rect$$inline_928$$) {
    var $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ = "HTML" == $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.tagName || "BODY" == $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.tagName;
    if(!$JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ || "static" != $goog$style$getComputedPosition$$($o$$inline_1158_parent$$inline_595_rect$$inline_928$$)) {
      $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ = $goog$style$getPageOffset$$($o$$inline_1158_parent$$inline_595_rect$$inline_928$$), $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ || ($JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ = ($JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ = 
      $goog$style$isRightToLeft$$($o$$inline_1158_parent$$inline_595_rect$$inline_928$$)) && $goog$userAgent$GECKO$$ ? -$o$$inline_1158_parent$$inline_595_rect$$inline_928$$.scrollLeft : $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ && (!$goog$userAgent$IE$$ || !$goog$userAgent$isVersion$$("8")) ? $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.scrollWidth - $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.clientWidth - 
      $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.scrollLeft : $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.scrollLeft, $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ = $goog$math$Coordinate$difference$$($JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$, new $goog$math$Coordinate$$($JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$, 
      $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.scrollTop)))
    }
  }
  $o$$inline_1158_parent$$inline_595_rect$$inline_928$$ = $goog$style$getPageOffset$$($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$);
  $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ = $goog$style$getSize$$($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$);
  $o$$inline_1158_parent$$inline_595_rect$$inline_928$$ = new $goog$math$Rect$$($o$$inline_1158_parent$$inline_595_rect$$inline_928$$.x, $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.y, $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.width, $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.height);
  if($JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ = $goog$style$getVisibleRectForElement$$($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$)) {
    var $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$ = new $goog$math$Rect$$($JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.left, $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.top, $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.right - 
    $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.left, $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.bottom - $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.top), $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ = 
    Math.max($o$$inline_1158_parent$$inline_595_rect$$inline_928$$.left, $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$.left), $body$$inline_934_pos$$inline_935_x1$$inline_1164$$ = Math.min($o$$inline_1158_parent$$inline_595_rect$$inline_928$$.left + $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.width, $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$.left + $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$.width);
    if($JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ <= $body$$inline_934_pos$$inline_935_x1$$inline_1164$$) {
      var $newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$ = Math.max($o$$inline_1158_parent$$inline_595_rect$$inline_928$$.top, $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$.top), $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$ = Math.min($o$$inline_1158_parent$$inline_595_rect$$inline_928$$.top + $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.height, $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$.top + $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$.height);
      $newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$ <= $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$ && ($o$$inline_1158_parent$$inline_595_rect$$inline_928$$.left = $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$, $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.top = $newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$, $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.width = 
      $body$$inline_934_pos$$inline_935_x1$$inline_1164$$ - $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$, $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.height = $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$ - $newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$)
    }
  }
  $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$ = $goog$dom$getDomHelper$$($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$);
  $newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$ = $goog$dom$getDomHelper$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$);
  if($JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.$document_$ != $newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$.$document_$) {
    var $body$$inline_934_pos$$inline_935_x1$$inline_1164$$ = $JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$.$document_$.body, $newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$ = $JSCompiler_StaticMethods_getWindow$$($newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$), $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$ = new $goog$math$Coordinate$$(0, 0), $currentWin$$inline_1171$$ = 
    $goog$dom$getWindow$$($goog$dom$getOwnerDocument$$($body$$inline_934_pos$$inline_935_x1$$inline_1164$$)), $currentEl$$inline_1172$$ = $body$$inline_934_pos$$inline_935_x1$$inline_1164$$;
    do {
      var $offset$$inline_1173$$ = $currentWin$$inline_1171$$ == $newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$ ? $goog$style$getPageOffset$$($currentEl$$inline_1172$$) : $goog$style$getClientPosition$$($currentEl$$inline_1172$$);
      $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$.x += $offset$$inline_1173$$.x;
      $position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$.y += $offset$$inline_1173$$.y
    }while($currentWin$$inline_1171$$ && $currentWin$$inline_1171$$ != $newBase$$inline_933_relativeWin$$inline_1169_y0$$inline_1165$$ && ($currentEl$$inline_1172$$ = $currentWin$$inline_1171$$.frameElement) && ($currentWin$$inline_1171$$ = $currentWin$$inline_1171$$.parent));
    $body$$inline_934_pos$$inline_935_x1$$inline_1164$$ = $goog$math$Coordinate$difference$$($position$$inline_1170_rect$$inline_1162_y1$$inline_1166$$, $goog$style$getPageOffset$$($body$$inline_934_pos$$inline_935_x1$$inline_1164$$));
    $goog$userAgent$IE$$ && !$JSCompiler_StaticMethods_isCss1CompatMode$$($JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$) && ($body$$inline_934_pos$$inline_935_x1$$inline_1164$$ = $goog$math$Coordinate$difference$$($body$$inline_934_pos$$inline_935_x1$$inline_1164$$, $JSCompiler_StaticMethods_getDocumentScroll$$($JSCompiler_inline_result$$923_isBody$$inline_596_isRtl$$inline_925_origBase$$inline_932_s$$inline_1159_visibleBox$$inline_929_x0$$inline_1163$$)));
    $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.left += $body$$inline_934_pos$$inline_935_x1$$inline_1164$$.x;
    $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.top += $body$$inline_934_pos$$inline_935_x1$$inline_1164$$.y
  }
  $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$ = ($absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ & 4 && $goog$style$isRightToLeft$$($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$) ? $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ ^ 
  2 : $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$) & -5;
  $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ = new $goog$math$Coordinate$$($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$ & 2 ? $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.left + $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.width : $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.left, $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$ & 
  1 ? $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.top + $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.height : $o$$inline_1158_parent$$inline_595_rect$$inline_928$$.top);
  $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ && ($absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ = $goog$math$Coordinate$difference$$($absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$, $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$));
  var $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$;
  if($JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ && ($absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$ = $goog$style$getVisibleRectForElement$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$)) && $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$) {
    $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$.top -= $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$.y, $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$.right -= $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$.x, $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$.bottom -= $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$.y, 
    $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$.left -= $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$.x
  }
  a: {
    $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$ = $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$;
    $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$ = $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$.$clone$();
    $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ = ($movableCorner$$1_size$$inline_947$$ & 4 && $goog$style$isRightToLeft$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$) ? $movableCorner$$1_size$$inline_947$$ ^ 2 : $movableCorner$$1_size$$inline_947$$) & -5;
    $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ = $goog$style$getSize$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$);
    $movableCorner$$1_size$$inline_947$$ = $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$.$clone$();
    if($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ || 0 != $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$) {
      ($JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ & 2 ? $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$.x -= $movableCorner$$1_size$$inline_947$$.width + ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ ? $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.right : 0) : $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ && 
      ($absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$.x += $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.left), $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ & 1) ? $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$.y -= $movableCorner$$1_size$$inline_947$$.height + ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ ? 
      $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.bottom : 0) : $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ && ($absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$.y += $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.top)
    }
    if($JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$) {
      if($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$) {
        $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ = $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$;
        $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ = 0;
        if(65 == ($JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 65) && ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x < $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.left || $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x >= $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.right)) {
          $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ &= -2
        }
        if(132 == ($JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 132) && ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y < $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.top || $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y >= $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.bottom)) {
          $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ &= -5
        }
        $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x < $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.left && $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 1 && ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x = $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.left, 
        $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ |= 1);
        $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x < $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.left && ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x + $movableCorner$$1_size$$inline_947$$.width > $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.right && 
        $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 16) && ($movableCorner$$1_size$$inline_947$$.width = Math.max($movableCorner$$1_size$$inline_947$$.width - ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x + $movableCorner$$1_size$$inline_947$$.width - $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.right), 0), $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ |= 
        4);
        $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x + $movableCorner$$1_size$$inline_947$$.width > $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.right && $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 1 && ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x = Math.max($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.right - 
        $movableCorner$$1_size$$inline_947$$.width, $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.left), $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ |= 1);
        $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 2 && ($JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ |= ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x < $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.left ? 16 : 0) | ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.x + 
        $movableCorner$$1_size$$inline_947$$.width > $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.right ? 32 : 0));
        $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y < $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.top && $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 4 && ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y = $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.top, 
        $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ |= 2);
        $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y >= $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.top && ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y + $movableCorner$$1_size$$inline_947$$.height > $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.bottom && 
        $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 32) && ($movableCorner$$1_size$$inline_947$$.height = Math.max($movableCorner$$1_size$$inline_947$$.height - ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y + $movableCorner$$1_size$$inline_947$$.height - $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.bottom), 0), $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ |= 
        8);
        $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y + $movableCorner$$1_size$$inline_947$$.height > $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.bottom && $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 4 && ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y = Math.max($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.bottom - 
        $movableCorner$$1_size$$inline_947$$.height, $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.top), $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ |= 2);
        $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 8 && ($JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$ |= ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y < $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.top ? 64 : 0) | ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.y + 
        $movableCorner$$1_size$$inline_947$$.height > $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$.bottom ? 128 : 0));
        $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ = $JSCompiler_temp_const$$852_corner$$inline_945_moveableParentTopLeft$$inline_594_status$$inline_951$$
      }else {
        $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ = 256
      }
      if($JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ & 496) {
        break a
      }
    }
    $goog$style$setPosition$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$);
    $goog$math$Size$equals$$($absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$, $movableCorner$$1_size$$inline_947$$) || (($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ = $JSCompiler_StaticMethods_isCss1CompatMode$$($goog$dom$getDomHelper$$($goog$dom$getOwnerDocument$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$))), $goog$userAgent$IE$$ && 
    (!$isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ || !$goog$userAgent$isVersion$$("8"))) ? ($JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$ = $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.style, $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$) ? ($goog$userAgent$IE$$ ? ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ = 
    $goog$style$getIePixelValue_$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, $goog$style$getCascadedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "paddingLeft")), $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$ = $goog$style$getIePixelValue_$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, $goog$style$getCascadedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, 
    "paddingRight")), $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$ = $goog$style$getIePixelValue_$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, $goog$style$getCascadedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "paddingTop")), $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ = $goog$style$getIePixelValue_$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, 
    $goog$style$getCascadedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "paddingBottom")), $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ = new $goog$math$Box$$($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$, $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$, $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$, 
    $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$)) : ($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ = $goog$style$getComputedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "paddingLeft"), $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$ = $goog$style$getComputedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, 
    "paddingRight"), $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$ = $goog$style$getComputedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "paddingTop"), $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ = $goog$style$getComputedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "paddingBottom"), 
    $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$ = new $goog$math$Box$$(parseFloat($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$), parseFloat($absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$), parseFloat($absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$), parseFloat($isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$))), 
    $goog$userAgent$IE$$ ? ($absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$ = $goog$style$getIePixelBorder_$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "borderLeft"), $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$ = $goog$style$getIePixelBorder_$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "borderRight"), $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ = 
    $goog$style$getIePixelBorder_$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "borderTop"), $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$ = $goog$style$getIePixelBorder_$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "borderBottom"), $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$ = new $goog$math$Box$$($absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$, 
    $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$, $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, $absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$)) : ($absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$ = $goog$style$getComputedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "borderLeftWidth"), 
    $anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$ = $goog$style$getComputedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "borderRightWidth"), $absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$ = $goog$style$getComputedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "borderTopWidth"), 
    $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$ = $goog$style$getComputedStyle$$($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$, "borderBottomWidth"), $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$ = new $goog$math$Box$$(parseFloat($absolutePos$$inline_599_anchorElementCorner$$inline_587_bottom$$inline_1203_elementSize$$inline_946_top$$inline_1178$$), parseFloat($anchorElement$$inline_586_corner$$inline_598_opt_viewport$$inline_941_right$$inline_1177_top$$inline_1202$$), 
    parseFloat($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$), parseFloat($absolutePos$$inline_937_left$$inline_1176_right$$inline_1201_viewport$$inline_600$$))), $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$.pixelWidth = $movableCorner$$1_size$$inline_947$$.width - $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.left - $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.left - 
    $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.right - $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.right, $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$.pixelHeight = $movableCorner$$1_size$$inline_947$$.height - $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.top - $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.top - 
    $isCss1CompatMode$$inline_952_left$$inline_1200_opt_margin$$4_paddingBox$$inline_954_pos$$inline_949$$.bottom - $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.bottom) : ($JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$.pixelWidth = $movableCorner$$1_size$$inline_947$$.width, $JSCompiler_temp$$inline_948_opt_overflow$$inline_591_overflow$$inline_950_style$$inline_953$$.pixelHeight = $movableCorner$$1_size$$inline_947$$.height) : 
    ($borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$ = $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.style, $goog$userAgent$GECKO$$ ? $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.MozBoxSizing = "border-box" : $goog$userAgent$WEBKIT$$ ? $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.WebkitBoxSizing = "border-box" : $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.boxSizing = 
    "border-box", $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.width = Math.max($movableCorner$$1_size$$inline_947$$.width, 0) + "px", $borderBox$$inline_955_bottom$$inline_1179_movableElement$$4_style$$inline_1183$$.height = Math.max($movableCorner$$1_size$$inline_947$$.height, 0) + "px"))
  }
};
...
$JSCompiler_prototypeAlias$$.$createDom$ = function $$JSCompiler_prototypeAlias$$$$createDom$$() {
  ...
  var $JSCompiler_StaticMethods_setElement$self$$inline_602$$ = this.$popup_$;
  $JSCompiler_StaticMethods_ensureNotVisible_$$($JSCompiler_StaticMethods_setElement$self$$inline_602$$);
  $JSCompiler_StaticMethods_setElement$self$$inline_602$$.$element_$ = $element$$134$$
};
$JSCompiler_prototypeAlias$$.$attach$ = function $$JSCompiler_prototypeAlias$$$$attach$$($anchorElement$$4$$) {
  var $doc$$inline_608_viewportWidth$$inline_610$$ = this.$getDomHelper$().$getOwnerDocument$($anchorElement$$4$$), $viewportElement$$inline_609_viewportHeight$$inline_611$$ = $goog$style$getClientViewportElement$$($doc$$inline_608_viewportWidth$$inline_610$$), $doc$$inline_608_viewportWidth$$inline_610$$ = $viewportElement$$inline_609_viewportHeight$$inline_611$$.offsetWidth, $viewportElement$$inline_609_viewportHeight$$inline_611$$ = $viewportElement$$inline_609_viewportHeight$$inline_611$$.offsetHeight, 
  $anchorElementOffset$$inline_612$$ = $goog$style$getPageOffset$$($anchorElement$$4$$), $anchorElementSize$$inline_613$$ = $goog$style$getSize$$($anchorElement$$4$$), $anchorType$$inline_614$$ = 0;
  $doc$$inline_608_viewportWidth$$inline_610$$ - $anchorElementOffset$$inline_612$$.x - $anchorElementSize$$inline_613$$.width > $anchorElementOffset$$inline_612$$.x && ($anchorType$$inline_614$$ += 1);
  $viewportElement$$inline_609_viewportHeight$$inline_611$$ - $anchorElementOffset$$inline_612$$.y - $anchorElementSize$$inline_613$$.height > $anchorElementOffset$$inline_612$$.y && ($anchorType$$inline_614$$ += 2);
  $JSCompiler_StaticMethods_setAnchoredPosition_$$(this, $anchorElement$$4$$, $goog$ui$Bubble$corners_$$[$anchorType$$inline_614$$])
};
...
$JSCompiler_prototypeAlias$$.$setPosition$ = function $$JSCompiler_prototypeAlias$$$$setPosition$$($position$$2$$) {
  $position$$2$$ instanceof $goog$positioning$AnchoredPosition$$ ? $JSCompiler_StaticMethods_setAnchoredPosition_$$(this, $position$$2$$.element, $position$$2$$.$corner$) : $JSCompiler_alias_THROW$$(Error("Bubble only supports absolute and anchored positions!"))
};
...
$JSCompiler_prototypeAlias$$.$setVisible$ = function $$JSCompiler_prototypeAlias$$$$setVisible$$($visible$$6$$) {
  if($visible$$6$$ && !this.$popup_$.$isVisible$()) {
    ...
    var $JSCompiler_temp_const$$844_closeButton$$inline_618_messageDiv$$inline_617$$ = this.$getElement$(), $bubbleTopClass$$inline_960$$, $bubbleBottomClass$$inline_961$$;
    switch(this.$popup_$.$popupCorner_$) {
      case 0:
        $bubbleTopClass$$inline_960$$ = this.$config_$.$cssBubbleTopLeftAnchor$;
        $bubbleBottomClass$$inline_961$$ = this.$config_$.$cssBubbleBottomNoAnchor$;
        break;
      case 2:
        $bubbleTopClass$$inline_960$$ = this.$config_$.$cssBubbleTopRightAnchor$;
        $bubbleBottomClass$$inline_961$$ = this.$config_$.$cssBubbleBottomNoAnchor$;
        break;
      case 1:
        $bubbleTopClass$$inline_960$$ = this.$config_$.$cssBubbleTopNoAnchor$;
        $bubbleBottomClass$$inline_961$$ = this.$config_$.$cssBubbleBottomLeftAnchor$;
        break;
      case 3:
        $bubbleTopClass$$inline_960$$ = this.$config_$.$cssBubbleTopNoAnchor$;
        $bubbleBottomClass$$inline_961$$ = this.$config_$.$cssBubbleBottomRightAnchor$;
        break;
      default:
        $JSCompiler_alias_THROW$$(Error("This corner type is not supported by bubble!"))
    }
    var $message$$inline_962$$ = $JSCompiler_alias_NULL$$, $message$$inline_962$$ = "object" == typeof this.$message_$ ? '<div id="' + this.$messageId_$ + '">' : this.$message_$;
    $JSCompiler_temp_const$$844_closeButton$$inline_618_messageDiv$$inline_617$$.innerHTML = '<table border=0 cellspacing=0 cellpadding=0 style="z-index:1" width=' + this.$config_$.$bubbleWidth$ + '><tr><td colspan=4 class="' + $bubbleTopClass$$inline_960$$ + '"><tr><td class="' + this.$config_$.$cssBubbleLeft$ + '"><td class="' + this.$config_$.$cssBubbleFont$ + '" style="padding:0 4;background:white">' + $message$$inline_962$$ + '<td id="' + this.$closeButtonId_$ + '" class="' + this.$config_$.$cssCloseButton$ + 
    '"/><td class="' + this.$config_$.$cssBubbleRight$ + '"><tr><td colspan=4 class="' + $bubbleBottomClass$$inline_961$$ + '"></table>';
    "object" == typeof this.$message_$ && ($JSCompiler_temp_const$$844_closeButton$$inline_618_messageDiv$$inline_617$$ = this.$getDomHelper$().$getElement$(this.$messageId_$), this.$getDomHelper$().appendChild($JSCompiler_temp_const$$844_closeButton$$inline_618_messageDiv$$inline_617$$, this.$message_$));
    $JSCompiler_temp_const$$844_closeButton$$inline_618_messageDiv$$inline_617$$ = this.$getDomHelper$().$getElement$(this.$closeButtonId_$);
    this.$listener_$ = $goog$events$listen$$($JSCompiler_temp_const$$844_closeButton$$inline_618_messageDiv$$inline_617$$, "click", this.$hideBubble_$, $JSCompiler_alias_FALSE$$, this);
...
function $JSCompiler_StaticMethods_setAnchoredPosition_$$($JSCompiler_StaticMethods_setAnchoredPosition_$self$$, $anchorElement$$5$$, $corner$$14$$) {
  ...
  var $JSCompiler_temp_const$$17$$ = $JSCompiler_StaticMethods_setAnchoredPosition_$self$$.$popup_$, $margin$$inline_625$$ = new $goog$math$Box$$(0, 0, 0, 0);
  $corner$$14$$ & 2 ? $margin$$inline_625$$.right -= $JSCompiler_StaticMethods_setAnchoredPosition_$self$$.$config_$.$marginShift$ : $margin$$inline_625$$.left -= $JSCompiler_StaticMethods_setAnchoredPosition_$self$$.$config_$.$marginShift$;
  $JSCompiler_temp_const$$17$$.$margin_$ = $margin$$inline_625$$ == $JSCompiler_alias_NULL$$ || $margin$$inline_625$$ instanceof $goog$math$Box$$ ? $margin$$inline_625$$ : new $goog$math$Box$$($margin$$inline_625$$, $JSCompiler_alias_VOID$$, $JSCompiler_alias_VOID$$, $JSCompiler_alias_VOID$$);
...
$JSCompiler_prototypeAlias$$.$update_$ = function $$JSCompiler_prototypeAlias$$$$update_$$() {
  ...
  if(this.$initialized_$) {
    ...
    $JSCompiler_alias_FALSE$$), $defaultStep_step$$inline_634$$;
    $defaultStep_step$$inline_634$$ = 0;
    $defaultStep_step$$inline_634$$ = 1 == this.$configuration_$ ? this.$blockPoolAllday_$.$gridSize$.height : 2 == this.$configuration_$ ? 24 : this.$blockPoolMonth_$.$gridSize$.width / 7;
    var $maxSize_size$$inline_637$$;
    $maxSize_size$$inline_637$$ = 0;
    $maxSize_size$$inline_637$$ = 1 == this.$configuration_$ ? this.$blockPoolAllday_$.$gridSize$.height : 2 == this.$configuration_$ ? 1152 : this.$blockPoolMonth_$.$gridSize$.width;
    var $minIndex$$ = 0, $maxIndex$$ = 0;
    $startCellPrimaryCoord$$ == $currentCellPrimaryCoord$$ ? ($minIndex$$ = Math.min($startCellSecondaryCoord$$, $currentCellSecondaryCoord$$), $maxIndex$$ = Math.max($startCellSecondaryCoord$$, $currentCellSecondaryCoord$$), this.$rects_$.push(this.$getRect_$($blockPositionForStartCell$$, $minIndex$$ * $defaultStep_step$$inline_634$$, $blockSizeForStartCell$$, ($maxIndex$$ - $minIndex$$ + 1) * $defaultStep_step$$inline_634$$))) : (this.$rects_$.push(this.$getRect_$($blockPositionForStartCell$$, 
    $currentCellPrimaryCoord$$ > $startCellPrimaryCoord$$ ? $startCellSecondaryCoord$$ * $defaultStep_step$$inline_634$$ : 0, $blockSizeForStartCell$$, $currentCellPrimaryCoord$$ > $startCellPrimaryCoord$$ ? $maxSize_size$$inline_637$$ - $startCellSecondaryCoord$$ * $defaultStep_step$$inline_634$$ : ($startCellSecondaryCoord$$ + 1) * $defaultStep_step$$inline_634$$)), this.$rects_$.push(this.$getRect_$($blockPositionForCurrentCell$$, $currentCellPrimaryCoord$$ > $startCellPrimaryCoord$$ ? 0 : $currentCellSecondaryCoord$$ * 
    $defaultStep_step$$inline_634$$, $blockSizeForCurrentCell$$, $currentCellPrimaryCoord$$ > $startCellPrimaryCoord$$ ? ($currentCellSecondaryCoord$$ + 1) * $defaultStep_step$$inline_634$$ : $maxSize_size$$inline_637$$ - $currentCellSecondaryCoord$$ * $defaultStep_step$$inline_634$$)), 1 < Math.abs($currentCellPrimaryCoord$$ - $startCellPrimaryCoord$$) && ($minIndex$$ = Math.min($startCellPrimaryCoord$$, $currentCellPrimaryCoord$$), $maxIndex$$ = Math.max($startCellPrimaryCoord$$, $currentCellPrimaryCoord$$), 
    this.$rects_$.push(this.$getRect_$($JSCompiler_StaticMethods_getBlockPositionOrSize_$$(this, $minIndex$$ + 1, $JSCompiler_alias_TRUE$$), 0, $JSCompiler_StaticMethods_getBlockPositionOrSize_$$(this, $maxIndex$$, $JSCompiler_alias_TRUE$$) - $JSCompiler_StaticMethods_getBlockPositionOrSize_$$(this, $minIndex$$ + 1, $JSCompiler_alias_TRUE$$), $maxSize_size$$inline_637$$))));
...
function $rflect$cal$MainPane$$($JSCompiler_StaticMethods_setTitle$self$$inline_641_aViewManager$$11$$, $aTimeManager$$8$$, $aEventManager$$5$$, $aContainerSizeMonitor$$4$$, $aBlockManager$$) {
  $goog$ui$Component$$.call(this, $JSCompiler_alias_VOID$$);
  this.$viewManager_$ = $JSCompiler_StaticMethods_setTitle$self$$inline_641_aViewManager$$11$$;
  ...
  this.$timeMarker_$ = new $rflect$cal$TimeMarker$$($JSCompiler_StaticMethods_setTitle$self$$inline_641_aViewManager$$11$$, $aTimeManager$$8$$);
  ...
  this.$selectionMask_$ = new $rflect$cal$MainPaneSelectionMask$$($JSCompiler_StaticMethods_setTitle$self$$inline_641_aViewManager$$11$$, this, $aTimeManager$$8$$, this.$blockManager_$.$blockPoolWeek$, this.$blockManager_$.$blockPoolAllday$, this.$blockManager_$.$blockPoolMonth$);
  ...
  this.$moRegistry_$ = new $rflect$cal$MouseOverRegistry$$;
  $JSCompiler_StaticMethods_setTitle$self$$inline_641_aViewManager$$11$$ = this.$dialog_$ = new $goog$ui$Dialog$$;
  $JSCompiler_StaticMethods_setTitle$self$$inline_641_aViewManager$$11$$.$title_$ = "new event";
  $JSCompiler_StaticMethods_setTitle$self$$inline_641_aViewManager$$11$$.$titleTextEl_$ && $goog$dom$setTextContent$$($JSCompiler_StaticMethods_setTitle$self$$inline_641_aViewManager$$11$$.$titleTextEl_$, "new event");
  this.$dialog_$.$setContent$("<input/>");
  $JSCompiler_StaticMethods_addChild$$(this.$dialog_$, new $goog$ui$Button$$("OK", $goog$ui$FlatButtonRenderer$$.$getInstance$()));
  $JSCompiler_StaticMethods_addChild$$(this.$dialog_$, new $goog$ui$Button$$("Cancel", $goog$ui$FlatButtonRenderer$$.$getInstance$()));
  $JSCompiler_StaticMethods_setBackgroundElementOpacity$$(this.$dialog_$, 0);
  $JSCompiler_StaticMethods_addChild$$(this, this.$dialog_$);
  new $goog$ui$Bubble$$("<div>New event</div>")
}
$goog$inherits$$($rflect$cal$MainPane$$, $rflect$cal$Component$$);
$JSCompiler_prototypeAlias$$ = $rflect$cal$MainPane$$.prototype;
$JSCompiler_prototypeAlias$$.$updateBeforeRedraw$ = function $$JSCompiler_prototypeAlias$$$$updateBeforeRedraw$$() {
  var $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$ = this.$containerSizeMonitor_$.$getSize$();
  516 > $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.width && ($JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.width = 516);
  374 > $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.height && ($JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.height = 374);
  $JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$) ? (this.$scrollablesCombinedWkSize_$ = $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$clone$(), this.$scrollablesCombinedWkSize_$.height -= 113, this.$scrollablesCombinedWkSize_$.width -= 229, this.$scrollablesCombinedWkSize_$.width -= this.$containerSizeMonitor_$.$scrollbarWidth$, this.$alldayGridContainerSize$ = this.$scrollablesCombinedWkSize_$.$clone$(), this.$gridContainerSize$ = this.$scrollablesCombinedWkSize_$.$clone$(), 
  this.$gridSize$ = this.$gridContainerSize$.$clone$(), this.$gridSize$.height = 1152, this.$blockManager_$.$blockPoolAllday$.$expanded$ || (this.$alldayGridContainerSize$.height = 47, this.$alldayGridSize$ = this.$alldayGridContainerSize$.$clone$())) : $JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$) && (this.$gridContainerSize$ = $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$clone$(), this.$gridContainerSize$.height -= 78, this.$gridContainerSize$.width -= 
  ...
  var $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$ = this.$blockManager_$, $aGridSize$$inline_965$$ = this.$gridSize$, $aGridContainerSize$$inline_966$$ = this.$gridContainerSize$, $opt_alldayGridSize$$inline_967$$ = this.$alldayGridSize$, $opt_alldayGridContainerSize$$inline_968$$ = this.$alldayGridContainerSize$;
  $JSCompiler_StaticMethods_isInWeekMode$$($JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$viewManager_$) ? ($JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$blockPoolWeek$.$gridContainerSize$ = $aGridContainerSize$$inline_966$$, $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$blockPoolWeek$.$gridSize$ = $aGridSize$$inline_965$$, $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$blockPoolAllday$.$gridSize$ = 
  $opt_alldayGridSize$$inline_967$$, $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$blockPoolAllday$.$gridContainerSize$ = $opt_alldayGridContainerSize$$inline_968$$) : $JSCompiler_StaticMethods_isInMonthMode$$($JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$viewManager_$) && ($JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$blockPoolMonth$.$gridContainerSize$ = $aGridContainerSize$$inline_966$$, 
  $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$.$blockPoolMonth$.$gridSize$ = $aGridSize$$inline_965$$);
  this.$blockManager_$.update();
  if($JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$) && (this.$blockManager_$.$blockPoolAllday$.$expanded$ && ($JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$ = 0, $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$ = Math.floor(this.$scrollablesCombinedWkSize_$.height / 2), this.$alldayGridContainerSize$.height = this.$alldayGridSize$.height > $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$ ? 
  $JSCompiler_StaticMethods_setSizes$self$$inline_964_alldayBlockMaxHeight_containerSize$$ : this.$alldayGridSize$.height), this.$gridContainerSize$.height = this.$scrollablesCombinedWkSize_$.height - this.$alldayGridContainerSize$.height, this.$alldayGridContainerSize$.height += this.$blockManager_$.$blockPoolWeek$.$expanded$ ? this.$containerSizeMonitor_$.$scrollbarWidth$ : 0, 1152 < this.$gridContainerSize$.height)) {
...
$JSCompiler_prototypeAlias$$.$buildBodyInternal$ = function $$JSCompiler_prototypeAlias$$$$buildBodyInternal$$($aSb$$56$$) {
  if($JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$)) {
    for(var $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$ = this.$mainPaneBuilder_$, $offset$$inline_650_offset$$inline_655$$ = 0, $length$$inline_651_length$$inline_656$$ = $rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$.length;++$offset$$inline_650_offset$$inline_655$$ < $length$$inline_651_length$$inline_656$$ - 1;) {
      switch($aSb$$56$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$offset$$inline_650_offset$$inline_655$$]), $offset$$inline_650_offset$$inline_655$$) {
        case 5:
          var $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
          $aSb$$56$$;
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$.$blockPoolMonth_$.$expanded$ ? $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$.$containerSizeMonitor_$.$scrollbarWidth$ + 
          2) : $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append(2);
          break;
        case 8:
          for(var $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
          $aSb$$56$$, $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $offset$$inline_650_offset$$inline_655$$, $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ = 
          $goog$i18n$DateTimeSymbols_en$$.$FIRSTDAYOFWEEK$, $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ = 0, $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ = 0;7 > 
          $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$;$blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$++) {
            0 < $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ && $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$]), 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$), 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ + 
            1]), $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ = ($aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ + 1) % 7, $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($goog$i18n$DateTimeSymbols_en$$.$WEEKDAYS$[$dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$]), 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ + 
            2])
          }
          $offset$$inline_650_offset$$inline_655$$ += 2;
          break;
        case 15:
          $aSb$$56$$.append($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$.$blockPoolMonth_$.$gridContainerSize$.height);
          break;
        case 19:
          $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$;
          $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $aSb$$56$$;
          $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ = $offset$$inline_650_offset$$inline_655$$;
          $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ = 0;
          for($blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolMonth_$.$blocksNumber_$;$dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ < 
          $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$;$dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$++) {
            0 < $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ && $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$]), 
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            1]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolMonth_$.$blocks$[$dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$].size), 
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            2]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            3]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            4]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            5]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolMonth_$.$blocks$[$dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$].$expanded$ ? 
            "mn-row-zippy-expanded" : "mn-row-zippy-collapsed"), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            6]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            7]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            8])
          }
          $offset$$inline_650_offset$$inline_655$$ += 7;
          break;
        case 30:
          $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
          $aSb$$56$$;
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$.$blockPoolMonth_$.$expanded$ ? $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append("mpbs-mn-scroll-vert-on") : 
          $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append("mpbs-mn-scroll-vert-off");
          break;
        case 32:
          $aSb$$56$$.append($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$.$blockPoolMonth_$.$gridSize$.height);
          break;
        case 35:
          for(var $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$, $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $aSb$$56$$, $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ = 
          $offset$$inline_650_offset$$inline_655$$, $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ = $JSCompiler_alias_NULL$$, $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ = 
          0, $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolMonth_$.$blocksNumber_$;$blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ < 
          $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$;$blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$++) {
            0 < $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ && $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$]), 
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            1]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolMonth_$.$blocks$[$blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$].size), 
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            2]), $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$timeManager_$.$daySeries$[7 * 
            $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$], $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$.$getWeekNumber$()), 
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            3])
          }
          $offset$$inline_650_offset$$inline_655$$ += 3;
          break;
        case 43:
          $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
          $aSb$$56$$;
          $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $offset$$inline_650_offset$$inline_655$$;
          for($aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ = 0;7 > $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$;$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$++) {
            0 < $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ && $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$]), 
            6 == $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ && $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append(" weekgrid-col-last"), 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ + 
            1])
          }
          $offset$$inline_650_offset$$inline_655$$++;
          break;
        case 48:
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$.$buildMonthGridRows_$($aSb$$56$$, $offset$$inline_650_offset$$inline_655$$), $offset$$inline_650_offset$$inline_655$$ += 32
      }
    }
  }else {
    if($JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$)) {
      $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$ = this.$mainPaneBuilder_$;
      $offset$$inline_650_offset$$inline_655$$ = 0;
      for($length$$inline_651_length$$inline_656$$ = $rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$.length;++$offset$$inline_650_offset$$inline_655$$ < $length$$inline_651_length$$inline_656$$ - 1;) {
        switch($aSb$$56$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$offset$$inline_650_offset$$inline_655$$]), $offset$$inline_650_offset$$inline_655$$) {
          case 3:
            $aSb$$56$$.append($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$.$blockPoolAllday_$.$expanded$ ? "goog-zippy-expanded" : "goog-zippy-collapsed");
            break;
          case 8:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$;
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $aSb$$56$$;
            $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ = $offset$$inline_650_offset$$inline_655$$;
            $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$timeManager_$.$daySeries$;
            $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ = 0;
            $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$gridSize$.width;
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 * ($blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ / $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolAllday_$.$gridContainerSize$.width)).toFixed(4));
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            1]);
            for(var $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ = 0, $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$blocksNumber_$;$blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ < 
            $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$;$blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$++) {
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              2]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              3]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 * ($blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ / $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$)).toFixed(4)), 
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ += $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$blocks$[$blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$].size, 
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              4]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 - 100 * ($blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ / $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$)).toFixed(4)), 
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              5]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append(-100 * $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              6]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append(1 != $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$ ? "dayname-wk-inner" : ""), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              7]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_format$$($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$weekDayNameFormatWeek_$, 
              $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$[$blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$])), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              8])
            }
            $offset$$inline_650_offset$$inline_655$$ += 8;
            break;
          case 19:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$;
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $aSb$$56$$;
            $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ = $offset$$inline_650_offset$$inline_655$$;
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolAllday_$.$expanded$ ? 
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append("mphs-scroll-vert-on ") : $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append("mphs-scroll-vert-off ");
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$expanded$ ? 
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append("mphs-scroll-horz-on") : $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append("mphs-scroll-horz-off");
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            1]);
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolAllday_$.$gridContainerSize$.height);
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
          ...
          case 23:
            ...
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $aSb$$56$$;
            $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ = $offset$$inline_650_offset$$inline_655$$;
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolAllday_$.$gridSize$.height);
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            1]);
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 * ($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$gridSize$.width / 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolAllday_$.$gridContainerSize$.width)).toFixed(4));
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            2]);
            $offset$$inline_650_offset$$inline_655$$ += 2;
          ...
          case 26:
            ...
            $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ = 0;
            $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$gridSize$.width;
            $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolAllday_$.$blocks$[0].$sparseArrays$;
            $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ = 0;
            for($aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$blocksNumber_$;$blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ < 
            $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$;$blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$++) {
              0 < $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ && $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              1]);
              $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ == $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$ - 1 && $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append(" weekgrid-col-last");
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              2]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 * ($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ / 
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$)).toFixed(4));
              $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ += $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$blocks$[$blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$].size;
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              3]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 - 100 * ($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ / 
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$)).toFixed(4));
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              4]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append(-100 * $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$);
              ...
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              8]);
              var $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$ = $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$, $aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$ = $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              9, $aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolAllday_$.$blocks$[0];
              $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$]);
              $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$ + 1]);
              $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$.append(!$aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$.$expanded$ && $aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$.$couldBeExpanded$ ? "expand-sign-wk-ad-collapsed" : $aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$.$expanded$ && $aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$.$couldBeCollapsed$ ? "expand-sign-wk-ad-expanded" : 
              "");
              $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$ + 2]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              12]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              13]);
              ...
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              14]);
              for(var $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$ = $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$, $aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$ = $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$[$blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$], 
              $aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$eventManager_$, 
              $chip$$inline_1039$$ = $JSCompiler_alias_VOID$$, $chipCounter$$inline_1040$$ = 0, $length$$inline_1041$$ = $aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$.length;$chipCounter$$inline_1040$$ < $length$$inline_1041$$;$chipCounter$$inline_1040$$++) {
                ($chip$$inline_1039$$ = $aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$[$chipCounter$$inline_1040$$]) && $rflect$cal$MainPaneBuilder$buildMonthBlockChip_$$($aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$, 71, $aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$, $chip$$inline_1039$$, 0, $chipCounter$$inline_1040$$, 0, $JSCompiler_alias_TRUE$$)
              }
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              15]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            ...
            $offset$$inline_650_offset$$inline_655$$ += 17;
            break;
          case 48:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$;
            ...
            $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ = 0;
            $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$gridSize$.width;
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 * ($blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ / $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$gridContainerSize$.width)).toFixed(4));
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            1]);
            $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ = 0;
            for($blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$blocksNumber_$;$blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ < 
            $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$;$blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$++) {
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              2]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 * ($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ / 
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$)).toFixed(4)), $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ += $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$blocks$[$blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$].size, 
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              3]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 - 100 * ($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ / 
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$)).toFixed(4)), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              4]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append(-100 * $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              5]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              6]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              7]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$blocks$[$blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$].$expanded$ ? 
              "wk-col-zippy-expanded" : "wk-col-zippy-collapsed"), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              8]), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              9])
            }
            $offset$$inline_650_offset$$inline_655$$ += 9;
            break;
          case 62:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$;
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $aSb$$56$$;
            $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ = $offset$$inline_650_offset$$inline_655$$;
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$gridContainerSize$.height);
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
            1]);
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$expanded$ ? 
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append("mpbs-wk-scroll-horz-on") : $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append("mpbs-wk-scroll-horz-off");
            $offset$$inline_650_offset$$inline_655$$++;
            break;
          case 66:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
            $aSb$$56$$;
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($rflect$cal$TimeMarker$HEAD_PARTS_$$[0]);
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($JSCompiler_StaticMethods_getPosition_$$($JSCompiler_alias_TRUE$$));
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($rflect$cal$TimeMarker$HEAD_PARTS_$$[1]);
            break;
          case 67:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$;
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $aSb$$56$$;
            $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ = $offset$$inline_650_offset$$inline_655$$;
            $dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ = 100 * ($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$gridSize$.width / 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$gridContainerSize$.width);
            if(1 in $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$cache_$ && 
            2 in $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$cache_$) {
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$cache_$[1]), 
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$), $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$cache_$[2])
            }else {
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$ = new $goog$string$StringBuffer$$;
              $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ = new $goog$i18n$DateTimeFormat$$($goog$i18n$DateTimeSymbols_en$$.$TIMEFORMATS$[3]);
              $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ = new $goog$date$DateTime$$;
              $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$ = new $goog$date$Interval$$(0, 0, 0, 0, 30);
              $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$.setHours(0);
              $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$.setMinutes(0);
              $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$.setSeconds(0);
              for($aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$ = 0;48 > $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$;$aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$++, $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$.add($aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$)) {
                0 < $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$ && $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$]), 
                $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append("grid-table-row "), 0 == $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$ % 2 ? ($blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append("grid-table-row-even"), 
                $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
                1]), $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append("hl-even")) : ($blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append("grid-table-row-odd"), $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
                1]), $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append("hl-odd")), $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
                2]), $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($JSCompiler_StaticMethods_format$$($blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$, $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$)), 
                $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
                3])
              }
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              ...
              6]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$cache_$[1] = 
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.toString());
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.clear();
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$);
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              7]);
              for($aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$ = 0;48 > $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$;$aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$++) {
                $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
                8]), $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append("grid-table-row "), 0 == $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$ % 2 ? $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append("grid-table-row-even") : 
                $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append("grid-table-row-odd"), $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
                9])
              }
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$cache_$[2] = 
          ...
          case 78:
            ...
            $aSb$$56$$;
            $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ = $offset$$inline_650_offset$$inline_655$$;
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append(100 * 
            ($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$.$blockPoolWeek_$.$gridSize$.width / $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_648_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_653$$.$blockPoolWeek_$.$gridContainerSize$.width));
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$ + 
            1]);
            $offset$$inline_650_offset$$inline_655$$++;
            break;
          case 80:
            ...
            for($blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$blocksNumber_$;$blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ < 
            $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$;$blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$++) {
              0 < $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ && $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              1]);
              $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$ == $blocksNumber$$inline_1049_blocksNumber$$inline_1077_colCounter$$inline_1014_colCounter$$inline_1031_timeCounter$$inline_1063$$ - 1 && $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append(" weekgrid-col-last");
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              2]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append((100 * ($dateInFirstCol$$inline_997_dayNameNumber$$inline_976_daySeries$$inline_1011_gridRowsWidth$$inline_1060_prevColsCumulativeSize$$inline_1028_prevColsCumulativeSize$$inline_1046_prevColsCumulativeSize$$inline_1074_rowCounter$$inline_985$$ / 
              $blocksNumber$$inline_986_counter$$inline_977_gridWidth$$inline_1029_gridWidth$$inline_1047_gridWidth$$inline_1075_prevColsCumulativeSize$$inline_1012_rowCounter$$inline_998_sb$$inline_1061$$)).toFixed(4));
              ...
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              4]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append(-100 * $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              5]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              6]);
              ...
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              7]);
              $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$ = $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$;
              $aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$ = $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 8;
              $aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$.$blocks$[$blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$];
              for($aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$ = 0;6 > $aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$;$aEventManager$$inline_1038_block$$inline_1035_counter$$inline_1190$$++) {
                $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$]), $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$.append(!$aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$.$expanded$ && $aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$.$couldBeExpanded$ ? 
                "expand-sign-wk-collapsed" : $aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$.$expanded$ && $aChips$$inline_1037_aOffset$$inline_1034_block$$inline_1189$$.$couldBeCollapsed$ ? "expand-sign-wk-expanded" : ""), $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1187_aSb$$inline_1033_aSb$$inline_1036_counter$$inline_1065$$ + 1])
              }
              $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$timeManager_$.$currentDay_$ && 
              $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$timeManager_$.$currentDay_$.$equals$($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$timeManager_$.$daySeries$[$blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$], 
              7) && ($aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              10]), $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$ = $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$, $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$.append($rflect$cal$TimeMarker$HEAD_PARTS_$$[2]), 
              $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$.append($JSCompiler_StaticMethods_getPosition_$$($JSCompiler_alias_FALSE$$)), $aSb$$inline_1186_aSb$$inline_1192_blocksNumber$$inline_1015_blocksNumber$$inline_1032_timeIncrement$$inline_1064$$.append($rflect$cal$TimeMarker$HEAD_PARTS_$$[3]));
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              11]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              12]);
              ...
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              13]);
              $rflect$cal$MainPaneBuilder$forEachChip_$$($aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$, $aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              14, $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$eventManager_$, 
              $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_1021_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_1008_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_1057_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_982_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_1017_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_1051_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_1043_JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$inline_1025_JSCompiler_StaticMethods_buildWeekGridCols_$self$$inline_1071_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_994_aSb$$inline_1001_aSb$$inline_1055_aSb$$inline_1068_aSb$$inline_971_aSb$$inline_973_aSb$$inline_989$$.$blockPoolWeek_$, 
              $blocksNumber$$inline_999_colCounter$$inline_1048_colCounter$$inline_1076_gridWidth$$inline_1013_sparseArrays$$inline_1030_timeFormat$$inline_1062$$, $rflect$cal$MainPaneBuilder$buildWeekBlockChip_$$);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              25]);
              $aOffset$$inline_1002_aOffset$$inline_1069_aOffset$$inline_974_aSb$$inline_1009_aSb$$inline_1018_aSb$$inline_1022_aSb$$inline_1026_aSb$$inline_1044_aSb$$inline_1052_aSb$$inline_1058_aSb$$inline_1072_aSb$$inline_983_aSb$$inline_995$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1010_aOffset$$inline_1019_aOffset$$inline_1023_aOffset$$inline_1027_aOffset$$inline_1045_aOffset$$inline_1053_aOffset$$inline_1059_aOffset$$inline_1073_aOffset$$inline_984_aOffset$$inline_996_counter$$inline_1003_dayNamesFirstNumber$$inline_975$$ + 
              26])
            }
            $offset$$inline_650_offset$$inline_655$$ += 26
        }
      }
    }
  }
...
$JSCompiler_prototypeAlias$$.$onClick_$ = function $$JSCompiler_prototypeAlias$$$$onClick_$$($JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$) {
  var $target$$51$$ = $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$.target, $id$$12$$ = $target$$51$$.id, $className$$34$$ = $target$$51$$.className, $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$ = $JSCompiler_alias_FALSE$$, 
  $day$$inline_664_index$$64_index$$inline_663$$ = 0;
  $JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$) ? /mn\-zippy\-row\d{1}/.test($id$$12$$) ? ($day$$inline_664_index$$64_index$$inline_663$$ = /\d{1}/.exec($id$$12$$)[0], $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$ = this.$blockManager_$.$blockPoolMonth$, $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$.$blocks$[$day$$inline_664_index$$64_index$$inline_663$$].$expanded$ = 
  !$JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$.$blocks$[$day$$inline_664_index$$64_index$$inline_663$$].$expanded$, $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$), this.$blockManager_$.$blockPoolMonth$.$expanded$ || 
  (this.$blockManager_$.$blockPoolMonth$.scrollTop = 0), $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$ = $JSCompiler_alias_TRUE$$) : $JSCompiler_StaticMethods_isDaynumLabel_$$(this, $className$$34$$) ? $JSCompiler_StaticMethods_onDaynumLabelClick_$$(this, $id$$12$$) : $JSCompiler_StaticMethods_isWeeknumLabel_$$(this, $className$$34$$) && ($day$$inline_664_index$$64_index$$inline_663$$ = 
  $rflect$string$getNumericIndex$$($target$$51$$.parentNode.id), $_log$$("index", $day$$inline_664_index$$64_index$$inline_663$$), ($day$$inline_664_index$$64_index$$inline_663$$ = this.$timeManager_$.$daySeries$[7 * $day$$inline_664_index$$64_index$$inline_663$$]) && $JSCompiler_StaticMethods_switchView_$$(this, $day$$inline_664_index$$64_index$$inline_663$$, 3)) : $JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$) && (/wk\-zippy\-col\d{1}/.test($id$$12$$) ? ($day$$inline_664_index$$64_index$$inline_663$$ = 
  /\d{1}/.exec($id$$12$$)[0], $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$ = this.$blockManager_$.$blockPoolWeek$, $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$.$blocks$[$day$$inline_664_index$$64_index$$inline_663$$].$expanded$ = 
  !$JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$.$blocks$[$day$$inline_664_index$$64_index$$inline_663$$].$expanded$, $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$), this.$blockManager_$.$blockPoolWeek$.$expanded$ || 
  (this.$blockManager_$.$blockPoolWeek$.scrollLeft = 0), $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$ = $JSCompiler_alias_TRUE$$) : /daynames\-zippy/.test($id$$12$$) ? ($JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$ = 
  this.$blockManager_$.$blockPoolAllday$, $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$.$blocks$[0].$expanded$ = !$JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$.$blocks$[0].$expanded$, $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$), 
  $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$ = $JSCompiler_alias_TRUE$$) : $JSCompiler_StaticMethods_isDaynumLabel_$$(this, $className$$34$$) && $JSCompiler_StaticMethods_onDaynumLabelClick_$$(this, $target$$51$$.parentNode.id));
  $JSCompiler_StaticMethods_toggleBlock$self$$inline_658_JSCompiler_StaticMethods_toggleBlock$self$$inline_666_JSCompiler_StaticMethods_toggleBlock$self$$inline_669_aEvent$$14_zippyClicked$$ && (this.$updateBeforeRedraw$(), this.$updateByRedraw$())
};
...
function $JSCompiler_StaticMethods_switchView_$$($JSCompiler_StaticMethods_switchView_$self$$, $aDate$$10_opt_date$$inline_1092$$, $aType$$) {
  $aDate$$10_opt_date$$inline_1092$$ = new $goog$date$DateTime$$($aDate$$10_opt_date$$inline_1092$$.getYear(), $aDate$$10_opt_date$$inline_1092$$.getMonth(), $aDate$$10_opt_date$$inline_1092$$.getDate());
  $JSCompiler_StaticMethods_switchView_$self$$.$timeManager_$.$basis$ = $aDate$$10_opt_date$$inline_1092$$ || new $goog$date$Date$$;
...
function $JSCompiler_StaticMethods_updateEventMap$$($JSCompiler_StaticMethods_updateEventMap$self$$, $aChips$$2$$, $opt_createArrays$$, $opt_arraysLength$$) {
  for(var $counter$$24$$ = 0;$counter$$24$$ < $JSCompiler_StaticMethods_updateEventMap$self$$.$blocksNumber_$;$counter$$24$$++) {
    var $JSCompiler_StaticMethods_computeEventMap$self$$inline_678_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_704$$ = $JSCompiler_StaticMethods_updateEventMap$self$$.$blocks$[$counter$$24$$], $aChips$$inline_679_blobs$$inline_706$$ = $aChips$$2$$[$counter$$24$$], $i$$inline_680_sparseArrays$$inline_707$$ = 0, $aDaysNumber$$inline_705_blobCounter$$inline_709_length$$inline_681$$ = 0, $blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$ = [], $blob$$inline_711_currentBlob$$inline_683$$ = 
    [], $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = 0, $blobEntryCounter$$inline_712_maxCol$$inline_685$$ = 0;
    $aChips$$inline_679_blobs$$inline_706$$.sort($rflect$cal$blocks$Block$sort$$);
    for(var $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ = $JSCompiler_alias_VOID$$, $chip$$inline_715_colEndArray$$inline_687$$ = [], $i$$inline_680_sparseArrays$$inline_707$$ = 0, $aDaysNumber$$inline_705_blobCounter$$inline_709_length$$inline_681$$ = $aChips$$inline_679_blobs$$inline_706$$.length;$i$$inline_680_sparseArrays$$inline_707$$ < $aDaysNumber$$inline_705_blobCounter$$inline_709_length$$inline_681$$;++$i$$inline_680_sparseArrays$$inline_707$$) {
      var $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$ = $aChips$$inline_679_blobs$$inline_706$$[$i$$inline_680_sparseArrays$$inline_707$$], $itemStart$$inline_689_start$$inline_717$$ = $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$.start, $chipCounter$$inline_718_itemEnd$$inline_690$$ = $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$.end;
      $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ || ($blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ = $chipCounter$$inline_718_itemEnd$$inline_690$$);
      $blob$$inline_711_currentBlob$$inline_683$$.length && ($blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ && $itemStart$$inline_689_start$$inline_717$$ >= $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$) && ($blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$.push({blob:$blob$$inline_711_currentBlob$$inline_683$$, $totalCols$:$chip$$inline_715_colEndArray$$inline_687$$.length}), $blob$$inline_711_currentBlob$$inline_683$$ = [], $chip$$inline_715_colEndArray$$inline_687$$ = 
      []);
      for(var $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = $JSCompiler_alias_FALSE$$, $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ = 0, $colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$ = $chip$$inline_715_colEndArray$$inline_687$$.length;$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ < $colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$;++$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$) {
        if($chip$$inline_715_colEndArray$$inline_687$$[$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$].end <= $itemStart$$inline_689_start$$inline_717$$) {
          $chip$$inline_715_colEndArray$$inline_687$$[$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$] = $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$;
          for($chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = Number($end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$) + 1;$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ < $chip$$inline_715_colEndArray$$inline_687$$.length && !($chip$$inline_715_colEndArray$$inline_687$$[$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$].end > 
          $itemStart$$inline_689_start$$inline_717$$);) {
            $chip$$inline_715_colEndArray$$inline_687$$[$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$] = $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$, $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$++
          }
          $blob$$inline_711_currentBlob$$inline_683$$.push({$chip$:$blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$, $startCol$:$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$, colSpan:$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ - $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$});
          $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ > $blobEntryCounter$$inline_712_maxCol$$inline_685$$ && ($blobEntryCounter$$inline_712_maxCol$$inline_685$$ = $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$);
          $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ && $chipCounter$$inline_718_itemEnd$$inline_690$$ > $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ && ($blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ = $chipCounter$$inline_718_itemEnd$$inline_690$$);
          $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = $JSCompiler_alias_TRUE$$;
          break
        }
      }
      if(!$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$) {
        $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ = 1;
        for($colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$ = $chip$$inline_715_colEndArray$$inline_687$$.length;$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ < $colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$;++$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$) {
          if($goog$getUid$$($chip$$inline_715_colEndArray$$inline_687$$[$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$]) == $goog$getUid$$($chip$$inline_715_colEndArray$$inline_687$$[$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ - 1])) {
            for(var $kk$$inline_696_mm$$inline_701$$ = 1, $colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$ = $blob$$inline_711_currentBlob$$inline_683$$.length;$kk$$inline_696_mm$$inline_701$$ < $colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$;++$kk$$inline_696_mm$$inline_701$$) {
              if($goog$getUid$$($blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].$chip$) == $goog$getUid$$($chip$$inline_715_colEndArray$$inline_687$$[$end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$])) {
                $colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$ = $blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].colSpan;
                $blob$$inline_711_currentBlob$$inline_683$$.push({$chip$:$blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$, $startCol$:$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = Number($blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].$startCol$) + 1, colSpan:$colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$ - 1});
                $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ > $blobEntryCounter$$inline_712_maxCol$$inline_685$$ && ($blobEntryCounter$$inline_712_maxCol$$inline_685$$ = $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$);
                for($chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$;$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ < $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ + $colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$ - 
                1;$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$++) {
                  $chip$$inline_715_colEndArray$$inline_687$$[$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$] = $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$
                }
                $blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$] = {$chip$:$blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].$chip$, $startCol$:$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = $blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].$startCol$, colSpan:1};
                $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ > $blobEntryCounter$$inline_712_maxCol$$inline_685$$ && ($blobEntryCounter$$inline_712_maxCol$$inline_685$$ = $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$);
                $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ && $chipCounter$$inline_718_itemEnd$$inline_690$$ > $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ && ($blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ = $chipCounter$$inline_718_itemEnd$$inline_690$$);
                break
              }
        ...
        if(!$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$) {
          $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ = $chip$$inline_715_colEndArray$$inline_687$$.length;
          $kk$$inline_696_mm$$inline_701$$ = 1;
          for($colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$ = $blob$$inline_711_currentBlob$$inline_683$$.length;$kk$$inline_696_mm$$inline_701$$ < $colEndArrayLength$$inline_693_currentBlobLength$$inline_697_spanOfShrunkItem$$inline_698$$;++$kk$$inline_696_mm$$inline_701$$) {
            $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = $blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].$chip$.end, $blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].$startCol$ + $blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].colSpan == $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ && $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ <= 
            $itemStart$$inline_689_start$$inline_717$$ && ($blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$] = {$chip$:$blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].$chip$, $startCol$:$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = $blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].$startCol$, colSpan:$blob$$inline_711_currentBlob$$inline_683$$[$kk$$inline_696_mm$$inline_701$$].colSpan + 
            1}, $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ > $blobEntryCounter$$inline_712_maxCol$$inline_685$$ && ($blobEntryCounter$$inline_712_maxCol$$inline_685$$ = $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$))
          }
          $blob$$inline_711_currentBlob$$inline_683$$.push({$chip$:$blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$, $startCol$:$chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = $chip$$inline_715_colEndArray$$inline_687$$.length, colSpan:1});
          $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ > $blobEntryCounter$$inline_712_maxCol$$inline_685$$ && ($blobEntryCounter$$inline_712_maxCol$$inline_685$$ = $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$);
          $chip$$inline_715_colEndArray$$inline_687$$.push($blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$);
          $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ && $chipCounter$$inline_718_itemEnd$$inline_690$$ > $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ && ($blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ = $chipCounter$$inline_718_itemEnd$$inline_690$$)
        }
      }
    }
    $blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$.push({blob:$blob$$inline_711_currentBlob$$inline_683$$, $totalCols$:$chip$$inline_715_colEndArray$$inline_687$$.length});
    $JSCompiler_StaticMethods_computeEventMap$self$$inline_678_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_704$$.$blobs$ = $blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$;
    if($opt_createArrays$$) {
      $JSCompiler_StaticMethods_computeEventMap$self$$inline_678_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_704$$ = $JSCompiler_StaticMethods_updateEventMap$self$$.$blocks$[$counter$$24$$];
      $aDaysNumber$$inline_705_blobCounter$$inline_709_length$$inline_681$$ = $opt_arraysLength$$ || 0;
      $aChips$$inline_679_blobs$$inline_706$$ = $JSCompiler_StaticMethods_computeEventMap$self$$inline_678_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_704$$.$blobs$;
      $i$$inline_680_sparseArrays$$inline_707$$ = [];
      for($blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$ = 0;$blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$ < $aDaysNumber$$inline_705_blobCounter$$inline_709_length$$inline_681$$;$blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$++) {
        $i$$inline_680_sparseArrays$$inline_707$$[$blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$] = []
      }
      $aDaysNumber$$inline_705_blobCounter$$inline_709_length$$inline_681$$ = 0;
      for($blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$ = $aChips$$inline_679_blobs$$inline_706$$.length;$aDaysNumber$$inline_705_blobCounter$$inline_709_length$$inline_681$$ < $blobLength$$inline_710_blobs$$inline_682_counter$$inline_708$$;$aDaysNumber$$inline_705_blobCounter$$inline_709_length$$inline_681$$++) {
        $blob$$inline_711_currentBlob$$inline_683$$ = $aChips$$inline_679_blobs$$inline_706$$[$aDaysNumber$$inline_705_blobCounter$$inline_709_length$$inline_681$$].blob;
        $blobEntryCounter$$inline_712_maxCol$$inline_685$$ = 0;
        for($blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$ = $blob$$inline_711_currentBlob$$inline_683$$.length;$blobEntryCounter$$inline_712_maxCol$$inline_685$$ < $blobEntriesLength$$inline_713_latestItemEnd$$inline_686$$;$blobEntryCounter$$inline_712_maxCol$$inline_685$$++) {
          $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$ = $blob$$inline_711_currentBlob$$inline_683$$[$blobEntryCounter$$inline_712_maxCol$$inline_685$$];
          $chip$$inline_715_colEndArray$$inline_687$$ = $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$.$chip$;
          $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$ = $blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$.$startCol$;
          $chipCounter$$inline_718_itemEnd$$inline_690$$ = $itemStart$$inline_689_start$$inline_717$$ = $chip$$inline_715_colEndArray$$inline_687$$.start;
          for($end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ = $chip$$inline_715_colEndArray$$inline_687$$.end;$chipCounter$$inline_718_itemEnd$$inline_690$$ < $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$;$chipCounter$$inline_718_itemEnd$$inline_690$$++) {
            $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$ = $chip$$inline_715_colEndArray$$inline_687$$.$clone$(), $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$.$startIsCut$ = $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$.$endIsCut$ = $chipCounter$$inline_718_itemEnd$$inline_690$$ > 
            $itemStart$$inline_689_start$$inline_717$$ && $chipCounter$$inline_718_itemEnd$$inline_690$$ < $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ - 1, $chipCounter$$inline_718_itemEnd$$inline_690$$ == $itemStart$$inline_689_start$$inline_717$$ && 1 < $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ - $itemStart$$inline_689_start$$inline_717$$ && ($chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$.$endIsCut$ = 
            $JSCompiler_alias_TRUE$$), $chipCounter$$inline_718_itemEnd$$inline_690$$ == $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ - 1 && 1 < $end$$inline_719_ii$$inline_692_jj$$inline_695_lastColNum$$inline_700$$ - $itemStart$$inline_689_start$$inline_717$$ && ($chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$.$startIsCut$ = $JSCompiler_alias_TRUE$$), $i$$inline_680_sparseArrays$$inline_707$$[$chipCounter$$inline_718_itemEnd$$inline_690$$][$blobEntry$$inline_714_chip$$inline_688_startCol$$inline_716$$] = 
            $chipClone$$inline_720_lastCol$$inline_694_ll$$inline_699_mmEnd$$inline_702_placedItem$$inline_691_startCol$$inline_684$$
          }
        }
      }
      $JSCompiler_StaticMethods_computeEventMap$self$$inline_678_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_704$$.$sparseArrays$ = $i$$inline_680_sparseArrays$$inline_707$$
    }
...
;function $rflect$cal$blocks$BlockManager$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_722_aViewManager$$13$$, $aTimeManager$$10$$, $aEventManager$$7$$) {
  this.$viewManager_$ = $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_722_aViewManager$$13$$;
  ...
  $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_722_aViewManager$$13$$ = this.$blockPoolAllday$;
  $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_722_aViewManager$$13$$.$blocksNumber_$ = 1;
  $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_722_aViewManager$$13$$)
}
$rflect$cal$blocks$BlockManager$$.prototype.update = function $$rflect$cal$blocks$BlockManager$$$$update$() {
  if($JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$)) {
    var $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_725_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_728_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_731$$ = this.$blockPoolWeek$;
    $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_725_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_728_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_731$$.$blocksNumber_$ = this.$timeManager_$.$daySeries$.length;
    $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_725_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_728_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_731$$);
    $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_725_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_728_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_731$$ = this.$blockPoolAllday$;
    $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_725_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_728_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_731$$.$blocksNumber_$ = 1;
    $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_725_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_728_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_731$$);
    ...
    $JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$) && ($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_725_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_728_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_731$$ = this.$blockPoolMonth$, $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_725_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_728_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_731$$.$blocksNumber_$ = this.$timeManager_$.$daySeries$.length / 
    7, $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_725_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_728_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_731$$), $JSCompiler_StaticMethods_updateCollapsedBlocks$$(this.$blockPoolMonth$), $JSCompiler_StaticMethods_updateEventMap$$(this.$blockPoolMonth$, this.$eventManager_$.$weekChips$), $JSCompiler_StaticMethods_updateExpandedBlocks$$(this.$blockPoolMonth$))
  }
};
...
function $rflect$cal$ContainerSizeMonitor$$($aViewManager$$14_outerDiv$$inline_737$$, $aContainer$$2_innerDiv$$inline_738_width$$inline_739$$, $opt_window$$5$$) {
  $goog$dom$ViewportSizeMonitor$$.call(this, $opt_window$$5$$);
  this.$container_$ = $aContainer$$2_innerDiv$$inline_738_width$$inline_739$$;
  this.$containerSize_$ = new $goog$math$Size$$(this.$container_$.clientWidth, this.$container_$.clientHeight);
  $aViewManager$$14_outerDiv$$inline_737$$ = document.createElement("div");
  $aViewManager$$14_outerDiv$$inline_737$$.style.cssText = "visiblity:hidden;overflow:auto;position:absolute;top:0;width:100px;height:100px";
  $aContainer$$2_innerDiv$$inline_738_width$$inline_739$$ = document.createElement("div");
  $goog$style$setSize$$($aContainer$$2_innerDiv$$inline_738_width$$inline_739$$, "200px", "200px");
  $aViewManager$$14_outerDiv$$inline_737$$.appendChild($aContainer$$2_innerDiv$$inline_738_width$$inline_739$$);
  document.body.appendChild($aViewManager$$14_outerDiv$$inline_737$$);
  $aContainer$$2_innerDiv$$inline_738_width$$inline_739$$ = $aViewManager$$14_outerDiv$$inline_737$$.offsetWidth - $aViewManager$$14_outerDiv$$inline_737$$.clientWidth;
  $goog$dom$removeNode$$($aViewManager$$14_outerDiv$$inline_737$$);
  this.$scrollbarWidth$ = $aContainer$$2_innerDiv$$inline_738_width$$inline_739$$
}
...
$JSCompiler_prototypeAlias$$.$checkForSizeChange_$ = function $$JSCompiler_prototypeAlias$$$$checkForSizeChange_$$($aNotActualResize$$) {
  var $containerSize$$inline_742_viewportSize$$ = $goog$dom$getViewportSize_$$(this.$window_$ || window);
  if(!$goog$math$Size$equals$$($containerSize$$inline_742_viewportSize$$, this.$size_$) && (this.$size_$ = $containerSize$$inline_742_viewportSize$$, $containerSize$$inline_742_viewportSize$$ = new $goog$math$Size$$(this.$container_$.clientWidth, this.$container_$.clientHeight), $goog$math$Size$equals$$($containerSize$$inline_742_viewportSize$$, this.$containerSize_$) || (this.$containerSize_$ = $containerSize$$inline_742_viewportSize$$, this.dispatchEvent("resize")), this.$windowSizePollInterval_$ == 
...
function $JSCompiler_StaticMethods_showView$$($JSCompiler_StaticMethods_showView$self$$, $JSCompiler_StaticMethods_preRender$self$$inline_756_aType$$1$$, $container$$inline_758_opt_caller$$) {
  var $calledByMiniCal$$ = $container$$inline_758_opt_caller$$ == $JSCompiler_StaticMethods_showView$self$$.$mainBody_$.$miniCal$;
  $JSCompiler_StaticMethods_showView$self$$.$currentView$ == $JSCompiler_StaticMethods_preRender$self$$inline_756_aType$$1$$ && $container$$inline_758_opt_caller$$ == $JSCompiler_alias_VOID$$ && !$JSCompiler_StaticMethods_showView$self$$.$isOnStartup_$ || ($JSCompiler_StaticMethods_showView$self$$.$currentView$ = $JSCompiler_StaticMethods_preRender$self$$inline_756_aType$$1$$, $JSCompiler_StaticMethods_showView$self$$.$timeManager$.$configuration$ = $JSCompiler_StaticMethods_showView$self$$.$currentView$, 
  $JSCompiler_StaticMethods_showView$self$$.$timeManager$.$run$(), $JSCompiler_StaticMethods_showView$self$$.$eventManager_$.$run$(), $JSCompiler_StaticMethods_showView$self$$.$isOnStartup_$ ? ($JSCompiler_StaticMethods_preRender$self$$inline_756_aType$$1$$ = $JSCompiler_StaticMethods_showView$self$$.$mainBody_$, $container$$inline_758_opt_caller$$ = $JSCompiler_StaticMethods_preRender$self$$inline_756_aType$$1$$.$dom_$.$document_$.body, $container$$inline_758_opt_caller$$.innerHTML = $rflect$cal$MainBody$HTML_PARTS_$$[0] + 
  $rflect$cal$MainBody$HTML_PARTS_$$[1] + $rflect$cal$MainBody$HTML_PARTS_$$[20] + $rflect$cal$MainBody$HTML_PARTS_$$[21], $JSCompiler_StaticMethods_preRender$self$$inline_756_aType$$1$$.$containerSizeMonitor_$.$checkForSizeChange_$($JSCompiler_alias_TRUE$$), $container$$inline_758_opt_caller$$.innerHTML = "", $JSCompiler_StaticMethods_showView$self$$.$mainBody_$.$updateBeforeRedraw$(), $JSCompiler_StaticMethods_showView$self$$.$mainBody_$.$render$(), $JSCompiler_StaticMethods_listen$$($JSCompiler_StaticMethods_showView$self$$, 
...
$JSCompiler_prototypeAlias$$.$getValues$ = function $$JSCompiler_prototypeAlias$$$$getValues$$() {
  for(var $l$$inline_767$$ = this.$getCount$(), $rv$$inline_768$$ = [], $i$$inline_769$$ = this.$getCount$() - this.$getCount$();$i$$inline_769$$ < $l$$inline_767$$;$i$$inline_769$$++) {
    $rv$$inline_768$$[$i$$inline_769$$] = this.get($i$$inline_769$$)
  }
  return $rv$$inline_768$$
};
$JSCompiler_prototypeAlias$$.$getKeys$ = function $$JSCompiler_prototypeAlias$$$$getKeys$$() {
...
function $goog$debug$Logger$Level$getPredefinedLevel$$($name$$65$$) {
  if(!$goog$debug$Logger$Level$predefinedLevelsCache_$$) {
    ...
    for(var $i$$inline_771$$ = 0, $level$$inline_772$$;$level$$inline_772$$ = $goog$debug$Logger$Level$PREDEFINED_LEVELS$$[$i$$inline_771$$];$i$$inline_771$$++) {
      $goog$debug$Logger$Level$predefinedLevelsCache_$$[$level$$inline_772$$.value] = $level$$inline_772$$, $goog$debug$Logger$Level$predefinedLevelsCache_$$[$level$$inline_772$$.name] = $level$$inline_772$$
    }
  }
...
$JSCompiler_prototypeAlias$$.log = function $$JSCompiler_prototypeAlias$$$log$($level$$15_logRecord$$inline_775$$, $msg$$5_msg$$inline_1111_target$$inline_776$$, $JSCompiler_StaticMethods_callPublish_$self$$inline_1113_opt_exception$$) {
  if($level$$15_logRecord$$inline_775$$.value >= $JSCompiler_StaticMethods_getEffectiveLevel$$(this).value) {
    $level$$15_logRecord$$inline_775$$ = this.$getLogRecord$($level$$15_logRecord$$inline_775$$, $msg$$5_msg$$inline_1111_target$$inline_776$$, $JSCompiler_StaticMethods_callPublish_$self$$inline_1113_opt_exception$$);
    $msg$$5_msg$$inline_1111_target$$inline_776$$ = "log:" + $level$$15_logRecord$$inline_775$$.$msg_$;
    $goog$global$$.console && ($goog$global$$.console.timeStamp ? $goog$global$$.console.timeStamp($msg$$5_msg$$inline_1111_target$$inline_776$$) : $goog$global$$.console.markTimeline && $goog$global$$.console.markTimeline($msg$$5_msg$$inline_1111_target$$inline_776$$));
    $goog$global$$.msWriteProfilerMark && $goog$global$$.msWriteProfilerMark($msg$$5_msg$$inline_1111_target$$inline_776$$);
    for($msg$$5_msg$$inline_1111_target$$inline_776$$ = this;$msg$$5_msg$$inline_1111_target$$inline_776$$;) {
      var $JSCompiler_StaticMethods_callPublish_$self$$inline_1113_opt_exception$$ = $msg$$5_msg$$inline_1111_target$$inline_776$$, $logRecord$$inline_1114$$ = $level$$15_logRecord$$inline_775$$;
      if($JSCompiler_StaticMethods_callPublish_$self$$inline_1113_opt_exception$$.$handlers_$) {
        for(var $i$$inline_1115$$ = 0, $handler$$inline_1116$$ = $JSCompiler_alias_VOID$$;$handler$$inline_1116$$ = $JSCompiler_StaticMethods_callPublish_$self$$inline_1113_opt_exception$$.$handlers_$[$i$$inline_1115$$];$i$$inline_1115$$++) {
          $handler$$inline_1116$$($logRecord$$inline_1114$$)
        }
      }
      $msg$$5_msg$$inline_1111_target$$inline_776$$ = $msg$$5_msg$$inline_1111_target$$inline_776$$.getParent()
    }
  }
};
$JSCompiler_prototypeAlias$$.$getLogRecord$ = function $$JSCompiler_prototypeAlias$$$$getLogRecord$$($level$$16$$, $msg$$6$$, $opt_exception$$1$$) {
  ...
  if($opt_exception$$1$$) {
    ...
    var $JSCompiler_inline_result$$790$$;
    var $opt_fn$$inline_792$$ = arguments.callee.caller;
    try {
      var $e$$inline_793$$;
      var $href$$inline_1119$$ = $goog$getObjectByName$$("window.location.href");
      if($goog$isString$$($opt_exception$$1$$)) {
        $e$$inline_793$$ = {message:$opt_exception$$1$$, name:"Unknown error", lineNumber:"Not available", fileName:$href$$inline_1119$$, stack:"Not available"}
      }else {
        var $lineNumber$$inline_1120$$, $fileName$$inline_1121$$, $threwError$$inline_1122$$ = $JSCompiler_alias_FALSE$$;
        try {
          $lineNumber$$inline_1120$$ = $opt_exception$$1$$.lineNumber || $opt_exception$$1$$.$line$ || "Not available"
        }catch($e$$inline_1123$$) {
          $lineNumber$$inline_1120$$ = "Not available", $threwError$$inline_1122$$ = $JSCompiler_alias_TRUE$$
        }
        try {
          $fileName$$inline_1121$$ = $opt_exception$$1$$.fileName || $opt_exception$$1$$.filename || $opt_exception$$1$$.sourceURL || $href$$inline_1119$$
        }catch($e$$inline_1124$$) {
          $fileName$$inline_1121$$ = "Not available", $threwError$$inline_1122$$ = $JSCompiler_alias_TRUE$$
        }
        $e$$inline_793$$ = $threwError$$inline_1122$$ || !$opt_exception$$1$$.lineNumber || !$opt_exception$$1$$.fileName || !$opt_exception$$1$$.stack ? {message:$opt_exception$$1$$.message, name:$opt_exception$$1$$.name, lineNumber:$lineNumber$$inline_1120$$, fileName:$fileName$$inline_1121$$, stack:$opt_exception$$1$$.stack || "Not available"} : $opt_exception$$1$$
      }
      $JSCompiler_inline_result$$790$$ = "Message: " + $goog$string$htmlEscape$$($e$$inline_793$$.message) + '\nUrl: <a href="view-source:' + $e$$inline_793$$.fileName + '" target="_new">' + $e$$inline_793$$.fileName + "</a>\nLine: " + $e$$inline_793$$.lineNumber + "\n\nBrowser stack:\n" + $goog$string$htmlEscape$$($e$$inline_793$$.stack + "-> ") + "[end]\n\nJS stack traversal:\n" + $goog$string$htmlEscape$$($goog$debug$getStacktrace$$($opt_fn$$inline_792$$) + "-> ")
    }catch($e2$$inline_794$$) {
      $JSCompiler_inline_result$$790$$ = "Exception trying to expose exception! You win, we lose. " + $e2$$inline_794$$
    }
    $logRecord$$4$$.$exceptionText_$ = $JSCompiler_inline_result$$790$$
  }
  return $logRecord$$4$$
};
...
function $goog$debug$LogManager$getLogger$$($name$$68$$) {
  ...
  var $JSCompiler_temp$$3_logger$$inline_803$$;
  if(!($JSCompiler_temp$$3_logger$$inline_803$$ = $goog$debug$LogManager$loggers_$$[$name$$68$$])) {
    $JSCompiler_temp$$3_logger$$inline_803$$ = new $goog$debug$Logger$$($name$$68$$);
    var $lastDotIndex$$inline_804_parentLogger$$inline_806$$ = $name$$68$$.lastIndexOf("."), $leafName$$inline_805$$ = $name$$68$$.substr($lastDotIndex$$inline_804_parentLogger$$inline_806$$ + 1), $lastDotIndex$$inline_804_parentLogger$$inline_806$$ = $goog$debug$LogManager$getLogger$$($name$$68$$.substr(0, $lastDotIndex$$inline_804_parentLogger$$inline_806$$));
    $lastDotIndex$$inline_804_parentLogger$$inline_806$$.$children_$ || ($lastDotIndex$$inline_804_parentLogger$$inline_806$$.$children_$ = {});
    $lastDotIndex$$inline_804_parentLogger$$inline_806$$.$children_$[$leafName$$inline_805$$] = $JSCompiler_temp$$3_logger$$inline_803$$;
    $JSCompiler_temp$$3_logger$$inline_803$$.$parent_$ = $lastDotIndex$$inline_804_parentLogger$$inline_806$$;
    $goog$debug$LogManager$loggers_$$[$name$$68$$] = $JSCompiler_temp$$3_logger$$inline_803$$
  }
  return $JSCompiler_temp$$3_logger$$inline_803$$
}
;function $goog$debug$DebugWindow$$($opt_identifier$$, $opt_prefix$$3$$) {
  ...
  if($JSCompiler_alias_TRUE$$ != this.$isCapturing_$) {
    ...
    $goog$debug$LogManager$initialize$$();
    var $JSCompiler_StaticMethods_addHandler$self$$inline_1134$$ = $goog$debug$LogManager$rootLogger_$$, $handler$$inline_1135$$ = this.$publishHandler_$;
    $JSCompiler_StaticMethods_addHandler$self$$inline_1134$$.$handlers_$ || ($JSCompiler_StaticMethods_addHandler$self$$inline_1134$$.$handlers_$ = []);
    $JSCompiler_StaticMethods_addHandler$self$$inline_1134$$.$handlers_$.push($handler$$inline_1135$$)
  }
...
$JSCompiler_prototypeAlias$$.$addLogRecord$ = function $$JSCompiler_prototypeAlias$$$$addLogRecord$$($logRecord$$8$$) {
  if(!this.$filteredLoggers_$[$logRecord$$8$$.$loggerName_$]) {
    var $JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$ = this.$formatter_$, $className$$inline_818$$;
    switch($logRecord$$8$$.$level_$.value) {
      case $goog$debug$Logger$Level$SHOUT$$.value:
        $className$$inline_818$$ = "dbg-sh";
        break;
      case $goog$debug$Logger$Level$SEVERE$$.value:
        $className$$inline_818$$ = "dbg-sev";
        break;
      case $goog$debug$Logger$Level$WARNING$$.value:
        $className$$inline_818$$ = "dbg-w";
        break;
      case $goog$debug$Logger$Level$INFO$$.value:
        $className$$inline_818$$ = "dbg-i";
        break;
      default:
        $className$$inline_818$$ = "dbg-f"
    }
    var $sb$$inline_819$$ = [];
    $sb$$inline_819$$.push($JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$.$prefix_$, " ");
    if($JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$.$showAbsoluteTime$) {
      var $time$$inline_1139$$ = new Date($logRecord$$8$$.$time_$);
      $sb$$inline_819$$.push("[", $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1139$$.getFullYear() - 2E3) + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1139$$.getMonth() + 1) + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1139$$.getDate()) + " " + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1139$$.getHours()) + ":" + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1139$$.getMinutes()) + ":" + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1139$$.getSeconds()) + 
      "." + $goog$debug$Formatter$getTwoDigitString_$$(Math.floor($time$$inline_1139$$.getMilliseconds() / 10)), "] ")
    }
    $JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$.$showRelativeTime$ && $sb$$inline_819$$.push("[", $goog$string$whitespaceEscape$$($goog$debug$Formatter$getRelativeTime_$$($logRecord$$8$$, $JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$.$startTimeProvider_$.get())), "s] ");
    $JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$.$showLoggerName$ && $sb$$inline_819$$.push("[", $goog$string$htmlEscape$$($logRecord$$8$$.$loggerName_$), "] ");
    $sb$$inline_819$$.push('<span class="', $className$$inline_818$$, '">', $goog$string$newLineToBr$$($goog$string$whitespaceEscape$$($goog$string$htmlEscape$$($logRecord$$8$$.$msg_$))));
    $JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$.$showExceptionText$ && $logRecord$$8$$.$exception_$ && $sb$$inline_819$$.push("<br>", $goog$string$newLineToBr$$($goog$string$whitespaceEscape$$($logRecord$$8$$.$exceptionText_$ || "")));
    $sb$$inline_819$$.push("</span><br>");
    $JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$ = $sb$$inline_819$$.join("");
    this.$enabled_$ ? ($JSCompiler_StaticMethods_openWindow_$$(this), this.$savedMessages_$.add($JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$), $JSCompiler_StaticMethods_writeToLog_$$(this, $JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$)) : this.$savedMessages_$.add($JSCompiler_StaticMethods_formatRecord$self$$inline_816_html$$inline_822$$);
...
function $goog$debug$FancyWindow$$($opt_identifier$$1$$, $opt_prefix$$4$$) {
  if($goog$debug$FancyWindow$HAS_LOCAL_STORE$$) {
    var $storedKeys$$inline_829$$ = $goog$debug$FancyWindow$getStoredKeys_$$(), $key$$inline_830$$;
    for($key$$inline_830$$ in $storedKeys$$inline_829$$) {
      var $logger$$inline_832_loggerName$$inline_831$$ = $key$$inline_830$$.replace("fancywindow.sel.", ""), $logger$$inline_832_loggerName$$inline_831$$ = $goog$debug$LogManager$getLogger$$($logger$$inline_832_loggerName$$inline_831$$), $curLevel$$inline_833$$ = $logger$$inline_832_loggerName$$inline_831$$.$level_$, $storedLevel$$inline_834$$ = window.localStorage.getItem($key$$inline_830$$).toString();
      (!$curLevel$$inline_833$$ || $curLevel$$inline_833$$.toString() != $storedLevel$$inline_834$$) && $logger$$inline_832_loggerName$$inline_831$$.$setLevel$($goog$debug$Logger$Level$getPredefinedLevel$$($storedLevel$$inline_834$$))
    }
  }
...
$JSCompiler_prototypeAlias$$.$closeOptions_$ = function $$JSCompiler_prototypeAlias$$$$closeOptions_$$() {
  ...
  for(var $loggers$$1_loggers$$inline_838$$ = $goog$debug$FancyWindow$getLoggers_$$(), $dh$$3_storedKeys$$inline_839$$ = this.$dh_$, $i$$120_i$$inline_840$$ = 0;$i$$120_i$$inline_840$$ < $loggers$$1_loggers$$inline_838$$.length;$i$$120_i$$inline_840$$++) {
    var $key$$inline_841_logger$$4$$ = $goog$debug$LogManager$getLogger$$($loggers$$1_loggers$$inline_838$$[$i$$120_i$$inline_840$$]), $level$$18_level$$inline_842_sel$$1$$ = $dh$$3_storedKeys$$inline_839$$.$getElement$("sel" + $loggers$$1_loggers$$inline_838$$[$i$$120_i$$inline_840$$]), $level$$18_level$$inline_842_sel$$1$$ = $level$$18_level$$inline_842_sel$$1$$.options[$level$$18_level$$inline_842_sel$$1$$.selectedIndex].text;
    "INHERIT" == $level$$18_level$$inline_842_sel$$1$$ ? $key$$inline_841_logger$$4$$.$setLevel$($JSCompiler_alias_NULL$$) : $key$$inline_841_logger$$4$$.$setLevel$($goog$debug$Logger$Level$getPredefinedLevel$$($level$$18_level$$inline_842_sel$$1$$))
  }
  if($goog$debug$FancyWindow$HAS_LOCAL_STORE$$) {
    $loggers$$1_loggers$$inline_838$$ = $goog$debug$FancyWindow$getLoggers_$$();
    $dh$$3_storedKeys$$inline_839$$ = $goog$debug$FancyWindow$getStoredKeys_$$();
    for($i$$120_i$$inline_840$$ = 0;$i$$120_i$$inline_840$$ < $loggers$$1_loggers$$inline_838$$.length;$i$$120_i$$inline_840$$++) {
      $key$$inline_841_logger$$4$$ = "fancywindow.sel." + $loggers$$1_loggers$$inline_838$$[$i$$120_i$$inline_840$$], $level$$18_level$$inline_842_sel$$1$$ = $goog$debug$LogManager$getLogger$$($loggers$$1_loggers$$inline_838$$[$i$$120_i$$inline_840$$]).$level_$, $key$$inline_841_logger$$4$$ in $dh$$3_storedKeys$$inline_839$$ ? $level$$18_level$$inline_842_sel$$1$$ ? window.localStorage.getItem($key$$inline_841_logger$$4$$) != $level$$18_level$$inline_842_sel$$1$$.name && window.localStorage.setItem($key$$inline_841_logger$$4$$, 
      $level$$18_level$$inline_842_sel$$1$$.name) : window.localStorage.removeItem($key$$inline_841_logger$$4$$) : $level$$18_level$$inline_842_sel$$1$$ && window.localStorage.setItem($key$$inline_841_logger$$4$$, $level$$18_level$$inline_842_sel$$1$$.name)
    }
  }
  return $JSCompiler_alias_FALSE$$
};
