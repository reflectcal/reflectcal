...
$rflect$cal$events$EventManager$$.prototype.$run$ = function $$rflect$cal$events$EventManager$$$$$run$$() {
  ...
  for(var $counter$$9$$ = this.$weekChips$.length = 0, $length$$26$$ = $daySeries$$.length;$counter$$9$$ < $length$$26$$;$counter$$9$$++) {
    ...
    if($JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$)) {
      ...
      var $aKnownChipIds$$inline_113_weekKey$$ = $knownChipsIds$$, $aDayNumber$$inline_116$$ = $counter$$9$$, $aTotalDays$$inline_117$$ = $length$$26$$, $allDayChips$$inline_118$$ = this.$allDayChips$[0], $allDayChipsCounter$$inline_119$$ = 0, $chips$$inline_120$$ = $JSCompiler_alias_VOID$$;
      ...
      $JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$) && 0 == $counter$$9$$ % 7 && ($aKnownChipIds$$inline_113_weekKey$$ = $daySeries$$[$counter$$9$$].$getWeekNumber$(), this.$weekChips$.push($rflect$cal$events$EventManager$getNestedChips_$$(this.$chipsByWeek_$, $counter$$inline_121_yearKey$$, $aKnownChipIds$$inline_113_weekKey$$) || []))
    }
  }
};
      ...
      for($length$$inline_504_length$$inline_509$$ = $rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$.length;++$offset$$inline_503_offset$$inline_508$$ < $length$$inline_504_length$$inline_509$$ - 1;) {
        switch($aSb$$56$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$offset$$inline_503_offset$$inline_508$$]), $offset$$inline_503_offset$$inline_508$$) {
          ...
          case 80:
            ...
            $offset$$inline_503_offset$$inline_508$$ += 26
        }
      }
    }
  }
