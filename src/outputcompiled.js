...
function $goog$string$padNumber$$($num$$4$$, $length$$14$$) {
  var $s$$13$$ = $goog$isDef$$($JSCompiler_alias_VOID$$) ? $num$$4$$.toFixed($JSCompiler_alias_VOID$$) : String($num$$4$$), $index$$45_length$$inline_78$$ = $s$$13$$.indexOf(".");
  -1 == $index$$45_length$$inline_78$$ && ($index$$45_length$$inline_78$$ = $s$$13$$.length);
  $index$$45_length$$inline_78$$ = Math.max(0, $length$$14$$ - $index$$45_length$$inline_78$$);
  return Array($index$$45_length$$inline_78$$ + 1).join("0") + $s$$13$$
}
...
var $ua$$inline_81$$;
if($ua$$inline_81$$ = $goog$userAgent$getUserAgentString$$()) {
  var $navigator$$inline_82$$ = $goog$userAgent$getNavigator$$();
  $goog$userAgent$detectedOpera_$$ = 0 == $ua$$inline_81$$.indexOf("Opera");
  $goog$userAgent$detectedIe_$$ = !$goog$userAgent$detectedOpera_$$ && -1 != $ua$$inline_81$$.indexOf("MSIE");
  $goog$userAgent$detectedWebkit_$$ = !$goog$userAgent$detectedOpera_$$ && -1 != $ua$$inline_81$$.indexOf("WebKit");
  $goog$userAgent$detectedGecko_$$ = !$goog$userAgent$detectedOpera_$$ && !$goog$userAgent$detectedWebkit_$$ && "Gecko" == $navigator$$inline_82$$.product
}
var $goog$userAgent$OPERA$$ = $goog$userAgent$detectedOpera_$$, $goog$userAgent$IE$$ = $goog$userAgent$detectedIe_$$, $goog$userAgent$GECKO$$ = $goog$userAgent$detectedGecko_$$, $goog$userAgent$WEBKIT$$ = $goog$userAgent$detectedWebkit_$$, $goog$userAgent$PLATFORM$$, $navigator$$inline_84$$ = $goog$userAgent$getNavigator$$();
$goog$userAgent$PLATFORM$$ = $navigator$$inline_84$$ && $navigator$$inline_84$$.platform || "";
...
a: {
  var $version$$inline_87$$ = "", $re$$inline_88$$;
  if($goog$userAgent$OPERA$$ && $goog$global$$.opera) {
    var $operaVersion$$inline_89$$ = $goog$global$$.opera.version, $version$$inline_87$$ = "function" == typeof $operaVersion$$inline_89$$ ? $operaVersion$$inline_89$$() : $operaVersion$$inline_89$$
  }else {
    if($goog$userAgent$GECKO$$ ? $re$$inline_88$$ = /rv\:([^\);]+)(\)|;)/ : $goog$userAgent$IE$$ ? $re$$inline_88$$ = /MSIE\s+([^\);]+)(\)|;)/ : $goog$userAgent$WEBKIT$$ && ($re$$inline_88$$ = /WebKit\/(\S+)/), $re$$inline_88$$) {
      var $arr$$inline_90$$ = $re$$inline_88$$.exec($goog$userAgent$getUserAgentString$$()), $version$$inline_87$$ = $arr$$inline_90$$ ? $arr$$inline_90$$[1] : ""
    }
  }
  if($goog$userAgent$IE$$) {
    var $docMode$$inline_91$$ = $goog$userAgent$getDocumentMode_$$();
    if($docMode$$inline_91$$ > parseFloat($version$$inline_87$$)) {
      $goog$userAgent$VERSION$$ = String($docMode$$inline_91$$);
      break a
    }
  }
  $goog$userAgent$VERSION$$ = $version$$inline_87$$
}
var $goog$userAgent$isVersionCache_$$ = {};
function $goog$userAgent$isVersion$$($version$$8$$) {
  var $JSCompiler_temp$$67_order$$inline_95$$;
  if(!($JSCompiler_temp$$67_order$$inline_95$$ = $goog$userAgent$isVersionCache_$$[$version$$8$$])) {
    $JSCompiler_temp$$67_order$$inline_95$$ = 0;
    for(var $v1Subs$$inline_96$$ = $goog$string$trim$$(String($goog$userAgent$VERSION$$)).split("."), $v2Subs$$inline_97$$ = $goog$string$trim$$(String($version$$8$$)).split("."), $subCount$$inline_98$$ = Math.max($v1Subs$$inline_96$$.length, $v2Subs$$inline_97$$.length), $subIdx$$inline_99$$ = 0;0 == $JSCompiler_temp$$67_order$$inline_95$$ && $subIdx$$inline_99$$ < $subCount$$inline_98$$;$subIdx$$inline_99$$++) {
      var $v1Sub$$inline_100$$ = $v1Subs$$inline_96$$[$subIdx$$inline_99$$] || "", $v2Sub$$inline_101$$ = $v2Subs$$inline_97$$[$subIdx$$inline_99$$] || "", $v1CompParser$$inline_102$$ = RegExp("(\\d*)(\\D*)", "g"), $v2CompParser$$inline_103$$ = RegExp("(\\d*)(\\D*)", "g");
      do {
        var $v1Comp$$inline_104$$ = $v1CompParser$$inline_102$$.exec($v1Sub$$inline_100$$) || ["", "", ""], $v2Comp$$inline_105$$ = $v2CompParser$$inline_103$$.exec($v2Sub$$inline_101$$) || ["", "", ""];
        if(0 == $v1Comp$$inline_104$$[0].length && 0 == $v2Comp$$inline_105$$[0].length) {
          break
        }
        $JSCompiler_temp$$67_order$$inline_95$$ = ((0 == $v1Comp$$inline_104$$[1].length ? 0 : parseInt($v1Comp$$inline_104$$[1], 10)) < (0 == $v2Comp$$inline_105$$[1].length ? 0 : parseInt($v2Comp$$inline_105$$[1], 10)) ? -1 : (0 == $v1Comp$$inline_104$$[1].length ? 0 : parseInt($v1Comp$$inline_104$$[1], 10)) > (0 == $v2Comp$$inline_105$$[1].length ? 0 : parseInt($v2Comp$$inline_105$$[1], 10)) ? 1 : 0) || ((0 == $v1Comp$$inline_104$$[2].length) < (0 == $v2Comp$$inline_105$$[2].length) ? -1 : (0 == 
        $v1Comp$$inline_104$$[2].length) > (0 == $v2Comp$$inline_105$$[2].length) ? 1 : 0) || ($v1Comp$$inline_104$$[2] < $v2Comp$$inline_105$$[2] ? -1 : $v1Comp$$inline_104$$[2] > $v2Comp$$inline_105$$[2] ? 1 : 0)
      }while(0 == $JSCompiler_temp$$67_order$$inline_95$$)
    }
    $JSCompiler_temp$$67_order$$inline_95$$ = $goog$userAgent$isVersionCache_$$[$version$$8$$] = 0 <= $JSCompiler_temp$$67_order$$inline_95$$
  }
  return $JSCompiler_temp$$67_order$$inline_95$$
}
var $doc$$inline_107$$ = $goog$global$$.document, $goog$userAgent$DOCUMENT_MODE$$ = !$doc$$inline_107$$ || !$goog$userAgent$IE$$ ? $JSCompiler_alias_VOID$$ : $goog$userAgent$getDocumentMode_$$() || ("CSS1Compat" == $doc$$inline_107$$.compatMode ? parseInt($goog$userAgent$VERSION$$, 10) : 5);
...
function $goog$events$handleBrowserEvent_$$($listener$$48$$, $opt_evt$$) {
  ...
  if(!$goog$events$BrowserFeature$HAS_W3C_EVENT_SUPPORT$$) {
    ...
    if($hasCapture$$2$$) {
      ...
      a: {
        var $evt$$16_useReturnValue$$inline_121$$ = $JSCompiler_alias_FALSE$$;
        if(0 == $ieEvent_retval$$1$$.keyCode) {
          try {
            $ieEvent_retval$$1$$.keyCode = -1;
            break a
          }catch($ex$$inline_122$$) {
            $evt$$16_useReturnValue$$inline_121$$ = $JSCompiler_alias_TRUE$$
          }
        }
        if($evt$$16_useReturnValue$$inline_121$$ || $ieEvent_retval$$1$$.returnValue == $JSCompiler_alias_VOID$$) {
          $ieEvent_retval$$1$$.returnValue = $JSCompiler_alias_TRUE$$
        }
      }
    }
    $evt$$16_useReturnValue$$inline_121$$ = new $goog$events$BrowserEvent$$;
    $evt$$16_useReturnValue$$inline_121$$.$init$($ieEvent_retval$$1$$, this);
    $ieEvent_retval$$1$$ = $JSCompiler_alias_TRUE$$;
    try {
      if($hasCapture$$2$$) {
        for(var $ancestors$$1$$ = [], $parent$$3$$ = $evt$$16_useReturnValue$$inline_121$$.currentTarget;$parent$$3$$;$parent$$3$$ = $parent$$3$$.parentNode) {
          $ancestors$$1$$.push($parent$$3$$)
        }
        $targetsMap$$1$$ = $map$$6$$[$JSCompiler_alias_TRUE$$];
        $targetsMap$$1$$.$remaining_$ = $targetsMap$$1$$.$count_$;
        for(var $i$$60$$ = $ancestors$$1$$.length - 1;!$evt$$16_useReturnValue$$inline_121$$.$propagationStopped_$ && 0 <= $i$$60$$ && $targetsMap$$1$$.$remaining_$;$i$$60$$--) {
          $evt$$16_useReturnValue$$inline_121$$.currentTarget = $ancestors$$1$$[$i$$60$$], $ieEvent_retval$$1$$ &= $goog$events$fireListeners_$$($targetsMap$$1$$, $ancestors$$1$$[$i$$60$$], $be$$1_type$$74$$, $JSCompiler_alias_TRUE$$, $evt$$16_useReturnValue$$inline_121$$)
        }
        if($hasBubble$$1$$) {
          $targetsMap$$1$$ = $map$$6$$[$JSCompiler_alias_FALSE$$];
          $targetsMap$$1$$.$remaining_$ = $targetsMap$$1$$.$count_$;
          for($i$$60$$ = 0;!$evt$$16_useReturnValue$$inline_121$$.$propagationStopped_$ && $i$$60$$ < $ancestors$$1$$.length && $targetsMap$$1$$.$remaining_$;$i$$60$$++) {
            $evt$$16_useReturnValue$$inline_121$$.currentTarget = $ancestors$$1$$[$i$$60$$], $ieEvent_retval$$1$$ &= $goog$events$fireListeners_$$($targetsMap$$1$$, $ancestors$$1$$[$i$$60$$], $be$$1_type$$74$$, $JSCompiler_alias_FALSE$$, $evt$$16_useReturnValue$$inline_121$$)
          }
        }
      }else {
        $ieEvent_retval$$1$$ = $goog$events$fireListener$$($listener$$48$$, $evt$$16_useReturnValue$$inline_121$$)
      }
    }finally {
...
$JSCompiler_prototypeAlias$$.$getWeekNumber$ = function $$JSCompiler_prototypeAlias$$$$getWeekNumber$$() {
  var $cutoffSameWeek$$inline_132_d$$inline_130$$ = new Date(this.getFullYear(), this.getMonth(), this.getDate()), $firstday$$inline_131$$ = this.$firstDayOfWeek_$ || 0, $cutoffSameWeek$$inline_132_d$$inline_130$$ = $cutoffSameWeek$$inline_132_d$$inline_130$$.valueOf() + 864E5 * (((this.$firstWeekCutOffDay_$ || 3) - $firstday$$inline_131$$ + 7) % 7 - (($cutoffSameWeek$$inline_132_d$$inline_130$$.getDay() + 6) % 7 - $firstday$$inline_131$$ + 7) % 7);
  return Math.floor(Math.round(($cutoffSameWeek$$inline_132_d$$inline_130$$ - (new Date((new Date($cutoffSameWeek$$inline_132_d$$inline_130$$)).getFullYear(), 0, 1)).valueOf()) / 864E5) / 7) + 1
};
...
function $rflect$date$moveToDayOfWeekIfNeeded$$($aDate$$1_date$$inline_144$$) {
  var $JSCompiler_temp$$36_diff$$inline_143$$;
  0 != $JSCompiler_StaticMethods_getWeekday$$($aDate$$1_date$$inline_144$$) && ($JSCompiler_temp$$36_diff$$inline_143$$ = (($goog$i18n$DateTimeSymbols_en$$.$FIRSTDAYOFWEEK$ + 0 + 1) % 7 - $aDate$$1_date$$inline_144$$.getDay() + -7) % 7, $aDate$$1_date$$inline_144$$ = $aDate$$1_date$$inline_144$$.$clone$(), $aDate$$1_date$$inline_144$$.add(new $goog$date$Interval$$(0, 0, 0 === $JSCompiler_temp$$36_diff$$inline_143$$ ? $JSCompiler_temp$$36_diff$$inline_143$$ + -7 : $JSCompiler_temp$$36_diff$$inline_143$$)));
  return $JSCompiler_temp$$36_diff$$inline_143$$ = $aDate$$1_date$$inline_144$$
}
...
function $rflect$date$createDateShim$$($aYear$$1_dateShim$$, $aMonth$$1$$, $aDate$$2$$, $aHours$$, $aMinutes$$, $aSeconds$$, $aWeekNumber$$inline_162_opt_full$$) {
  var $dateObj$$;
  $aWeekNumber$$inline_162_opt_full$$ ? ($dateObj$$ = new $goog$date$DateTime$$($aYear$$1_dateShim$$, $aMonth$$1$$, $aDate$$2$$, $aHours$$, $aMinutes$$, $aSeconds$$), $aYear$$1_dateShim$$ = new $rflect$date$DateShim$$($dateObj$$)) : $aYear$$1_dateShim$$ = new $rflect$date$DateShim$$($aYear$$1_dateShim$$, $aMonth$$1$$, $aDate$$2$$, $aHours$$, $aMinutes$$, $aSeconds$$);
  $aWeekNumber$$inline_162_opt_full$$ && ($aYear$$1_dateShim$$.$day_$ = $dateObj$$.getDay(), $aYear$$1_dateShim$$.$dayOfYear_$ = $dateObj$$.$getDayOfYear$(), $aWeekNumber$$inline_162_opt_full$$ = $dateObj$$.$getWeekNumber$(), $aYear$$1_dateShim$$.$weekNumber_$ = $aWeekNumber$$inline_162_opt_full$$);
...
$JSCompiler_prototypeAlias$$.$clone$ = function $$JSCompiler_prototypeAlias$$$$clone$$() {
  ...
  var $aWeekNumber$$inline_177$$ = this.$getWeekNumber$();
  $date$$17$$.$weekNumber_$ = $aWeekNumber$$inline_177$$;
  return $date$$17$$
};
...
function $goog$i18n$TimeZone$createTimeZone$$($offset$$inline_851_str$$inline_181_timeZoneData$$) {
  if("number" == typeof $offset$$inline_851_str$$inline_181_timeZoneData$$) {
    var $tz$$1_tz$$inline_180$$ = new $goog$i18n$TimeZone$$;
    $tz$$1_tz$$inline_180$$.$standardOffset_$ = $offset$$inline_851_str$$inline_181_timeZoneData$$;
    var $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$;
    $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$ = $offset$$inline_851_str$$inline_181_timeZoneData$$;
    if(0 == $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$) {
      $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$ = "Etc/GMT"
    }else {
      var $parts$$inline_849$$ = ["Etc/GMT", 0 > $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$ ? "-" : "+"];
      $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$ = Math.abs($JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$);
      $parts$$inline_849$$.push(Math.floor($JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$ / 60) % 100);
      $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$ %= 60;
      0 != $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$ && $parts$$inline_849$$.push(":", $goog$string$padNumber$$($JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$, 2));
      $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$ = $parts$$inline_849$$.join("")
    }
    $tz$$1_tz$$inline_180$$.$timeZoneId_$ = $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$;
    0 == $offset$$inline_851_str$$inline_181_timeZoneData$$ ? $offset$$inline_851_str$$inline_181_timeZoneData$$ = "UTC" : ($JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$ = ["UTC", 0 > $offset$$inline_851_str$$inline_181_timeZoneData$$ ? "+" : "-"], $offset$$inline_851_str$$inline_181_timeZoneData$$ = Math.abs($offset$$inline_851_str$$inline_181_timeZoneData$$), $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$.push(Math.floor($offset$$inline_851_str$$inline_181_timeZoneData$$ / 
    60) % 100), $offset$$inline_851_str$$inline_181_timeZoneData$$ %= 60, 0 != $offset$$inline_851_str$$inline_181_timeZoneData$$ && $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$.push(":", $offset$$inline_851_str$$inline_181_timeZoneData$$), $offset$$inline_851_str$$inline_181_timeZoneData$$ = $JSCompiler_inline_result$$847_offset$$inline_848_parts$$inline_852$$.join(""));
    $tz$$1_tz$$inline_180$$.$tzNames_$ = [$offset$$inline_851_str$$inline_181_timeZoneData$$, $offset$$inline_851_str$$inline_181_timeZoneData$$];
    $tz$$1_tz$$inline_180$$.$transitions_$ = [];
    return $tz$$1_tz$$inline_180$$
  }
  $tz$$1_tz$$inline_180$$ = new $goog$i18n$TimeZone$$;
  $tz$$1_tz$$inline_180$$.$timeZoneId_$ = $offset$$inline_851_str$$inline_181_timeZoneData$$.id;
  $tz$$1_tz$$inline_180$$.$standardOffset_$ = -$offset$$inline_851_str$$inline_181_timeZoneData$$.std_offset;
  $tz$$1_tz$$inline_180$$.$tzNames_$ = $offset$$inline_851_str$$inline_181_timeZoneData$$.names;
  $tz$$1_tz$$inline_180$$.$transitions_$ = $offset$$inline_851_str$$inline_181_timeZoneData$$.transitions;
  return $tz$$1_tz$$inline_180$$
}
...
function $JSCompiler_StaticMethods_formatField_$$($opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$, $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$, $dateForDate$$1$$, $dateForTime$$1$$) {
  var $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$.length;
  switch($opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$.charAt(0)) {
    case "G":
      return $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = 0 < $dateForDate$$1$$.getFullYear() ? 1 : 0, 4 <= $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? $goog$i18n$DateTimeSymbols_en$$.$ERANAMES$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$] : 
      $goog$i18n$DateTimeSymbols_en$$.$ERAS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
    case "y":
      return $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = $dateForDate$$1$$.getFullYear(), 0 > $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ && ($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = 
      -$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$), $JSCompiler_StaticMethods_localizeNumbers_$$(2 == $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? $goog$string$padNumber$$($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ % 
      100, 2) : String($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$));
    case "M":
      a: {
        switch($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = $dateForDate$$1$$.getMonth(), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$) {
          case 5:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $goog$i18n$DateTimeSymbols_en$$.$NARROWMONTHS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
            break a;
          case 4:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $goog$i18n$DateTimeSymbols_en$$.$MONTHS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
            break a;
          case 3:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $goog$i18n$DateTimeSymbols_en$$.$SHORTMONTHS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
            break a;
          default:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ + 1, $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$))
        }
      }
      return $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$;
    case "k":
      return $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($dateForTime$$1$$.getHours() || 24, $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$));
    case "S":
      return $JSCompiler_StaticMethods_localizeNumbers_$$(($dateForTime$$1$$.getTime() % 1E3 / 1E3).toFixed(Math.min(3, $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$)).substr(2) + (3 < $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? 
      $goog$string$padNumber$$(0, $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ - 3) : ""));
    case "E":
      return $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = $dateForDate$$1$$.getDay(), 4 <= $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? $goog$i18n$DateTimeSymbols_en$$.$WEEKDAYS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$] : 
      $goog$i18n$DateTimeSymbols_en$$.$SHORTWEEKDAYS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
    case "a":
      return $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $dateForTime$$1$$.getHours(), $goog$i18n$DateTimeSymbols_en$$.$AMPMS$[12 <= $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ && 24 > 
      $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? 1 : 0];
    case "h":
      return $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($dateForTime$$1$$.getHours() % 12 || 12, $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$));
    case "K":
      return $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($dateForTime$$1$$.getHours() % 12, $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$));
    case "H":
      return $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($dateForTime$$1$$.getHours(), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$));
    case "c":
      a: {
        switch($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = $dateForDate$$1$$.getDay(), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$) {
          case 5:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $goog$i18n$DateTimeSymbols_en$$.$STANDALONENARROWWEEKDAYS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
            break a;
          case 4:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $goog$i18n$DateTimeSymbols_en$$.$STANDALONEWEEKDAYS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
            break a;
          case 3:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $goog$i18n$DateTimeSymbols_en$$.$STANDALONESHORTWEEKDAYS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
            break a;
          default:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$, 1))
        }
      }
      return $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$;
    case "L":
      a: {
        switch($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = $dateForDate$$1$$.getMonth(), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$) {
          case 5:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $goog$i18n$DateTimeSymbols_en$$.$STANDALONENARROWMONTHS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
            break a;
          case 4:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $goog$i18n$DateTimeSymbols_en$$.$STANDALONEMONTHS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
            break a;
          case 3:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $goog$i18n$DateTimeSymbols_en$$.$STANDALONESHORTMONTHS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
            break a;
          default:
            $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ + 1, $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$))
        }
      ...
      return $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$;
    case "Q":
      return $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = Math.floor($dateForDate$$1$$.getMonth() / 3), 4 > $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? $goog$i18n$DateTimeSymbols_en$$.$SHORTQUARTERS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$] : 
      $goog$i18n$DateTimeSymbols_en$$.$QUARTERS$[$date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$];
    case "d":
      return $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($dateForDate$$1$$.getDate(), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$));
    case "m":
      return $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($dateForTime$$1$$.getMinutes(), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$));
    case "s":
      return $JSCompiler_StaticMethods_localizeNumbers_$$($goog$string$padNumber$$($dateForTime$$1$$.getSeconds(), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$));
    case "v":
      return $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $JSCompiler_alias_VOID$$ || $goog$i18n$TimeZone$createTimeZone$$($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$.getTimezoneOffset()), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$.$timeZoneId_$;
    case "z":
      return $opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$ = $JSCompiler_alias_VOID$$ || $goog$i18n$TimeZone$createTimeZone$$($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$.getTimezoneOffset()), 4 > $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? 
      $opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$.$tzNames_$[0 < $JSCompiler_StaticMethods_getDaylightAdjustment$$($opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$, $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$) ? 2 : 0] : $opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$.$tzNames_$[0 < $JSCompiler_StaticMethods_getDaylightAdjustment$$($opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$, 
      $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$) ? 3 : 1];
    case "Z":
      return $opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$ = $JSCompiler_alias_VOID$$ || $goog$i18n$TimeZone$createTimeZone$$($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$.getTimezoneOffset()), 4 > $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? 
      ($JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = -($opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$.$standardOffset_$ - $JSCompiler_StaticMethods_getDaylightAdjustment$$($opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$, $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$)), 
      $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = [0 > $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? "-" : "+"], $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = 
      Math.abs($JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$), $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$.push($goog$string$padNumber$$(Math.floor($JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ / 
      60) % 100, 2), $goog$string$padNumber$$($JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ % 60, 2)), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$.join("")) : 
      ($JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$.$standardOffset_$ - $JSCompiler_StaticMethods_getDaylightAdjustment$$($opt_timeZone$$inline_223_opt_timeZone$$inline_228_patternStr$$, $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$), 
      $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$ = ["GMT"], $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$.push(0 >= $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ ? 
      "+" : "-"), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = Math.abs($JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$), $date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$.push($goog$string$padNumber$$(Math.floor($JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ / 
      60) % 100, 2), ":", $goog$string$padNumber$$($JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ % 60, 2)), $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$ = $JSCompiler_StaticMethods_localizeNumbers_$$($date$$45_parts$$inline_1148_parts$$inline_857_value$$inline_185_value$$inline_190_value$$inline_195_value$$inline_199_value$$inline_207_value$$inline_212_value$$inline_216$$.join(""))), 
      $JSCompiler_inline_result$$0_JSCompiler_inline_result$$17_JSCompiler_inline_result$$38_JSCompiler_temp$$841_count$$27_hours$$inline_202_offset$$inline_1147_offset$$inline_856_opt_timeZone$$inline_219$$;
    default:
      return""
  }
}
...
$rflect$cal$events$EventManager$$.prototype.$run$ = function $$rflect$cal$events$EventManager$$$$$run$$() {
  ...
  this.$allDayChips$[0] = [];
  for(var $allDayChipsCounter$$inline_239_allDayChipsLength$$ = this.$weekChips$.length = 0, $counter$$9$$ = 0, $length$$27$$ = $daySeries$$.length;$counter$$9$$ < $length$$27$$;$counter$$9$$++) {
    var $counter$$inline_241_yearKey$$ = $daySeries$$[$counter$$9$$].getFullYear();
    if($JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$)) {
      var $dayOfYearKey_length$$inline_242$$ = $daySeries$$[$counter$$9$$].$getDayOfYear$();
      this.$dayChips$.push((this.$chipsByDay_$[$counter$$inline_241_yearKey$$] && this.$chipsByDay_$[$counter$$inline_241_yearKey$$][$dayOfYearKey_length$$inline_242$$] ? this.$chipsByDay_$[$counter$$inline_241_yearKey$$][$dayOfYearKey_length$$inline_242$$] : $JSCompiler_alias_NULL$$) || []);
      var $aKnownChipIds$$inline_232_weekKey$$ = $knownChipsIds$$, $aDayNumber$$inline_235$$ = $counter$$9$$, $aTotalDays$$inline_236$$ = $length$$27$$, $allDayChips$$inline_238$$ = this.$allDayChips$[0], $chips$$inline_240$$ = $JSCompiler_alias_VOID$$;
      if($chips$$inline_240$$ = this.$allDayChipsByDay_$[$counter$$inline_241_yearKey$$] && this.$allDayChipsByDay_$[$counter$$inline_241_yearKey$$][$dayOfYearKey_length$$inline_242$$] ? this.$allDayChipsByDay_$[$counter$$inline_241_yearKey$$][$dayOfYearKey_length$$inline_242$$] : $JSCompiler_alias_NULL$$) {
        $counter$$inline_241_yearKey$$ = 0;
        for($dayOfYearKey_length$$inline_242$$ = $chips$$inline_240$$.length;$counter$$inline_241_yearKey$$ < $dayOfYearKey_length$$inline_242$$;$counter$$inline_241_yearKey$$++) {
          var $id$$inline_243_newChip$$inline_244$$ = $chips$$inline_240$$[$counter$$inline_241_yearKey$$].$eventId$;
          $aKnownChipIds$$inline_232_weekKey$$[$id$$inline_243_newChip$$inline_244$$] || ($aKnownChipIds$$inline_232_weekKey$$[$id$$inline_243_newChip$$inline_244$$] = 1, $id$$inline_243_newChip$$inline_244$$ = $chips$$inline_240$$[$counter$$inline_241_yearKey$$].$clone$(), $id$$inline_243_newChip$$inline_244$$.start = $aDayNumber$$inline_235$$, $id$$inline_243_newChip$$inline_244$$.$endIsCut$ = $aTotalDays$$inline_236$$ - $aDayNumber$$inline_235$$ < $id$$inline_243_newChip$$inline_244$$.end, $id$$inline_243_newChip$$inline_244$$.end = 
          $id$$inline_243_newChip$$inline_244$$.$endIsCut$ ? $aTotalDays$$inline_236$$ : $aDayNumber$$inline_235$$ + $id$$inline_243_newChip$$inline_244$$.end, $allDayChips$$inline_238$$[$allDayChipsCounter$$inline_239_allDayChipsLength$$++] = $id$$inline_243_newChip$$inline_244$$)
        }
      }
    }else {
      $JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$) && $counter$$9$$ % 7 == $goog$i18n$DateTimeSymbols_en$$.$FIRSTWEEKCUTOFFDAY$ && ($aKnownChipIds$$inline_232_weekKey$$ = $daySeries$$[$counter$$9$$].$getWeekNumber$(), this.$weekChips$.push((this.$chipsByWeek_$[$counter$$inline_241_yearKey$$] && this.$chipsByWeek_$[$counter$$inline_241_yearKey$$][$aKnownChipIds$$inline_232_weekKey$$] ? this.$chipsByWeek_$[$counter$$inline_241_yearKey$$][$aKnownChipIds$$inline_232_weekKey$$] : $JSCompiler_alias_NULL$$) || 
      []))
    }
  }
};
...
function $JSCompiler_StaticMethods_unlisten$$($JSCompiler_StaticMethods_unlisten$self$$, $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$, $i$$inline_253_type$$78$$, $listener$$inline_248_opt_fn$$2$$, $capture$$inline_251_opt_capture$$3$$, $opt_handler$$12_opt_handler$$inline_250$$) {
  if($goog$isArray$$($i$$inline_253_type$$78$$)) {
    for(var $i$$66$$ = 0;$i$$66$$ < $i$$inline_253_type$$78$$.length;$i$$66$$++) {
      $JSCompiler_StaticMethods_unlisten$$($JSCompiler_StaticMethods_unlisten$self$$, $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$, $i$$inline_253_type$$78$$[$i$$66$$], $listener$$inline_248_opt_fn$$2$$, $capture$$inline_251_opt_capture$$3$$, $opt_handler$$12_opt_handler$$inline_250$$)
    }
  }else {
    a: {
      $listener$$inline_248_opt_fn$$2$$ = $listener$$inline_248_opt_fn$$2$$ || $JSCompiler_StaticMethods_unlisten$self$$;
      $opt_handler$$12_opt_handler$$inline_250$$ = $opt_handler$$12_opt_handler$$inline_250$$ || $JSCompiler_StaticMethods_unlisten$self$$.$handler_$ || $JSCompiler_StaticMethods_unlisten$self$$;
      $capture$$inline_251_opt_capture$$3$$ = !!$capture$$inline_251_opt_capture$$3$$;
      if($key$$50_listener$$51_listenerArray$$inline_252_src$$19$$ = $goog$events$getListeners_$$($key$$50_listener$$51_listenerArray$$inline_252_src$$19$$, $i$$inline_253_type$$78$$, $capture$$inline_251_opt_capture$$3$$)) {
        for($i$$inline_253_type$$78$$ = 0;$i$$inline_253_type$$78$$ < $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$.length;$i$$inline_253_type$$78$$++) {
          if(!$key$$50_listener$$51_listenerArray$$inline_252_src$$19$$[$i$$inline_253_type$$78$$].$removed$ && $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$[$i$$inline_253_type$$78$$].$listener$ == $listener$$inline_248_opt_fn$$2$$ && $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$[$i$$inline_253_type$$78$$].capture == $capture$$inline_251_opt_capture$$3$$ && $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$[$i$$inline_253_type$$78$$].$handler$ == $opt_handler$$12_opt_handler$$inline_250$$) {
            $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$ = $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$[$i$$inline_253_type$$78$$];
            break a
          }
        }
      }
      $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$ = $JSCompiler_alias_NULL$$
    }
    $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$ && ($key$$50_listener$$51_listenerArray$$inline_252_src$$19$$ = $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$.key, $goog$events$unlistenByKey$$($key$$50_listener$$51_listenerArray$$inline_252_src$$19$$), $goog$array$remove$$($JSCompiler_StaticMethods_unlisten$self$$.$keys_$, $key$$50_listener$$51_listenerArray$$inline_252_src$$19$$))
  }
...
function $goog$dom$classes$add$$($element$$9$$, $var_args$$57$$) {
  for(var $classes$$ = $goog$dom$classes$get$$($element$$9$$), $args$$3_args$$inline_256$$ = $goog$array$slice$$(arguments, 1), $expectedCount$$ = $classes$$.length + $args$$3_args$$inline_256$$.length, $classes$$inline_255$$ = $classes$$, $i$$inline_257$$ = 0;$i$$inline_257$$ < $args$$3_args$$inline_256$$.length;$i$$inline_257$$++) {
    $goog$array$contains$$($classes$$inline_255$$, $args$$3_args$$inline_256$$[$i$$inline_257$$]) || $classes$$inline_255$$.push($args$$3_args$$inline_256$$[$i$$inline_257$$])
  }
...
function $JSCompiler_StaticMethods_getDocumentScroll$$($JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_266$$) {
  var $doc$$inline_265_win$$inline_267$$ = $JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_266$$.$document_$;
  $JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_266$$ = !$goog$userAgent$WEBKIT$$ && "CSS1Compat" == $doc$$inline_265_win$$inline_267$$.compatMode ? $doc$$inline_265_win$$inline_267$$.documentElement : $doc$$inline_265_win$$inline_267$$.body;
  $doc$$inline_265_win$$inline_267$$ = $goog$dom$getWindow_$$($doc$$inline_265_win$$inline_267$$);
  return new $goog$math$Coordinate$$($doc$$inline_265_win$$inline_267$$.pageXOffset || $JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_266$$.scrollLeft, $doc$$inline_265_win$$inline_267$$.pageYOffset || $JSCompiler_StaticMethods_getDocumentScroll$self_el$$inline_266$$.scrollTop)
}
...
function $JSCompiler_StaticMethods_getFirstElementChild$$($JSCompiler_StaticMethods_getFirstElementChild$self$$, $node$$6$$) {
  var $JSCompiler_temp$$60_node$$inline_269$$;
  if($node$$6$$.firstElementChild != $JSCompiler_alias_VOID$$) {
    $JSCompiler_temp$$60_node$$inline_269$$ = $node$$6$$.firstElementChild
  }else {
    for($JSCompiler_temp$$60_node$$inline_269$$ = $node$$6$$.firstChild;$JSCompiler_temp$$60_node$$inline_269$$ && 1 != $JSCompiler_temp$$60_node$$inline_269$$.nodeType;) {
      $JSCompiler_temp$$60_node$$inline_269$$ = $JSCompiler_temp$$60_node$$inline_269$$.nextSibling
    }
  }
  return $JSCompiler_temp$$60_node$$inline_269$$
}
...
function $goog$style$getClientPosition$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$) {
  var $JSCompiler_temp_const$$30_pos$$4$$ = new $goog$math$Coordinate$$;
  if(1 == $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.nodeType) {
    if($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.getBoundingClientRect) {
      var $box$$8_scrollCoord$$1$$ = $goog$style$getBoundingClientRect_$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$);
      $JSCompiler_temp_const$$30_pos$$4$$.x = $box$$8_scrollCoord$$1$$.left;
      $JSCompiler_temp_const$$30_pos$$4$$.y = $box$$8_scrollCoord$$1$$.top
    }else {
      $box$$8_scrollCoord$$1$$ = $JSCompiler_StaticMethods_getDocumentScroll$$($goog$dom$getDomHelper$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$));
      var $box$$inline_275_doc$$inline_860$$, $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$ = $goog$dom$getOwnerDocument$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$), $positionStyle$$inline_277$$ = $goog$style$getStyle_$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$, "position");
      $goog$asserts$assertObject$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$, "Parameter is required");
      var $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ = $goog$userAgent$GECKO$$ && $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.getBoxObjectFor && !$JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.getBoundingClientRect && "absolute" == $positionStyle$$inline_277$$ && ($box$$inline_275_doc$$inline_860$$ = $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.getBoxObjectFor($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$)) && (0 > $box$$inline_275_doc$$inline_860$$.screenX || 
      0 > $box$$inline_275_doc$$inline_860$$.screenY), $pos$$inline_279$$ = new $goog$math$Coordinate$$(0, 0), $JSCompiler_temp$$inline_861_JSCompiler_temp$$inline_862_viewportElement$$inline_280$$;
      $box$$inline_275_doc$$inline_860$$ = $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$ ? $goog$dom$getOwnerDocument$$($doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$) : document;
      if($JSCompiler_temp$$inline_861_JSCompiler_temp$$inline_862_viewportElement$$inline_280$$ = $goog$userAgent$IE$$) {
        if($JSCompiler_temp$$inline_861_JSCompiler_temp$$inline_862_viewportElement$$inline_280$$ = !($goog$userAgent$IE$$ && 9 <= $goog$userAgent$DOCUMENT_MODE$$)) {
          $JSCompiler_temp$$inline_861_JSCompiler_temp$$inline_862_viewportElement$$inline_280$$ = "CSS1Compat" != $goog$dom$getDomHelper$$($box$$inline_275_doc$$inline_860$$).$document_$.compatMode
        }
      }
      $JSCompiler_temp$$inline_861_JSCompiler_temp$$inline_862_viewportElement$$inline_280$$ = $JSCompiler_temp$$inline_861_JSCompiler_temp$$inline_862_viewportElement$$inline_280$$ ? $box$$inline_275_doc$$inline_860$$.body : $box$$inline_275_doc$$inline_860$$.documentElement;
      if($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$ != $JSCompiler_temp$$inline_861_JSCompiler_temp$$inline_862_viewportElement$$inline_280$$) {
        if($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.getBoundingClientRect) {
          $box$$inline_275_doc$$inline_860$$ = $goog$style$getBoundingClientRect_$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$), $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$ = $JSCompiler_StaticMethods_getDocumentScroll$$($goog$dom$getDomHelper$$($doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$)), $pos$$inline_279$$.x = $box$$inline_275_doc$$inline_860$$.left + $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.x, $pos$$inline_279$$.y = $box$$inline_275_doc$$inline_860$$.top + 
          $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.y
        }else {
          if($doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.getBoxObjectFor && !$BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$) {
            $box$$inline_275_doc$$inline_860$$ = $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.getBoxObjectFor($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$), $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$ = $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.getBoxObjectFor($JSCompiler_temp$$inline_861_JSCompiler_temp$$inline_862_viewportElement$$inline_280$$), $pos$$inline_279$$.x = $box$$inline_275_doc$$inline_860$$.screenX - $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.screenX, 
            $pos$$inline_279$$.y = $box$$inline_275_doc$$inline_860$$.screenY - $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.screenY
          }else {
            $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ = $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$;
            do {
              $pos$$inline_279$$.x += $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$.offsetLeft;
              $pos$$inline_279$$.y += $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$.offsetTop;
              $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ != $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$ && ($pos$$inline_279$$.x += $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$.clientLeft || 0, $pos$$inline_279$$.y += $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$.clientTop || 0);
              if($goog$userAgent$WEBKIT$$ && "fixed" == $goog$style$getComputedPosition$$($BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$)) {
                $pos$$inline_279$$.x += $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.body.scrollLeft;
                $pos$$inline_279$$.y += $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.body.scrollTop;
                break
              }
              $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ = $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$.offsetParent
            }while($BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ && $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ != $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$);
            if($goog$userAgent$OPERA$$ || $goog$userAgent$WEBKIT$$ && "absolute" == $positionStyle$$inline_277$$) {
              $pos$$inline_279$$.y -= $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.body.offsetTop
            }
            for($BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ = $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$;($BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ = $goog$style$getOffsetParent$$($BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$)) && $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ != $doc$$inline_276_scrollCoord$$inline_281_vpBox$$inline_282$$.body && $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$ != $JSCompiler_temp$$inline_861_JSCompiler_temp$$inline_862_viewportElement$$inline_280$$;) {
              if($pos$$inline_279$$.x -= $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$.scrollLeft, !$goog$userAgent$OPERA$$ || "TR" != $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$.tagName) {
                $pos$$inline_279$$.y -= $BUGGY_GECKO_BOX_OBJECT$$inline_278_parent$$inline_283$$.scrollTop
              }
            }
          }
        }
      }
      $JSCompiler_temp_const$$30_pos$$4$$.x = $pos$$inline_279$$.x - $box$$8_scrollCoord$$1$$.x;
      $JSCompiler_temp_const$$30_pos$$4$$.y = $pos$$inline_279$$.y - $box$$8_scrollCoord$$1$$.y
    }
    if($goog$userAgent$GECKO$$ && !$goog$userAgent$isVersion$$(12)) {
      var $isAbstractedEvent_property$$inline_286$$;
      $goog$userAgent$IE$$ ? $isAbstractedEvent_property$$inline_286$$ = "-ms-transform" : $goog$userAgent$WEBKIT$$ ? $isAbstractedEvent_property$$inline_286$$ = "-webkit-transform" : $goog$userAgent$OPERA$$ ? $isAbstractedEvent_property$$inline_286$$ = "-o-transform" : $goog$userAgent$GECKO$$ && ($isAbstractedEvent_property$$inline_286$$ = "-moz-transform");
      var $targetEvent_transform$$inline_287$$;
      $isAbstractedEvent_property$$inline_286$$ && ($targetEvent_transform$$inline_287$$ = $goog$style$getStyle_$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$, $isAbstractedEvent_property$$inline_286$$));
      $targetEvent_transform$$inline_287$$ || ($targetEvent_transform$$inline_287$$ = $goog$style$getStyle_$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$, "transform"));
      $targetEvent_transform$$inline_287$$ ? ($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$ = $targetEvent_transform$$inline_287$$.match($goog$style$MATRIX_TRANSLATION_REGEX_$$), $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$ = !$JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$ ? new $goog$math$Coordinate$$(0, 0) : new $goog$math$Coordinate$$(parseFloat($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$[1]), parseFloat($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$[2]))) : 
      $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$ = new $goog$math$Coordinate$$(0, 0);
      $JSCompiler_temp_const$$30_pos$$4$$ = new $goog$math$Coordinate$$($JSCompiler_temp_const$$30_pos$$4$$.x + $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.x, $JSCompiler_temp_const$$30_pos$$4$$.y + $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.y)
    }
  }else {
    $isAbstractedEvent_property$$inline_286$$ = $goog$isFunction$$($JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.$getBrowserEvent$), $targetEvent_transform$$inline_287$$ = $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$, $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.targetTouches ? $targetEvent_transform$$inline_287$$ = $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.targetTouches[0] : $isAbstractedEvent_property$$inline_286$$ && $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.$event_$.targetTouches && 
    ($targetEvent_transform$$inline_287$$ = $JSCompiler_inline_result$$31_el$$12_matches$$inline_288$$.$event_$.targetTouches[0]), $JSCompiler_temp_const$$30_pos$$4$$.x = $targetEvent_transform$$inline_287$$.clientX, $JSCompiler_temp_const$$30_pos$$4$$.y = $targetEvent_transform$$inline_287$$.clientY
  }
...
function $goog$style$getIePixelBorder_$$($element$$67$$, $prop$$5$$) {
  ...
  var $pixelValue$$inline_305_width$$15$$ = $element$$67$$.currentStyle ? $element$$67$$.currentStyle[$prop$$5$$ + "Width"] : $JSCompiler_alias_NULL$$, $JSCompiler_temp$$24_oldStyleValue$$inline_303$$;
  if($pixelValue$$inline_305_width$$15$$ in $goog$style$ieBorderWidthKeywords_$$) {
    $JSCompiler_temp$$24_oldStyleValue$$inline_303$$ = $goog$style$ieBorderWidthKeywords_$$[$pixelValue$$inline_305_width$$15$$]
  }else {
    if(/^\d+px?$/.test($pixelValue$$inline_305_width$$15$$)) {
      $JSCompiler_temp$$24_oldStyleValue$$inline_303$$ = parseInt($pixelValue$$inline_305_width$$15$$, 10)
    }else {
      $JSCompiler_temp$$24_oldStyleValue$$inline_303$$ = $element$$67$$.style.left;
      var $oldRuntimeValue$$inline_304$$ = $element$$67$$.runtimeStyle.left;
      $element$$67$$.runtimeStyle.left = $element$$67$$.currentStyle.left;
      $element$$67$$.style.left = $pixelValue$$inline_305_width$$15$$;
      $pixelValue$$inline_305_width$$15$$ = $element$$67$$.style.pixelLeft;
      $element$$67$$.style.left = $JSCompiler_temp$$24_oldStyleValue$$inline_303$$;
      $element$$67$$.runtimeStyle.left = $oldRuntimeValue$$inline_304$$;
      $JSCompiler_temp$$24_oldStyleValue$$inline_303$$ = $pixelValue$$inline_305_width$$15$$
    }
  }
  return $JSCompiler_temp$$24_oldStyleValue$$inline_303$$
}
...
function $JSCompiler_StaticMethods_setId$$($JSCompiler_StaticMethods_setId$self$$, $id$$4$$) {
  if($JSCompiler_StaticMethods_setId$self$$.$parent_$ && $JSCompiler_StaticMethods_setId$self$$.$parent_$.$childIndex_$) {
    var $obj$$inline_865$$ = $JSCompiler_StaticMethods_setId$self$$.$parent_$.$childIndex_$, $key$$inline_866$$ = $JSCompiler_StaticMethods_setId$self$$.$id_$;
    $key$$inline_866$$ in $obj$$inline_865$$ && delete $obj$$inline_865$$[$key$$inline_866$$];
...
function $JSCompiler_StaticMethods_addChild$$($JSCompiler_StaticMethods_addChild$self$$, $child$$11$$) {
  var $index$$inline_313$$ = $JSCompiler_StaticMethods_addChild$self$$.$children_$ ? $JSCompiler_StaticMethods_addChild$self$$.$children_$.length : 0;
  ...
  (0 > $index$$inline_313$$ || $index$$inline_313$$ > ($JSCompiler_StaticMethods_addChild$self$$.$children_$ ? $JSCompiler_StaticMethods_addChild$self$$.$children_$.length : 0)) && $JSCompiler_alias_THROW$$(Error("Child component index out of bounds"));
  ...
  if($child$$11$$.getParent() == $JSCompiler_StaticMethods_addChild$self$$) {
    var $contentElement$$inline_315_key$$inline_869$$ = $JSCompiler_StaticMethods_getId$$($child$$11$$);
    $JSCompiler_StaticMethods_addChild$self$$.$childIndex_$[$contentElement$$inline_315_key$$inline_869$$] = $child$$11$$;
  ...
  $goog$array$splice$$($JSCompiler_StaticMethods_addChild$self$$.$children_$, $index$$inline_313$$, 0, $child$$11$$);
  $child$$11$$.$inDocument_$ && $JSCompiler_StaticMethods_addChild$self$$.$inDocument_$ && $child$$11$$.getParent() == $JSCompiler_StaticMethods_addChild$self$$ ? ($contentElement$$inline_315_key$$inline_869$$ = $JSCompiler_StaticMethods_addChild$self$$.$getContentElement$(), $contentElement$$inline_315_key$$inline_869$$.insertBefore($child$$11$$.$getElement$(), $contentElement$$inline_315_key$$inline_869$$.childNodes[$index$$inline_313$$] || $JSCompiler_alias_NULL$$)) : $JSCompiler_StaticMethods_addChild$self$$.$inDocument_$ && 
...
$JSCompiler_prototypeAlias$$.removeChild = function $$JSCompiler_prototypeAlias$$$removeChild$($child$$15$$, $opt_unrender$$) {
  if($child$$15$$) {
    ...
    if($id$$7$$ && $child$$15$$) {
      var $obj$$inline_876$$ = this.$childIndex_$;
      $id$$7$$ in $obj$$inline_876$$ && delete $obj$$inline_876$$[$id$$7$$];
...
$JSCompiler_prototypeAlias$$.$decorate$ = function $$JSCompiler_prototypeAlias$$$$decorate$$($control$$3$$, $element$$84$$) {
  ...
  $goog$array$forEach$$($classNames$$1$$, function($className$$18_state$$inline_332$$) {
    if(!$hasRendererClassName$$ && $className$$18_state$$inline_332$$ == $rendererClassName$$) {
      ...
      if(!$hasStructuralClassName$$ && $className$$18_state$$inline_332$$ == $structuralClassName$$) {
        ...
        if(!this.$stateByClass_$) {
          ...
          var $obj$$inline_1150$$ = this.$classByState_$, $transposed$$inline_1151$$ = {}, $key$$inline_1152$$;
          for($key$$inline_1152$$ in $obj$$inline_1150$$) {
            $transposed$$inline_1151$$[$obj$$inline_1150$$[$key$$inline_1152$$]] = $key$$inline_1152$$
          }
          this.$stateByClass_$ = $transposed$$inline_1151$$
        }
        $className$$18_state$$inline_332$$ = parseInt(this.$stateByClass_$[$className$$18_state$$inline_332$$], 10);
        $state$$2$$ = $JSCompiler_temp_const$$22$$ | (isNaN($className$$18_state$$inline_332$$) ? 0 : $className$$18_state$$inline_332$$)
      }
    }
  }, this);
...
$JSCompiler_prototypeAlias$$.$setAllowTextSelection$ = function $$JSCompiler_prototypeAlias$$$$setAllowTextSelection$$($element$$87$$, $allow$$) {
  var $unselectable$$inline_346_value$$inline_349$$ = !$allow$$, $descendants$$inline_348$$ = $goog$userAgent$IE$$ || $goog$userAgent$OPERA$$ ? $element$$87$$.getElementsByTagName("*") : $JSCompiler_alias_NULL$$;
  if($goog$style$unselectableStyle_$$) {
    if($unselectable$$inline_346_value$$inline_349$$ = $unselectable$$inline_346_value$$inline_349$$ ? "none" : "", $element$$87$$.style[$goog$style$unselectableStyle_$$] = $unselectable$$inline_346_value$$inline_349$$, $descendants$$inline_348$$) {
      for(var $i$$inline_350$$ = 0, $descendant$$inline_351$$;$descendant$$inline_351$$ = $descendants$$inline_348$$[$i$$inline_350$$];$i$$inline_350$$++) {
        $descendant$$inline_351$$.style[$goog$style$unselectableStyle_$$] = $unselectable$$inline_346_value$$inline_349$$
      }
    }
  }else {
    if($goog$userAgent$IE$$ || $goog$userAgent$OPERA$$) {
      if($unselectable$$inline_346_value$$inline_349$$ = $unselectable$$inline_346_value$$inline_349$$ ? "on" : "", $element$$87$$.setAttribute("unselectable", $unselectable$$inline_346_value$$inline_349$$), $descendants$$inline_348$$) {
        for($i$$inline_350$$ = 0;$descendant$$inline_351$$ = $descendants$$inline_348$$[$i$$inline_350$$];$i$$inline_350$$++) {
          $descendant$$inline_351$$.setAttribute("unselectable", $unselectable$$inline_346_value$$inline_349$$)
        }
      }
    }
  }
...
function $JSCompiler_StaticMethods_getClassNames$$($JSCompiler_StaticMethods_getClassNames$self$$, $control$$10$$) {
  var $cssClass_extraClassNames$$1_state$$inline_354$$ = $JSCompiler_StaticMethods_getClassNames$self$$.$getCssClass$(), $classNames$$2$$ = [$cssClass_extraClassNames$$1_state$$inline_354$$], $classNames$$inline_355_structuralCssClass$$ = $JSCompiler_StaticMethods_getClassNames$self$$.$getCssClass$();
  $classNames$$inline_355_structuralCssClass$$ != $cssClass_extraClassNames$$1_state$$inline_354$$ && $classNames$$2$$.push($classNames$$inline_355_structuralCssClass$$);
  $cssClass_extraClassNames$$1_state$$inline_354$$ = $control$$10$$.$state_$;
  for($classNames$$inline_355_structuralCssClass$$ = [];$cssClass_extraClassNames$$1_state$$inline_354$$;) {
    var $mask$$inline_356$$ = $cssClass_extraClassNames$$1_state$$inline_354$$ & -$cssClass_extraClassNames$$1_state$$inline_354$$;
    $classNames$$inline_355_structuralCssClass$$.push($JSCompiler_StaticMethods_getClassForState$$($JSCompiler_StaticMethods_getClassNames$self$$, $mask$$inline_356$$));
    $cssClass_extraClassNames$$1_state$$inline_354$$ &= ~$mask$$inline_356$$
  }
  $classNames$$2$$.push.apply($classNames$$2$$, $classNames$$inline_355_structuralCssClass$$);
  ($cssClass_extraClassNames$$1_state$$inline_354$$ = $control$$10$$.$extraClassNames_$) && $classNames$$2$$.push.apply($classNames$$2$$, $cssClass_extraClassNames$$1_state$$inline_354$$);
...
$JSCompiler_prototypeAlias$$.$decorate$ = function $$JSCompiler_prototypeAlias$$$$decorate$$($button$$2$$, $element$$95$$) {
  ...
  var $value$$inline_359$$ = this.$getValue$($element$$95$$);
  $button$$2$$.$value_$ = $value$$inline_359$$;
...
function $goog$ui$Control$$($content$$3$$, $JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$, $opt_domHelper$$2$$) {
  $goog$ui$Component$$.call(this, $opt_domHelper$$2$$);
  if(!$JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$) {
    $JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$ = this.constructor;
    for(var $key$$inline_371_rendererCtor$$inline_372$$;$JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$;) {
      $key$$inline_371_rendererCtor$$inline_372$$ = $goog$getUid$$($JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$);
      if($key$$inline_371_rendererCtor$$inline_372$$ = $goog$ui$registry$defaultRenderers_$$[$key$$inline_371_rendererCtor$$inline_372$$]) {
        break
      }
      $JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$ = $JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$.$superClass_$ ? $JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$.$superClass_$.constructor : $JSCompiler_alias_NULL$$
    }
    $JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$ = $key$$inline_371_rendererCtor$$inline_372$$ ? $goog$isFunction$$($key$$inline_371_rendererCtor$$inline_372$$.$getInstance$) ? $key$$inline_371_rendererCtor$$inline_372$$.$getInstance$() : new $key$$inline_371_rendererCtor$$inline_372$$ : $JSCompiler_alias_NULL$$
  }
  this.$renderer_$ = $JSCompiler_temp$$58_componentCtor$$inline_370_opt_renderer$$;
...
$JSCompiler_prototypeAlias$$.$setEnabled$ = function $$JSCompiler_prototypeAlias$$$$setEnabled$$($enable$$9$$) {
  var $parent$$inline_397$$ = this.getParent();
  if((!$parent$$inline_397$$ || "function" != typeof $parent$$inline_397$$.isEnabled || $parent$$inline_397$$.isEnabled()) && $JSCompiler_StaticMethods_isTransitionAllowed$$(this, 1, !$enable$$9$$)) {
...
$JSCompiler_prototypeAlias$$.$performActionInternal$ = function $$JSCompiler_prototypeAlias$$$$performActionInternal$$($e$$37$$) {
  ...
  if($JSCompiler_StaticMethods_isAutoState$$(this, 64)) {
    var $actionEvent_open$$inline_403$$ = !(this.$state_$ & 64);
    $JSCompiler_StaticMethods_isTransitionAllowed$$(this, 64, $actionEvent_open$$inline_403$$) && this.$setState$(64, $actionEvent_open$$inline_403$$)
  }
  $actionEvent_open$$inline_403$$ = new $goog$events$Event$$("action", this);
  $e$$37$$ && ($actionEvent_open$$inline_403$$.altKey = $e$$37$$.altKey, $actionEvent_open$$inline_403$$.ctrlKey = $e$$37$$.ctrlKey, $actionEvent_open$$inline_403$$.metaKey = $e$$37$$.metaKey, $actionEvent_open$$inline_403$$.shiftKey = $e$$37$$.shiftKey, $actionEvent_open$$inline_403$$.$platformModifierKey$ = $e$$37$$.$platformModifierKey$);
  return this.dispatchEvent($actionEvent_open$$inline_403$$)
};
...
var $key$$inline_407$$ = $goog$getUid$$($goog$ui$Control$$);
$goog$ui$registry$defaultRenderers_$$[$key$$inline_407$$] = $goog$ui$ControlRenderer$$;
...
$JSCompiler_prototypeAlias$$.$decorate$ = function $$JSCompiler_prototypeAlias$$$$decorate$$($control$$12$$, $element$$120$$) {
  ...
  var $JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$;
  a: {
    $JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$ = $JSCompiler_StaticMethods_getFirstElementChild$$($control$$12$$.$getDomHelper$(), $element$$120$$);
    var $innerClassName$$inline_419_outerClassName$$inline_417$$ = this.$getCssClass$() + "-outer-box";
    if($JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$ && $goog$array$contains$$($goog$dom$classes$get$$($JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$), $innerClassName$$inline_419_outerClassName$$inline_417$$) && ($JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$ = $JSCompiler_StaticMethods_getFirstElementChild$$($control$$12$$.$getDomHelper$(), $JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$), $innerClassName$$inline_419_outerClassName$$inline_417$$ = 
    this.$getCssClass$() + "-inner-box", $JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$ && $goog$array$contains$$($goog$dom$classes$get$$($JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$), $innerClassName$$inline_419_outerClassName$$inline_417$$))) {
      $JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$ = $JSCompiler_alias_TRUE$$;
      break a
    }
    $JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$ = $JSCompiler_alias_FALSE$$
  }
  $JSCompiler_inline_result$$41_inner$$inline_418_outer$$inline_416$$ || $element$$120$$.appendChild($JSCompiler_StaticMethods_createButton$$(this, $element$$120$$.childNodes, $control$$12$$.$getDomHelper$()));
  ...
  for(var $offset$$24$$ = 0, $length$$29$$ = $rflect$cal$MiniCalBuilder$HTML_PARTS_$$.length;++$offset$$24$$ < $length$$29$$ - 1;) {
    switch($aSb$$3$$.append($rflect$cal$MiniCalBuilder$HTML_PARTS_$$[$offset$$24$$]), $offset$$24$$) {
      ...
      case 3:
        ...
        break;
      case 5:
        var $aSb$$inline_433_aSb$$inline_435$$ = $aSb$$3$$;
        $aSb$$inline_433_aSb$$inline_435$$.append(this.$timeManager_$.$basis$.getYear());
        $aSb$$inline_433_aSb$$inline_435$$.append("&nbsp;");
        $aSb$$inline_433_aSb$$inline_435$$.append($goog$i18n$DateTimeSymbols_en$$.$MONTHS$[this.$timeManager_$.$basis$.getMonth()]);
        break;
      case 8:
        for(var $aSb$$inline_433_aSb$$inline_435$$ = $aSb$$3$$, $aOffset$$inline_436$$ = $offset$$24$$, $dayNamesFirstNumber$$inline_437$$ = $goog$i18n$DateTimeSymbols_en$$.$FIRSTDAYOFWEEK$, $dayNameNumber$$inline_438$$ = 0, $counter$$inline_439$$ = 0;7 > $counter$$inline_439$$;$counter$$inline_439$$++) {
          0 < $counter$$inline_439$$ && $aSb$$inline_433_aSb$$inline_435$$.append($rflect$cal$MiniCalBuilder$HTML_PARTS_$$[$aOffset$$inline_436$$]), $dayNameNumber$$inline_438$$ = ($dayNamesFirstNumber$$inline_437$$ + $counter$$inline_439$$ + 1) % 7, $aSb$$inline_433_aSb$$inline_435$$.append($goog$i18n$DateTimeSymbols_en$$.$WEEKDAYS$[$dayNameNumber$$inline_438$$].charAt(0).toUpperCase()), $aSb$$inline_433_aSb$$inline_435$$.append($rflect$cal$MiniCalBuilder$HTML_PARTS_$$[$aOffset$$inline_436$$ + 1])
        }
        $offset$$24$$++;
        break;
      case 11:
...
$JSCompiler_prototypeAlias$$.$run$ = function $$JSCompiler_prototypeAlias$$$$run$$() {
  ...
  var $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = 0;
  switch(this.$configuration$) {
    case 1:
      $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = 1;
      break;
    case 2:
      $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = this.$daysNumber$;
      break;
    case 3:
      $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = 7;
      break;
    case 4:
      $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = this.$daysNumber$;
      break;
    ...
    ;
    case 5:
      var $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = 0, $date$$inline_453_firstDayOfMonth$$inline_452$$ = this.$basis$.$clone$();
      $date$$inline_453_firstDayOfMonth$$inline_452$$.setDate(1);
      this.$start_$.$equals$($date$$inline_453_firstDayOfMonth$$inline_452$$) || ($daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = $JSCompiler_StaticMethods_getWeekday$$($date$$inline_453_firstDayOfMonth$$inline_452$$) - $JSCompiler_StaticMethods_getWeekday$$(this.$start_$));
      $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = 7 == this.$configuration$ ? 42 : 0 == ($daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ + $goog$date$getNumberOfDaysInMonth$$(this.$basis$.getFullYear(), this.$basis$.getMonth())) % 7 ? $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ + $goog$date$getNumberOfDaysInMonth$$(this.$basis$.getFullYear(), this.$basis$.getMonth()) : $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ + 
      $goog$date$getNumberOfDaysInMonth$$(this.$basis$.getFullYear(), this.$basis$.getMonth()) - ($daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ + $goog$date$getNumberOfDaysInMonth$$(this.$basis$.getFullYear(), this.$basis$.getMonth())) % 7 + 7
  }
  this.$daySeries$.length = 0;
  $date$$inline_453_firstDayOfMonth$$inline_452$$ = new $rflect$date$DateShim$$(this.$start_$);
  $date$$inline_453_firstDayOfMonth$$inline_452$$.$dayOfYear_$ = this.$start_$.$getDayOfYear$();
  var $aWeekNumber$$inline_898_counter$$inline_454$$ = this.$start_$.$getWeekNumber$();
  $date$$inline_453_firstDayOfMonth$$inline_452$$.$weekNumber_$ = $aWeekNumber$$inline_898_counter$$inline_454$$;
  for($aWeekNumber$$inline_898_counter$$inline_454$$ = 0;$aWeekNumber$$inline_898_counter$$inline_454$$ < $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$;$aWeekNumber$$inline_898_counter$$inline_454$$++) {
    this.$daySeries$[$aWeekNumber$$inline_898_counter$$inline_454$$] = $date$$inline_453_firstDayOfMonth$$inline_452$$, $date$$inline_453_firstDayOfMonth$$inline_452$$ = $rflect$date$getTomorrow$$($date$$inline_453_firstDayOfMonth$$inline_452$$)
  }
  this.$interval$.start = this.$start_$.getTime();
  this.$interval$.end = (new $goog$date$Date$$($date$$inline_453_firstDayOfMonth$$inline_452$$)).getTime();
  $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = new Date;
  if(this.$isInNowPoint$ = this.$interval$.contains(+$daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$) && (5 != this.$configuration$ || this.$basis$.getMonth() == $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$.getMonth())) {
    $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$ = new Date, this.$currentDay_$ = new $rflect$date$DateShim$$($daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$.getFullYear(), $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$.getMonth(), $daysNumber$$inline_450_difference$$inline_451_now$$inline_901_today$$inline_455$$.getDate())
  }
};
$JSCompiler_prototypeAlias$$.shift = function $$JSCompiler_prototypeAlias$$$shift$($aDirection$$1$$) {
  var $daysNumber$$inline_459$$ = 0;
  switch(this.$configuration$) {
    case 1:
    ...
    ;
    case 4:
      $daysNumber$$inline_459$$ = this.$daysNumber$ * $aDirection$$1$$;
      this.$basis$.add(new $goog$date$Interval$$(0, 0, $daysNumber$$inline_459$$));
      break;
    case 7:
    ;
    case 5:
...
function $JSCompiler_StaticMethods_build_$$($JSCompiler_StaticMethods_build_$self$$, $aSb$$10$$) {
  for(var $sb$$3$$ = $aSb$$10$$ || new $goog$string$StringBuffer$$, $counter$$13$$ = 0, $length$$34$$ = $JSCompiler_StaticMethods_build_$self$$.$rects_$.length;$counter$$13$$ < $length$$34$$;$counter$$13$$++) {
    var $JSCompiler_StaticMethods_buildUnit_$self$$inline_461$$ = $JSCompiler_StaticMethods_build_$self$$, $aSb$$inline_462$$ = $sb$$3$$, $aRect$$inline_463$$ = $JSCompiler_StaticMethods_build_$self$$.$rects_$[$counter$$13$$];
    $aSb$$inline_462$$.append('<div class="mask');
    $JSCompiler_StaticMethods_buildUnit_$self$$inline_461$$.$additionalClassNames$ && ($aSb$$inline_462$$.append(" "), $aSb$$inline_462$$.append($JSCompiler_StaticMethods_buildUnit_$self$$inline_461$$.$additionalClassNames$));
    $aSb$$inline_462$$.append('" style="left:');
    $aSb$$inline_462$$.append(Math.floor($aRect$$inline_463$$.left));
    $aSb$$inline_462$$.append("px;top:");
    $aSb$$inline_462$$.append(Math.floor($aRect$$inline_463$$.top));
    $aSb$$inline_462$$.append("px;width:");
    $aSb$$inline_462$$.append(Math.ceil($aRect$$inline_463$$.width));
    $aSb$$inline_462$$.append("px;height:");
    $aSb$$inline_462$$.append(Math.ceil($aRect$$inline_463$$.height));
    $aSb$$inline_462$$.append('px">');
    $aSb$$inline_462$$.append("</div>")
  }
...
$JSCompiler_prototypeAlias$$.$init$ = function $$JSCompiler_prototypeAlias$$$$init$$($JSCompiler_inline_result$$43_aConfiguration$$1_cell$$inline_467$$, $startSelectionIndex$$, $endSelectionIndex_minCell$$inline_468$$) {
  $rflect$cal$SelectionMask$$.prototype.$init$.call(this, $JSCompiler_inline_result$$43_aConfiguration$$1_cell$$inline_467$$);
  ...
  if(5 == this.$configuration_$) {
    this.$initialized_$ = $JSCompiler_alias_FALSE$$, this.$startCell_$ = $JSCompiler_StaticMethods_getCellBySelectionIndex_$$($startSelectionIndex$$), this.$currentCell_$ = $JSCompiler_StaticMethods_getCellBySelectionIndex_$$($endSelectionIndex_minCell$$inline_468$$), this.$update_$(), this.close()
  }else {
    this.$dragStarted_$ = $JSCompiler_alias_TRUE$$;
    if(this.$initialized_$) {
      $JSCompiler_inline_result$$43_aConfiguration$$1_cell$$inline_467$$ = $JSCompiler_StaticMethods_getCellBySelectionIndex_$$($startSelectionIndex$$);
      $endSelectionIndex_minCell$$inline_468$$ = -1 == $JSCompiler_StaticMethods_compareCells_$$(this, this.$visibleStartCell_$, this.$visibleCurrentCell_$) ? this.$visibleStartCell_$ : this.$visibleCurrentCell_$;
      var $maxCell$$inline_469$$ = 1 == $JSCompiler_StaticMethods_compareCells_$$(this, this.$visibleStartCell_$, this.$visibleCurrentCell_$) ? this.$visibleStartCell_$ : this.$visibleCurrentCell_$;
      $_log$$("cell", $JSCompiler_inline_result$$43_aConfiguration$$1_cell$$inline_467$$);
      $_log$$("minCell", $endSelectionIndex_minCell$$inline_468$$);
      $_log$$("maxCell", $maxCell$$inline_469$$);
      $JSCompiler_inline_result$$43_aConfiguration$$1_cell$$inline_467$$ = 0 <= $JSCompiler_StaticMethods_compareCells_$$(this, $JSCompiler_inline_result$$43_aConfiguration$$1_cell$$inline_467$$, $endSelectionIndex_minCell$$inline_468$$) && 0 >= $JSCompiler_StaticMethods_compareCells_$$(this, $JSCompiler_inline_result$$43_aConfiguration$$1_cell$$inline_467$$, $maxCell$$inline_469$$)
    }else {
      $JSCompiler_inline_result$$43_aConfiguration$$1_cell$$inline_467$$ = $JSCompiler_alias_FALSE$$
    }
    this.$indexIsInMask_$ = $JSCompiler_inline_result$$43_aConfiguration$$1_cell$$inline_467$$;
...
$JSCompiler_prototypeAlias$$.$startDrag$ = function $$JSCompiler_prototypeAlias$$$$startDrag$$($JSCompiler_temp$$66_e$$43_element$$inline_497$$) {
  var $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$ = "mousedown" == $JSCompiler_temp$$66_e$$43_element$$inline_497$$.type;
  if(this.$enabled_$ && !this.$dragging_$ && (!$doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$ || $JSCompiler_StaticMethods_isMouseActionButton$$($JSCompiler_temp$$66_e$$43_element$$inline_497$$))) {
    $JSCompiler_StaticMethods_maybeReinitTouchEvent_$$($JSCompiler_temp$$66_e$$43_element$$inline_497$$);
    if(0 == this.$hysteresisDistanceSquared_$) {
      if(this.dispatchEvent(new $goog$fx$DragEvent$$("start", this, $JSCompiler_temp$$66_e$$43_element$$inline_497$$.clientX, $JSCompiler_temp$$66_e$$43_element$$inline_497$$.clientY, $JSCompiler_temp$$66_e$$43_element$$inline_497$$))) {
        this.$dragging_$ = $JSCompiler_alias_TRUE$$, $JSCompiler_temp$$66_e$$43_element$$inline_497$$.preventDefault()
      }else {
        return
      }
    }else {
      $JSCompiler_temp$$66_e$$43_element$$inline_497$$.preventDefault()
    }
    var $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$ = this.$document_$, $bestParent$$inline_499_docEl$$inline_494$$ = $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$.documentElement, $borderWidths$$inline_500_useCapture$$inline_495$$ = !$goog$fx$Dragger$HAS_SET_CAPTURE_$$;
    $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$, ["touchmove", "mousemove"], this.$handleMove_$, $borderWidths$$inline_500_useCapture$$inline_495$$);
    $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$, ["touchend", "mouseup"], this.$endDrag$, $borderWidths$$inline_500_useCapture$$inline_495$$);
    $goog$fx$Dragger$HAS_SET_CAPTURE_$$ ? ($bestParent$$inline_499_docEl$$inline_494$$.setCapture($JSCompiler_alias_FALSE$$), $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $bestParent$$inline_499_docEl$$inline_494$$, "losecapture", this.$endDrag$)) : $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$ ? $goog$dom$getWindow_$$($doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$) : window, "blur", this.$endDrag$);
    $goog$userAgent$IE$$ && this.$ieDragStartCancellingOn_$ && $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$, "dragstart", $goog$events$Event$preventDefault$$);
    this.$scrollTarget_$ && $JSCompiler_StaticMethods_listen$$(this.$eventHandler_$, this.$scrollTarget_$, "scroll", this.$onScroll_$, $borderWidths$$inline_500_useCapture$$inline_495$$);
    this.clientX = this.$startX$ = $JSCompiler_temp$$66_e$$43_element$$inline_497$$.clientX;
    this.clientY = this.$startY$ = $JSCompiler_temp$$66_e$$43_element$$inline_497$$.clientY;
    this.screenX = $JSCompiler_temp$$66_e$$43_element$$inline_497$$.screenX;
    this.screenY = $JSCompiler_temp$$66_e$$43_element$$inline_497$$.screenY;
    this.$useRightPositioningForRtl_$ ? ($JSCompiler_temp$$66_e$$43_element$$inline_497$$ = this.target, $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$ = $JSCompiler_temp$$66_e$$43_element$$inline_497$$.offsetLeft, $bestParent$$inline_499_docEl$$inline_494$$ = $JSCompiler_temp$$66_e$$43_element$$inline_497$$.offsetParent, !$bestParent$$inline_499_docEl$$inline_494$$ && "fixed" == $goog$style$getComputedPosition$$($JSCompiler_temp$$66_e$$43_element$$inline_497$$) && ($bestParent$$inline_499_docEl$$inline_494$$ = 
    $goog$dom$getOwnerDocument$$($JSCompiler_temp$$66_e$$43_element$$inline_497$$).documentElement), $bestParent$$inline_499_docEl$$inline_494$$ ? ($goog$userAgent$GECKO$$ ? ($borderWidths$$inline_500_useCapture$$inline_495$$ = $goog$style$getBorderBox$$($bestParent$$inline_499_docEl$$inline_494$$), $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$ += $borderWidths$$inline_500_useCapture$$inline_495$$.left) : $goog$userAgent$IE$$ && 8 <= $goog$userAgent$DOCUMENT_MODE$$ && ($borderWidths$$inline_500_useCapture$$inline_495$$ = 
    $goog$style$getBorderBox$$($bestParent$$inline_499_docEl$$inline_494$$), $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$ -= $borderWidths$$inline_500_useCapture$$inline_495$$.left), $JSCompiler_temp$$66_e$$43_element$$inline_497$$ = $goog$style$isRightToLeft$$($bestParent$$inline_499_docEl$$inline_494$$) ? $bestParent$$inline_499_docEl$$inline_494$$.clientWidth - ($doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$ + $JSCompiler_temp$$66_e$$43_element$$inline_497$$.offsetWidth) : 
    $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$) : $JSCompiler_temp$$66_e$$43_element$$inline_497$$ = $doc$$inline_493_isMouseDown_offsetLeftForReal$$inline_498$$) : $JSCompiler_temp$$66_e$$43_element$$inline_497$$ = this.target.offsetLeft;
    this.$deltaX$ = $JSCompiler_temp$$66_e$$43_element$$inline_497$$;
...
$JSCompiler_prototypeAlias$$.$enterDocument$ = function $$JSCompiler_prototypeAlias$$$$enterDocument$$() {
  ...
  if(this.$bgIframeEl_$) {
    var $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$ = this.$getElement$();
    $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$.parentNode && $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$.parentNode.insertBefore(this.$bgIframeEl_$, $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$)
  }
  $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$ = this.$getElement$();
  $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$.parentNode && $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$.parentNode.insertBefore(this.$bgEl_$, $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$);
  $goog$ui$ModalPopup$$.$superClass_$.$enterDocument$.call(this);
  $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$ = this.$getElement$();
  $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$.parentNode && $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$.parentNode.insertBefore(this.$tabCatcherElement_$, $refNode$$inline_1175_refNode$$inline_1178_refNode$$inline_515$$.nextSibling);
...
$JSCompiler_prototypeAlias$$.$setVisible$ = function $$JSCompiler_prototypeAlias$$$$setVisible$$($JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$) {
  $goog$asserts$assert$$(this.$inDocument_$, "ModalPopup must be rendered first.");
  if($JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$ != this.$visible_$) {
    if(this.$popupShowTransition_$ && this.$popupShowTransition_$.stop(), this.$bgShowTransition_$ && this.$bgShowTransition_$.stop(), this.$popupHideTransition_$ && this.$popupHideTransition_$.stop(), this.$bgHideTransition_$ && this.$bgHideTransition_$.stop(), $JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$) {
      if(this.dispatchEvent("beforeshow")) {
        this.$resizeBackground_$();
        var $viewSize$$inline_913_win$$inline_908$$ = (($JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$ = $JSCompiler_StaticMethods_getDocument$$(this.$getDomHelper$())) ? $goog$dom$getWindow_$$($JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$) : window) || window;
        if("fixed" == $goog$style$getComputedPosition$$(this.$getElement$())) {
          var $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$ = $JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$ = 0
        }else {
          $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$ = $JSCompiler_StaticMethods_getDocumentScroll$$(this.$getDomHelper$()), $JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$ = $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$.x, $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$ = 
          $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$.y
        }
        var $JSCompiler_StaticMethods_getWindow$self$$inline_919_popupSize$$inline_912$$ = $goog$style$getSize$$(this.$getElement$()), $viewSize$$inline_913_win$$inline_908$$ = $goog$dom$getViewportSize_$$($viewSize$$inline_913_win$$inline_908$$ || window);
        $JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$ = Math.max($JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$ + $viewSize$$inline_913_win$$inline_908$$.width / 2 - $JSCompiler_StaticMethods_getWindow$self$$inline_919_popupSize$$inline_912$$.width / 2, 0);
        $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$ = Math.max($JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$ + $viewSize$$inline_913_win$$inline_908$$.height / 2 - $JSCompiler_StaticMethods_getWindow$self$$inline_919_popupSize$$inline_912$$.height / 2, 0);
        $goog$style$setPosition$$(this.$getElement$(), $JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$, $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$);
        $goog$style$setPosition$$(this.$tabCatcherElement_$, $JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$, $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$);
        $JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$ = this.$getHandler$();
        $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$ = this.$getDomHelper$();
        $JSCompiler_StaticMethods_listen$$($JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$, $goog$dom$getWindow_$$($JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$.$document_$), "resize", this.$resizeBackground_$);
      ...
      this.dispatchEvent("beforehide") && ($JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$ = $JSCompiler_StaticMethods_unlisten$$, $JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$ = this.$getHandler$(), $JSCompiler_StaticMethods_getWindow$self$$inline_919_popupSize$$inline_912$$ = this.$getDomHelper$(), $JSCompiler_temp_const$$827_JSCompiler_temp_const$$830_doc$$inline_907_left$$inline_914_visible$$3_x$$inline_909$$($JSCompiler_StaticMethods_getWindow$self$$inline_917_JSCompiler_temp_const$$829_scroll$$inline_911_top$$inline_915_y$$inline_910$$, 
      $goog$dom$getWindow_$$($JSCompiler_StaticMethods_getWindow$self$$inline_919_popupSize$$inline_912$$.$document_$), "resize", this.$resizeBackground_$), this.$visible_$ = $JSCompiler_alias_FALSE$$, this.$popupHideTransition_$ && this.$bgHideTransition_$ ? ($goog$events$listenOnce$$(this.$popupHideTransition_$, "end", this.$onHide$, $JSCompiler_alias_FALSE$$, this), this.$bgHideTransition_$.play(), this.$popupHideTransition_$.play()) : this.$onHide$())
    }
  }
};
...
function $rflect$ui$Dialog$$($ok$$inline_521_opt_class$$4$$, $cancel$$inline_522_opt_useIframeMask$$1$$, $opt_domHelper$$7$$, $opt_buttonRenderer$$) {
  $goog$ui$ModalPopup$$.call(this, $cancel$$inline_522_opt_useIframeMask$$1$$, $opt_domHelper$$7$$);
  this.$class_$ = $ok$$inline_521_opt_class$$4$$ || "modal-dialog";
  $ok$$inline_521_opt_class$$4$$ = $rflect$ui$Dialog$ButtonSet$getButton$$("OK");
  $cancel$$inline_522_opt_useIframeMask$$1$$ = $rflect$ui$Dialog$ButtonSet$getButton$$("Cancel");
  this.$buttons_$ = $JSCompiler_StaticMethods_addButton$$($JSCompiler_StaticMethods_addButton$$(new $rflect$ui$Dialog$ButtonSet$$, $ok$$inline_521_opt_class$$4$$, $JSCompiler_alias_TRUE$$, $JSCompiler_alias_FALSE$$, $JSCompiler_alias_TRUE$$), $cancel$$inline_522_opt_useIframeMask$$1$$, $JSCompiler_alias_FALSE$$, $JSCompiler_alias_TRUE$$);
...
function $JSCompiler_StaticMethods_setDraggingEnabled_$$($JSCompiler_StaticMethods_setDraggingEnabled_$self$$, $enabled$$2$$) {
  if($JSCompiler_StaticMethods_setDraggingEnabled_$self$$.$getElement$()) {
    var $element$$inline_530$$ = $JSCompiler_StaticMethods_setDraggingEnabled_$self$$.$titleEl_$, $className$$inline_531$$ = $JSCompiler_StaticMethods_setDraggingEnabled_$self$$.$class_$ + "-title-draggable";
    $enabled$$2$$ ? $goog$dom$classes$add$$($element$$inline_530$$, $className$$inline_531$$) : $goog$dom$classes$remove$$($element$$inline_530$$, $className$$inline_531$$)
  }
...
$JSCompiler_prototypeAlias$$.$onMouseDownGlobal_$ = function $$JSCompiler_prototypeAlias$$$$onMouseDownGlobal_$$() {
  for(var $counter$$14$$ = 0, $length$$37$$ = $rflect$ui$Dialog$instances_$$.length;$counter$$14$$ < $length$$37$$;$counter$$14$$++) {
    $rflect$ui$Dialog$instances_$$[$counter$$14$$].$doNotClose$ ? $rflect$ui$Dialog$instances_$$[$counter$$14$$].$doNotClose$ = $JSCompiler_alias_FALSE$$ : $rflect$ui$Dialog$instances_$$[$counter$$14$$].$setVisible$($JSCompiler_alias_FALSE$$)
  }
};
$JSCompiler_prototypeAlias$$.$exitDocument$ = function $$JSCompiler_prototypeAlias$$$$exitDocument$$() {
  this.$visible_$ && this.$setVisible$($JSCompiler_alias_FALSE$$);
...
$JSCompiler_prototypeAlias$$.$setDraggerLimits_$ = function $$JSCompiler_prototypeAlias$$$$setDraggerLimits_$$() {
  var $doc$$41_h$$8$$ = $JSCompiler_StaticMethods_getDocument$$(this.$getDomHelper$()), $limits$$inline_541_viewSize$$2$$ = $goog$dom$getViewportSize_$$(($doc$$41_h$$8$$ ? $goog$dom$getWindow_$$($doc$$41_h$$8$$) : window) || window || window), $w$$8$$ = Math.max($doc$$41_h$$8$$.body.scrollWidth, $limits$$inline_541_viewSize$$2$$.width), $doc$$41_h$$8$$ = Math.max($doc$$41_h$$8$$.body.scrollHeight, $limits$$inline_541_viewSize$$2$$.height), $dialogSize$$ = $goog$style$getSize$$(this.$getElement$());
  "fixed" == $goog$style$getComputedPosition$$(this.$getElement$()) ? ($limits$$inline_541_viewSize$$2$$ = new $goog$math$Rect$$(0, 0, Math.max(0, $limits$$inline_541_viewSize$$2$$.width - $dialogSize$$.width), Math.max(0, $limits$$inline_541_viewSize$$2$$.height - $dialogSize$$.height)), this.$dragger_$.$limits$ = $limits$$inline_541_viewSize$$2$$ || new $goog$math$Rect$$(NaN, NaN, NaN, NaN)) : this.$dragger_$.$limits$ = new $goog$math$Rect$$(0, 0, $w$$8$$ - $dialogSize$$.width, $doc$$41_h$$8$$ - 
...
;function $rflect$cal$ui$SaveDialog$$() {
  ...
  var $JSCompiler_inline_result$$53_save$$inline_555$$;
  $JSCompiler_inline_result$$53_save$$inline_555$$ = $rflect$ui$Dialog$ButtonSet$getButton$$("Save");
  var $cancel$$inline_556$$ = $rflect$ui$Dialog$ButtonSet$getButton$$("Cancel");
  $JSCompiler_inline_result$$53_save$$inline_555$$ = $JSCompiler_StaticMethods_addButton$$($JSCompiler_StaticMethods_addButton$$(new $rflect$ui$Dialog$ButtonSet$$, $JSCompiler_inline_result$$53_save$$inline_555$$, $JSCompiler_alias_TRUE$$, $JSCompiler_alias_FALSE$$, $JSCompiler_alias_TRUE$$), $cancel$$inline_556$$, $JSCompiler_alias_FALSE$$, $JSCompiler_alias_TRUE$$);
  $JSCompiler_StaticMethods_setButtonSet$$(this, $JSCompiler_inline_result$$53_save$$inline_555$$);
...
function $JSCompiler_StaticMethods_buildWeekGridAdCols_$$($JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$, $aSb$$34$$, $aOffset$$9$$) {
  for(var $prevColsCumulativeSize$$1$$ = 0, $gridWidth$$1$$ = $JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$.$blockPoolWeek_$.$gridSize$.width, $sparseArrays$$ = $JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$.$blockPoolAllday_$.$blocks$[0].$sparseArrays$, $colCounter$$2$$ = 0, $blocksNumber$$1$$ = $JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$.$blockPoolWeek_$.$blocksNumber_$;$colCounter$$2$$ < $blocksNumber$$1$$;$colCounter$$2$$++) {
    ...
    var $aSb$$inline_559_aSb$$inline_563$$ = $aSb$$34$$, $aChips$$inline_564_aOffset$$inline_560$$ = $aOffset$$9$$ + 9, $aEventManager$$inline_565_block$$inline_561$$ = $JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$.$blockPoolAllday_$.$blocks$[0];
    $aSb$$inline_559_aSb$$inline_563$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aChips$$inline_564_aOffset$$inline_560$$]);
    $aSb$$inline_559_aSb$$inline_563$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aChips$$inline_564_aOffset$$inline_560$$ + 1]);
    $aSb$$inline_559_aSb$$inline_563$$.append(!$aEventManager$$inline_565_block$$inline_561$$.$expanded$ && $aEventManager$$inline_565_block$$inline_561$$.$couldBeExpanded$ ? "expand-sign-wk-ad-collapsed" : $aEventManager$$inline_565_block$$inline_561$$.$expanded$ && $aEventManager$$inline_565_block$$inline_561$$.$couldBeCollapsed$ ? "expand-sign-wk-ad-expanded" : "");
    $aSb$$inline_559_aSb$$inline_563$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aChips$$inline_564_aOffset$$inline_560$$ + 2]);
    ...
    for(var $aSb$$inline_559_aSb$$inline_563$$ = $aSb$$34$$, $aChips$$inline_564_aOffset$$inline_560$$ = $sparseArrays$$[$colCounter$$2$$], $aEventManager$$inline_565_block$$inline_561$$ = $JSCompiler_StaticMethods_buildWeekGridAdCols_$self$$.$eventManager_$, $chip$$inline_566$$ = $JSCompiler_alias_VOID$$, $chipCounter$$inline_567$$ = 0, $length$$inline_568$$ = $aChips$$inline_564_aOffset$$inline_560$$.length;$chipCounter$$inline_567$$ < $length$$inline_568$$;$chipCounter$$inline_567$$++) {
      ($chip$$inline_566$$ = $aChips$$inline_564_aOffset$$inline_560$$[$chipCounter$$inline_567$$]) && $rflect$cal$MainPaneBuilder$buildMonthBlockChip_$$($aSb$$inline_559_aSb$$inline_563$$, 72, $aEventManager$$inline_565_block$$inline_561$$, $chip$$inline_566$$, 0, $chipCounter$$inline_567$$, 0, $JSCompiler_alias_TRUE$$)
    }
...
function $JSCompiler_StaticMethods_buildWeekGridCols_$$($JSCompiler_StaticMethods_buildWeekGridCols_$self$$, $aSb$$47$$, $aOffset$$21$$) {
  for(var $prevColsCumulativeSize$$3$$ = 0, $gridWidth$$3$$ = $JSCompiler_StaticMethods_buildWeekGridCols_$self$$.$blockPoolWeek_$.$gridSize$.width, $colCounter$$4$$ = 0, $blocksNumber$$5$$ = $JSCompiler_StaticMethods_buildWeekGridCols_$self$$.$blockPoolWeek_$.$blocksNumber_$;$colCounter$$4$$ < $blocksNumber$$5$$;$colCounter$$4$$++) {
    ...
    for(var $aSb$$inline_571_aSb$$inline_578$$ = $aSb$$47$$, $aOffset$$inline_572$$ = $aOffset$$21$$ + 8, $block$$inline_574$$ = $JSCompiler_StaticMethods_buildWeekGridCols_$self$$.$blockPoolWeek_$.$blocks$[$colCounter$$4$$], $counter$$inline_575$$ = 0;6 > $counter$$inline_575$$;$counter$$inline_575$$++) {
      $aSb$$inline_571_aSb$$inline_578$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_572$$]), $aSb$$inline_571_aSb$$inline_578$$.append(!$block$$inline_574$$.$expanded$ && $block$$inline_574$$.$couldBeExpanded$ ? "expand-sign-wk-collapsed" : $block$$inline_574$$.$expanded$ && $block$$inline_574$$.$couldBeCollapsed$ ? "expand-sign-wk-expanded" : ""), $aSb$$inline_571_aSb$$inline_578$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_572$$ + 1])
    }
    $JSCompiler_StaticMethods_buildWeekGridCols_$self$$.$timeManager_$.$currentDay_$ && $JSCompiler_StaticMethods_buildWeekGridCols_$self$$.$timeManager_$.$currentDay_$.$equals$($JSCompiler_StaticMethods_buildWeekGridCols_$self$$.$timeManager_$.$daySeries$[$colCounter$$4$$], 7) && ($aSb$$47$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$21$$ + 10]), $aSb$$inline_571_aSb$$inline_578$$ = $aSb$$47$$, $aSb$$inline_571_aSb$$inline_578$$.append($rflect$cal$TimeMarker$HEAD_PARTS_$$[2]), 
    $aSb$$inline_571_aSb$$inline_578$$.append($JSCompiler_StaticMethods_getPosition_$$($JSCompiler_alias_FALSE$$)), $aSb$$inline_571_aSb$$inline_578$$.append($rflect$cal$TimeMarker$HEAD_PARTS_$$[3]));
...
function $rflect$cal$ui$EditDialog$$() {
  ...
  $JSCompiler_alias_FALSE$$ != this.$modal_$ && $JSCompiler_StaticMethods_setModalInternal_$$(this);
  $JSCompiler_StaticMethods_setBackgroundElementOpacity$$(this, 0);
  var $JSCompiler_inline_result$$61_edit$$inline_596$$;
  $JSCompiler_inline_result$$61_edit$$inline_596$$ = $rflect$ui$Dialog$ButtonSet$getButton$$("Edit");
  var $del$$inline_597$$ = $rflect$ui$Dialog$ButtonSet$getButton$$("Delete"), $cancel$$inline_598$$ = $rflect$ui$Dialog$ButtonSet$getButton$$("Cancel");
  $JSCompiler_inline_result$$61_edit$$inline_596$$ = $JSCompiler_StaticMethods_addButton$$($JSCompiler_StaticMethods_addButton$$($JSCompiler_StaticMethods_addButton$$(new $rflect$ui$Dialog$ButtonSet$$, $JSCompiler_inline_result$$61_edit$$inline_596$$, $JSCompiler_alias_TRUE$$, $JSCompiler_alias_FALSE$$, $JSCompiler_alias_TRUE$$), $del$$inline_597$$, $JSCompiler_alias_FALSE$$, $JSCompiler_alias_TRUE$$), $cancel$$inline_598$$, $JSCompiler_alias_FALSE$$, $JSCompiler_alias_TRUE$$);
  $JSCompiler_StaticMethods_setButtonSet$$(this, $JSCompiler_inline_result$$61_edit$$inline_596$$);
...
for(var $rflect$pagevis$nameOfHiddenProperty_$$, $rflect$pagevis$nameOfVisibilityChangeEvent$$, $rflect$pagevis$VENDOR_HIDDEN_NAMES$$ = ["hidden", "msHidden", "mozHidden", "webkitHidden"], $rflect$pagevis$VENDOR_VISIBILITYCHANGE_NAMES$$ = ["visibilitychange", "msvisibilitychange", "mozvisibilitychange", "webkitvisibilitychange"], $vendorCounter$$inline_600$$ = 0;$vendorCounter$$inline_600$$ < $rflect$pagevis$VENDOR_HIDDEN_NAMES$$.length;$vendorCounter$$inline_600$$++) {
  if($rflect$pagevis$VENDOR_HIDDEN_NAMES$$[$vendorCounter$$inline_600$$] in document) {
    $rflect$pagevis$nameOfHiddenProperty_$$ = $rflect$pagevis$VENDOR_HIDDEN_NAMES$$[$vendorCounter$$inline_600$$];
    $rflect$pagevis$nameOfVisibilityChangeEvent$$ = $rflect$pagevis$VENDOR_VISIBILITYCHANGE_NAMES$$[$vendorCounter$$inline_600$$];
    break
  }
}
...
$JSCompiler_prototypeAlias$$.$update_$ = function $$JSCompiler_prototypeAlias$$$$update_$$() {
  ...
  if(this.$initialized_$) {
    ...
    $JSCompiler_alias_FALSE$$), $defaultStep_step$$inline_603$$;
    $defaultStep_step$$inline_603$$ = 0;
    $defaultStep_step$$inline_603$$ = 1 == this.$configuration_$ ? this.$blockPoolAllday_$.$gridSize$.height : this.$isWeek$() ? 24 : this.$blockPoolMonth_$.$gridSize$.width / 7;
    var $maxSize$$1_size$$inline_606$$;
    $maxSize$$1_size$$inline_606$$ = 0;
    $maxSize$$1_size$$inline_606$$ = 1 == this.$configuration_$ ? this.$blockPoolAllday_$.$gridSize$.height : this.$isWeek$() ? 1152 : this.$blockPoolMonth_$.$gridSize$.width;
    var $minIndex$$ = 0, $maxIndex$$ = 0;
    $startCellPrimaryCoord$$ == $currentCellPrimaryCoord$$ ? ($minIndex$$ = Math.min($startCellSecondaryCoord$$, $currentCellSecondaryCoord$$), $maxIndex$$ = Math.max($startCellSecondaryCoord$$, $currentCellSecondaryCoord$$), this.$rects_$.push(this.$getRect_$($blockPositionForStartCell$$, $minIndex$$ * $defaultStep_step$$inline_603$$, $blockSizeForStartCell$$, ($maxIndex$$ - $minIndex$$ + 1) * $defaultStep_step$$inline_603$$))) : (this.$rects_$.push(this.$getRect_$($blockPositionForStartCell$$, 
    $currentCellPrimaryCoord$$ > $startCellPrimaryCoord$$ ? $startCellSecondaryCoord$$ * $defaultStep_step$$inline_603$$ : 0, $blockSizeForStartCell$$, $currentCellPrimaryCoord$$ > $startCellPrimaryCoord$$ ? $maxSize$$1_size$$inline_606$$ - $startCellSecondaryCoord$$ * $defaultStep_step$$inline_603$$ : ($startCellSecondaryCoord$$ + 1) * $defaultStep_step$$inline_603$$)), this.$rects_$.push(this.$getRect_$($blockPositionForCurrentCell$$, $currentCellPrimaryCoord$$ > $startCellPrimaryCoord$$ ? 0 : 
    $currentCellSecondaryCoord$$ * $defaultStep_step$$inline_603$$, $blockSizeForCurrentCell$$, $currentCellPrimaryCoord$$ > $startCellPrimaryCoord$$ ? ($currentCellSecondaryCoord$$ + 1) * $defaultStep_step$$inline_603$$ : $maxSize$$1_size$$inline_606$$ - $currentCellSecondaryCoord$$ * $defaultStep_step$$inline_603$$)), 1 < Math.abs($currentCellPrimaryCoord$$ - $startCellPrimaryCoord$$) && ($minIndex$$ = Math.min($startCellPrimaryCoord$$, $currentCellPrimaryCoord$$), $maxIndex$$ = Math.max($startCellPrimaryCoord$$, 
...
function $JSCompiler_StaticMethods_updateBlockManager$$($JSCompiler_StaticMethods_updateBlockManager$self$$) {
  var $JSCompiler_StaticMethods_setSizes$self$$inline_610$$ = $JSCompiler_StaticMethods_updateBlockManager$self$$.$blockManager_$, $aGridSize$$inline_611$$ = $JSCompiler_StaticMethods_updateBlockManager$self$$.$gridSize$, $aGridContainerSize$$inline_612$$ = $JSCompiler_StaticMethods_updateBlockManager$self$$.$gridContainerSize$, $opt_alldayGridSize$$inline_613$$ = $JSCompiler_StaticMethods_updateBlockManager$self$$.$alldayGridSize$, $opt_alldayGridContainerSize$$inline_614$$ = $JSCompiler_StaticMethods_updateBlockManager$self$$.$alldayGridContainerSize$;
  $JSCompiler_StaticMethods_isInWeekMode$$($JSCompiler_StaticMethods_setSizes$self$$inline_610$$.$viewManager_$) ? ($JSCompiler_StaticMethods_setSizes$self$$inline_610$$.$blockPoolWeek$.$gridContainerSize$ = $aGridContainerSize$$inline_612$$, $JSCompiler_StaticMethods_setSizes$self$$inline_610$$.$blockPoolWeek$.$gridSize$ = $aGridSize$$inline_611$$, $JSCompiler_StaticMethods_setSizes$self$$inline_610$$.$blockPoolAllday$.$gridSize$ = $opt_alldayGridSize$$inline_613$$, $JSCompiler_StaticMethods_setSizes$self$$inline_610$$.$blockPoolAllday$.$gridContainerSize$ = 
  $opt_alldayGridContainerSize$$inline_614$$) : $JSCompiler_StaticMethods_isInMonthMode$$($JSCompiler_StaticMethods_setSizes$self$$inline_610$$.$viewManager_$) && ($JSCompiler_StaticMethods_setSizes$self$$inline_610$$.$blockPoolMonth$.$gridContainerSize$ = $aGridContainerSize$$inline_612$$, $JSCompiler_StaticMethods_setSizes$self$$inline_610$$.$blockPoolMonth$.$gridSize$ = $aGridSize$$inline_611$$);
...
$JSCompiler_prototypeAlias$$.$buildBodyInternal$ = function $$JSCompiler_prototypeAlias$$$$buildBodyInternal$$($aSb$$59$$) {
  if($JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$)) {
    for(var $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$ = this.$mainPaneBuilder_$, $offset$$inline_620_offset$$inline_625$$ = 0, $length$$inline_621_length$$inline_626$$ = $rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$.length;++$offset$$inline_620_offset$$inline_625$$ < $length$$inline_621_length$$inline_626$$ - 1;) {
      switch($aSb$$59$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$offset$$inline_620_offset$$inline_625$$]), $offset$$inline_620_offset$$inline_625$$) {
        case 5:
          var $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
          $aSb$$59$$;
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$.$blockPoolMonth_$.$expanded$ ? $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$.$containerSizeMonitor_$.$scrollbarWidth$ + 
          2) : $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append(2);
          break;
        case 8:
          for(var $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
          $aSb$$59$$, $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $offset$$inline_620_offset$$inline_625$$, $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ = $goog$i18n$DateTimeSymbols_en$$.$FIRSTDAYOFWEEK$, 
          $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ = 0, $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ = 0;7 > $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$;$blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$++) {
            0 < $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ && $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$]), 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$), 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ + 
            1]), $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ = ($aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ + 
            1) % 7, $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($goog$i18n$DateTimeSymbols_en$$.$WEEKDAYS$[$dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$]), 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ + 
            2])
          }
          $offset$$inline_620_offset$$inline_625$$ += 2;
          break;
        case 15:
          $aSb$$59$$.append($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$.$blockPoolMonth_$.$gridContainerSize$.height);
          break;
        case 19:
          $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$;
          $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $aSb$$59$$;
          $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ = $offset$$inline_620_offset$$inline_625$$;
          $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ = 0;
          for($blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolMonth_$.$blocksNumber_$;$dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ < 
          $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$;$dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$++) {
            0 < $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ && $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$]), 
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
            1]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolMonth_$.$blocks$[$dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$].size), 
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 2]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
            3]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 4]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$), 
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 5]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolMonth_$.$blocks$[$dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$].$expanded$ ? 
            "mn-row-zippy-expanded" : "mn-row-zippy-collapsed"), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
            6]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 7]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
            8])
          }
          $offset$$inline_620_offset$$inline_625$$ += 7;
          break;
        case 30:
          $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
          $aSb$$59$$;
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$.$blockPoolMonth_$.$expanded$ ? $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append("mpbs-mn-scroll-vert-on") : 
          $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append("mpbs-mn-scroll-vert-off");
          break;
        case 32:
          $aSb$$59$$.append($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$.$blockPoolMonth_$.$gridSize$.height);
          break;
        case 35:
          for(var $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$, $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $aSb$$59$$, $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ = 
          $offset$$inline_620_offset$$inline_625$$, $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ = $JSCompiler_alias_NULL$$, $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ = 0, $blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolMonth_$.$blocksNumber_$;$blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ < 
          $blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$;$blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$++) {
            0 < $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ && $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$]), 
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
            1]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolMonth_$.$blocks$[$blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$].size), 
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 2]), $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ = 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$timeManager_$.$daySeries$[7 * 
            $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$], $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$.$getWeekNumber$()), 
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 3])
          }
          $offset$$inline_620_offset$$inline_625$$ += 3;
          break;
        case 43:
          $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
          $aSb$$59$$;
          $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $offset$$inline_620_offset$$inline_625$$;
          for($aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ = 0;7 > $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$;$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$++) {
            0 < $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ && $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$]), 
            6 == $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ && $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append(" weekgrid-col-last"), 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[$aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ + 
            1])
          }
          $offset$$inline_620_offset$$inline_625$$++;
          break;
        case 49:
          $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$.$buildMonthGridRows_$($aSb$$59$$, $offset$$inline_620_offset$$inline_625$$), $offset$$inline_620_offset$$inline_625$$ += 32
      }
    }
  }else {
    if($JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$)) {
      $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$ = this.$mainPaneBuilder_$;
      $offset$$inline_620_offset$$inline_625$$ = 0;
      for($length$$inline_621_length$$inline_626$$ = $rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$.length;++$offset$$inline_620_offset$$inline_625$$ < $length$$inline_621_length$$inline_626$$ - 1;) {
        switch($aSb$$59$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$offset$$inline_620_offset$$inline_625$$]), $offset$$inline_620_offset$$inline_625$$) {
          case 3:
            $aSb$$59$$.append($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$.$blockPoolAllday_$.$expanded$ ? "goog-zippy-expanded" : "goog-zippy-collapsed");
            break;
          case 8:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$;
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $aSb$$59$$;
            $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ = $offset$$inline_620_offset$$inline_625$$;
            $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$timeManager_$.$daySeries$;
            $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ = 0;
            $blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$gridSize$.width;
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append((100 * ($blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$ / $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolAllday_$.$gridContainerSize$.width)).toFixed(4));
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 1]);
            for(var $blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$ = 0, $blocksNumber$$inline_972_timeIncrement$$inline_1003$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$blocksNumber_$;$blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$ < 
            $blocksNumber$$inline_972_timeIncrement$$inline_1003$$;$blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$++) {
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 2]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$), 
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 3]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append((100 * 
              ($blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ / $blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$)).toFixed(4)), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ += $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$blocks$[$blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$].size, 
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 4]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append((100 - 
              100 * ($blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ / $blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$)).toFixed(4)), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
              5]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append(-100 * $blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
              6]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append(1 != $blocksNumber$$inline_972_timeIncrement$$inline_1003$$ ? "dayname-wk-inner" : ""), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
              7]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_format$$($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$weekDayNameFormatWeek_$, 
              $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$[$blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$])), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
              8])
            }
            $offset$$inline_620_offset$$inline_625$$ += 8;
            break;
          case 19:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$;
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $aSb$$59$$;
            $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ = $offset$$inline_620_offset$$inline_625$$;
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolAllday_$.$expanded$ ? 
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append("mphs-scroll-vert-on ") : $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append("mphs-scroll-vert-off ");
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$expanded$ ? 
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append("mphs-scroll-horz-on") : $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append("mphs-scroll-horz-off");
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 1]);
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolAllday_$.$gridContainerSize$.height);
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 2]);
            $offset$$inline_620_offset$$inline_625$$ += 2;
            break;
          case 23:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
            ...
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $aSb$$59$$;
            $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ = $offset$$inline_620_offset$$inline_625$$;
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolAllday_$.$gridSize$.height);
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 1]);
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append((100 * ($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$gridSize$.width / 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolAllday_$.$gridContainerSize$.width)).toFixed(4));
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 2]);
            $offset$$inline_620_offset$$inline_625$$ += 2;
            break;
          case 27:
            $JSCompiler_StaticMethods_buildWeekGridAdCols_$$($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$, $aSb$$59$$, $offset$$inline_620_offset$$inline_625$$);
            $offset$$inline_620_offset$$inline_625$$ += 17;
            break;
          case 49:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$;
            ...
            $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ = 0;
            $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$gridSize$.width;
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append((100 * ($blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ / $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$gridContainerSize$.width)).toFixed(4));
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 1]);
            $blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$ = 0;
            for($blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$ = $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$blocksNumber_$;$blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$ < 
            $blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$;$blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$++) {
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 2]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append((100 * 
              ($dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ / $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$)).toFixed(4)), $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ += 
              $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$blocks$[$blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$].size, 
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 3]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append((100 - 
              100 * ($dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ / $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$)).toFixed(4)), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
              4]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append(-100 * $blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
              5]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 6]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$), 
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 7]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$blocks$[$blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$].$expanded$ ? 
              "wk-col-zippy-expanded" : "wk-col-zippy-collapsed"), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
              8]), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 9])
            }
            $offset$$inline_620_offset$$inline_625$$ += 9;
            break;
          case 63:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$;
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $aSb$$59$$;
            $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ = $offset$$inline_620_offset$$inline_625$$;
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$gridContainerSize$.height);
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 1]);
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$expanded$ ? 
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append("mpbs-wk-scroll-horz-on") : $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append("mpbs-wk-scroll-horz-off");
            $offset$$inline_620_offset$$inline_625$$++;
            break;
          case 67:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
            $aSb$$59$$;
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($rflect$cal$TimeMarker$HEAD_PARTS_$$[0]);
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($JSCompiler_StaticMethods_getPosition_$$($JSCompiler_alias_TRUE$$));
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($rflect$cal$TimeMarker$HEAD_PARTS_$$[1]);
            break;
          case 68:
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$ = 
            $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$;
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $aSb$$59$$;
            $aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ = $offset$$inline_620_offset$$inline_625$$;
            $dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$ = 100 * ($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$gridSize$.width / 
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$blockPoolWeek_$.$gridContainerSize$.width);
            if(1 in $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$cache_$ && 
            2 in $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$cache_$) {
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$cache_$[1]), 
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$), $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$cache_$[2])
            }else {
              $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$ = new $goog$string$StringBuffer$$;
              $blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$ = new $goog$i18n$DateTimeFormat$$($goog$i18n$DateTimeSymbols_en$$.$TIMEFORMATS$[3]);
              $blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$ = new $goog$date$DateTime$$;
              $blocksNumber$$inline_972_timeIncrement$$inline_1003$$ = new $goog$date$Interval$$(0, 0, 0, 0, 30);
              $blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$.setHours(0);
              $blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$.setMinutes(0);
              $blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$.setSeconds(0);
              for(var $counter$$inline_1004$$ = 0;48 > $counter$$inline_1004$$;$counter$$inline_1004$$++, $blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$.add($blocksNumber$$inline_972_timeIncrement$$inline_1003$$)) {
                0 < $counter$$inline_1004$$ && $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$]), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append("grid-table-row "), 
                0 == $counter$$inline_1004$$ % 2 ? ($blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append("grid-table-row-even"), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
                1]), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append("hl-even")) : ($blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append("grid-table-row-odd"), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
                1]), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append("hl-odd")), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
                2]), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($JSCompiler_StaticMethods_format$$($blocksNumber$$inline_956_colCounter$$inline_987_gridWidth$$inline_970_timeFormat$$inline_1001$$, $blocksNumber$$inline_988_colCounter$$inline_971_timeCounter$$inline_1002$$)), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
                3])
              }
              $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 4]);
              $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 5]);
              $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 6]);
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$cache_$[1] = 
              $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.toString());
              $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.clear();
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($dateInFirstCol$$inline_954_dayNameNumber$$inline_933_daySeries$$inline_968_gridRowsWidth$$inline_999_prevColsCumulativeSize$$inline_985_rowCounter$$inline_942$$);
              $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 7]);
              for($counter$$inline_1004$$ = 0;48 > $counter$$inline_1004$$;$counter$$inline_1004$$++) {
                $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 8]), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append("grid-table-row "), 
                0 == $counter$$inline_1004$$ % 2 ? $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append("grid-table-row-even") : $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append("grid-table-row-odd"), $blocksNumber$$inline_943_counter$$inline_934_gridWidth$$inline_986_prevColsCumulativeSize$$inline_969_rowCounter$$inline_955_sb$$inline_1000$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_941_aOffset$$inline_953_aOffset$$inline_967_aOffset$$inline_976_aOffset$$inline_980_aOffset$$inline_984_aOffset$$inline_992_aOffset$$inline_998_counter$$inline_960_dayNamesFirstNumber$$inline_932$$ + 
                9])
              }
              $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$.append($JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.$cache_$[2] = 
          ...
          case 79:
            ...
            $aSb$$59$$;
            $aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ = $offset$$inline_620_offset$$inline_625$$;
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append(100 * 
            ($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$.$blockPoolWeek_$.$gridSize$.width / $JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$.$blockPoolWeek_$.$gridContainerSize$.width));
            $JSCompiler_StaticMethods_buildAllDayGrid_$self$$inline_978_JSCompiler_StaticMethods_buildDayNamesWeek_$self$$inline_965_JSCompiler_StaticMethods_buildHoursAndGridRows_$self$$inline_996_JSCompiler_StaticMethods_buildMnRowZippies_$self$$inline_939_JSCompiler_StaticMethods_buildScrollableAllday_$self$$inline_974_JSCompiler_StaticMethods_buildScrollableWeek_$self$$inline_990_JSCompiler_StaticMethods_buildWeekColZippies_$self$$inline_982_JSCompiler_StaticMethods_buildWeekNumbers_$self$$inline_951_aSb$$inline_1007_aSb$$inline_928_aSb$$inline_930_aSb$$inline_946_aSb$$inline_958_aSb$$inline_994$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[$aOffset$$inline_1008_aOffset$$inline_931_aOffset$$inline_959_aSb$$inline_940_aSb$$inline_952_aSb$$inline_966_aSb$$inline_975_aSb$$inline_979_aSb$$inline_983_aSb$$inline_991_aSb$$inline_997$$ + 
            1]);
            $offset$$inline_620_offset$$inline_625$$++;
            break;
          case 82:
            $JSCompiler_StaticMethods_buildWeekGridCols_$$($JSCompiler_StaticMethods_buildBodyInternalMonth_$self$$inline_618_JSCompiler_StaticMethods_buildBodyInternalWeek_$self$$inline_623$$, $aSb$$59$$, $offset$$inline_620_offset$$inline_625$$), $offset$$inline_620_offset$$inline_625$$ += 26
        }
      }
    }
  }
...
$JSCompiler_prototypeAlias$$.$enterDocument$ = function $$JSCompiler_prototypeAlias$$$$enterDocument$$() {
  ...
  "editevent", this.$onEventEdit_$, $JSCompiler_alias_FALSE$$, this), this.$saveDialog_$, $rflect$ui$Dialog$EventType$SELECT$$, this.$onSaveDialogSave_$, $JSCompiler_alias_FALSE$$, this), this.$editDialog_$, "editevent", this.$onEventEdit_$, $JSCompiler_alias_FALSE$$, this), this.$editDialog_$, $rflect$ui$Dialog$EventType$SELECT$$, this.$onEditDialogButtonSelect_$, $JSCompiler_alias_FALSE$$, this);
  this.$timeMarker_$.start()
};
$JSCompiler_prototypeAlias$$.$onClick_$ = function $$JSCompiler_prototypeAlias$$$$onClick_$$($JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$) {
  $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$ = $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$.target;
  var $allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$ = $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$.id, $className$$34_className$$inline_645_endDate$$inline_1030$$ = $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$.className, $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = 
  $JSCompiler_alias_FALSE$$, $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$ = 0;
  $JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$) ? /mn\-zippy\-row\d{1}/.test($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$) ? ($day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$ = /\d{1}/.exec($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$)[0], $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = 
  this.$blockManager_$.$blockPoolMonth$, $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.$blocks$[$day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$].$expanded$ = !$JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.$blocks$[$day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$].$expanded$, 
  $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$), this.$blockManager_$.$blockPoolMonth$.$expanded$ || (this.$blockManager_$.$blockPoolMonth$.scrollTop = 0), $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = 
  $JSCompiler_alias_TRUE$$) : $JSCompiler_StaticMethods_isDaynumLabel_$$(this, $className$$34_className$$inline_645_endDate$$inline_1030$$) ? $JSCompiler_StaticMethods_onDaynumLabelClick_$$(this, $allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$) : $JSCompiler_StaticMethods_isWeeknumLabel_$$(this, $className$$34_className$$inline_645_endDate$$inline_1030$$) && ($day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$ = $rflect$string$getNumericIndex$$($JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$.parentNode.id), 
  ($day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$ = this.$timeManager_$.$daySeries$[7 * $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$]) && $JSCompiler_StaticMethods_switchView_$$(this, $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$, 3)) : $JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$) && (/wk\-zippy\-col\d{1}/.test($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$) ? 
  ($day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$ = /\d{1}/.exec($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$)[0], $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = this.$blockManager_$.$blockPoolWeek$, $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.$blocks$[$day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$].$expanded$ = 
  !$JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.$blocks$[$day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$].$expanded$, $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$), 
  this.$blockManager_$.$blockPoolWeek$.$expanded$ || (this.$blockManager_$.$blockPoolWeek$.scrollLeft = 0), $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = $JSCompiler_alias_TRUE$$) : /daynames\-zippy/.test($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$) ? ($JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = 
  this.$blockManager_$.$blockPoolAllday$, $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.$blocks$[0].$expanded$ = !$JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.$blocks$[0].$expanded$, 
  $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$), $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = $JSCompiler_alias_TRUE$$) : 
  $JSCompiler_StaticMethods_isDaynumLabel_$$(this, $className$$34_className$$inline_645_endDate$$inline_1030$$) && $JSCompiler_StaticMethods_onDaynumLabelClick_$$(this, $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$.parentNode.id));
  if($JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$) {
    this.$updateBeforeRedraw$(), this.$updateByRedraw$()
  }else {
    if((this.$chipWeekRe_$ || (this.$chipWeekRe_$ = $rflect$string$buildClassNameRe$$("event-rect-wk-inner", "event-wk-timelabel"))).test($className$$34_className$$inline_645_endDate$$inline_1030$$) || (this.$chipMonthRe_$ || (this.$chipMonthRe_$ = $rflect$string$buildClassNameRe$$("event-rect-mn-inner"))).test($className$$34_className$$inline_645_endDate$$inline_1030$$)) {
      if("event-wk-timelabel" == $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$.className && ($className$$34_className$$inline_645_endDate$$inline_1030$$ = $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$.parentNode.className), $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$ = ($JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$ = 
      /\d+ev/.exec($className$$34_className$$inline_645_endDate$$inline_1030$$)) ? +$JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$[0].substring(0, $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$[0].length - 2) : NaN, !isNaN($JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$)) {
        $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$ = this.$eventManager_$.$events_$[$JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$];
        this.$editDialog_$.$setVisible$($JSCompiler_alias_TRUE$$);
        this.$editDialog_$.$eventNameLink_$.innerHTML = $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$.summary;
        $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$ = this.$editDialog_$;
        var $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$.$startDate$, $className$$34_className$$inline_645_endDate$$inline_1030$$ = $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$.$endDate$.$clone$(), 
        $formatStringStart$$inline_1034$$, $allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$ = $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$.$allDay$ || 0 == $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.getHours() && 0 == $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.getMinutes() && 
        0 == $className$$34_className$$inline_645_endDate$$inline_1030$$.getHours() && 0 == $className$$34_className$$inline_645_endDate$$inline_1030$$.getMinutes(), $timeFormatString$$inline_1036$$ = " " + $goog$i18n$DateTimeSymbols_en$$.$TIMEFORMATS$[3];
        $allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$ && ($className$$34_className$$inline_645_endDate$$inline_1030$$.add(new $goog$date$Interval$$($goog$date$Interval$DAYS$$, -1)), $timeFormatString$$inline_1036$$ = "");
        $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.getFullYear() != $className$$34_className$$inline_645_endDate$$inline_1030$$.getFullYear() ? ($formatStringStart$$inline_1034$$ = $goog$i18n$DateTimePatterns$$.$MONTH_DAY_ABBR$ + ", yyyy" + $timeFormatString$$inline_1036$$, $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$ = 
        new $goog$i18n$DateTimeFormat$$($formatStringStart$$inline_1034$$ + " -"), $allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$ = new $goog$i18n$DateTimeFormat$$(" " + $formatStringStart$$inline_1034$$), $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = $JSCompiler_StaticMethods_format$$($day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$, 
        $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$) + $JSCompiler_StaticMethods_format$$($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$, $className$$34_className$$inline_645_endDate$$inline_1030$$)) : $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.getMonth() != 
        $className$$34_className$$inline_645_endDate$$inline_1030$$.getMonth() || $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.getMonth() == $className$$34_className$$inline_645_endDate$$inline_1030$$.getMonth() && $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$.getDate() != 
        $className$$34_className$$inline_645_endDate$$inline_1030$$.getDate() ? ($formatStringStart$$inline_1034$$ = $goog$i18n$DateTimePatterns$$.$MONTH_DAY_ABBR$ + $timeFormatString$$inline_1036$$, $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$ = new $goog$i18n$DateTimeFormat$$($formatStringStart$$inline_1034$$ + " -"), $allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$ = new $goog$i18n$DateTimeFormat$$(" " + $formatStringStart$$inline_1034$$ + ", yyyy"), 
        $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = $JSCompiler_StaticMethods_format$$($day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$, $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$) + 
        $JSCompiler_StaticMethods_format$$($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$, $className$$34_className$$inline_645_endDate$$inline_1030$$)) : ($formatStringStart$$inline_1034$$ = "EEEE, " + $goog$i18n$DateTimePatterns$$.$MONTH_DAY_FULL$ + ", yyyy" + ($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$ ? "" : $timeFormatString$$inline_1036$$ + " -"), $day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$ = new $goog$i18n$DateTimeFormat$$($formatStringStart$$inline_1034$$), 
        $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ = $JSCompiler_StaticMethods_format$$($day$$inline_634_event$$inline_647_formatStart$$inline_1032_index$$69_index$$inline_633$$, $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$), 
        $allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$ || ($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$ = new $goog$i18n$DateTimeFormat$$($timeFormatString$$inline_1036$$), $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$ += $JSCompiler_StaticMethods_format$$($allDay$$inline_1035_formatEnd$$inline_1033_id$$12$$, $className$$34_className$$inline_645_endDate$$inline_1030$$)));
        $JSCompiler_temp_const$$832_aEvent$$15_eventId$$inline_646_matches$$inline_1023_target$$54$$.$eventTimeCont_$.innerHTML = $JSCompiler_StaticMethods_toggleBlock$self$$inline_628_JSCompiler_StaticMethods_toggleBlock$self$$inline_636_JSCompiler_StaticMethods_toggleBlock$self$$inline_639_result$$inline_1031_startDate$$inline_1029_zippyClicked$$
      }
    }
  }
};
$JSCompiler_prototypeAlias$$.$onMouseOut_$ = function $$JSCompiler_prototypeAlias$$$$onMouseOut_$$($aEvent$$16_className$$36$$) {
  $aEvent$$16_className$$36$$ = $aEvent$$16_className$$36$$.target.className;
  ($JSCompiler_StaticMethods_isDaynumLabel_$$(this, $aEvent$$16_className$$36$$) || $JSCompiler_StaticMethods_isWeeknumLabel_$$(this, $aEvent$$16_className$$36$$) || $rflect$string$buildClassNameRe$$("zippy").test($aEvent$$16_className$$36$$)) && $JSCompiler_StaticMethods_registerTarget$$(this.$moRegistry_$, $JSCompiler_alias_NULL$$)
};
$JSCompiler_prototypeAlias$$.$onMouseOver_$ = function $$JSCompiler_prototypeAlias$$$$onMouseOver_$$($aEvent$$17_target$$56$$) {
  ...
  var $className$$37$$ = $aEvent$$17_target$$56$$.className;
  $JSCompiler_StaticMethods_isDaynumLabel_$$(this, $className$$37$$) || $JSCompiler_StaticMethods_isWeeknumLabel_$$(this, $className$$37$$) ? $JSCompiler_StaticMethods_registerTarget$$(this.$moRegistry_$, $aEvent$$17_target$$56$$, "label-underlined") : $rflect$string$buildClassNameRe$$("zippy").test($className$$37$$) ? $JSCompiler_StaticMethods_registerTarget$$(this.$moRegistry_$, $aEvent$$17_target$$56$$, "zippy-highlighted") : $JSCompiler_StaticMethods_registerTarget$$(this.$moRegistry_$, $JSCompiler_alias_NULL$$)
};
...
function $JSCompiler_StaticMethods_switchView_$$($JSCompiler_StaticMethods_switchView_$self$$, $aDate$$10_opt_date$$inline_1042$$, $aType$$) {
  $aDate$$10_opt_date$$inline_1042$$ = new $goog$date$DateTime$$($aDate$$10_opt_date$$inline_1042$$.getYear(), $aDate$$10_opt_date$$inline_1042$$.getMonth(), $aDate$$10_opt_date$$inline_1042$$.getDate());
  $JSCompiler_StaticMethods_switchView_$self$$.$timeManager_$.$basis$ = $aDate$$10_opt_date$$inline_1042$$ || new $goog$date$Date$$;
...
$JSCompiler_prototypeAlias$$.$onMouseDown_$ = function $$JSCompiler_prototypeAlias$$$$onMouseDown_$$($aEvent$$18$$) {
  var $className$$38$$ = $aEvent$$18$$.target.className, $preventDefaultIsNeeded$$ = $JSCompiler_alias_FALSE$$;
  $JSCompiler_StaticMethods_isWeekGrid_$$(this, $className$$38$$) ? (this.$selectionMask_$.$init$(2, $aEvent$$18$$), $preventDefaultIsNeeded$$ = $JSCompiler_alias_TRUE$$) : $JSCompiler_StaticMethods_isAlldayGrid_$$(this, $className$$38$$) ? (this.$selectionMask_$.$init$(1, $aEvent$$18$$), $preventDefaultIsNeeded$$ = $JSCompiler_alias_TRUE$$) : $JSCompiler_StaticMethods_isMonthGrid_$$(this, $className$$38$$) && ($JSCompiler_StaticMethods_isDaynumLabel_$$(this, $className$$38$$) || this.$selectionMask_$.$init$(3, 
...
$JSCompiler_prototypeAlias$$.$onSelectStart_$ = function $$JSCompiler_prototypeAlias$$$$onSelectStart_$$($aEvent$$19$$) {
  var $className$$39$$ = $aEvent$$19$$.target.className;
  ($JSCompiler_StaticMethods_isWeekGrid_$$(this, $className$$39$$) || $JSCompiler_StaticMethods_isAlldayGrid_$$(this, $className$$39$$) || $JSCompiler_StaticMethods_isMonthGrid_$$(this, $className$$39$$)) && $aEvent$$19$$.preventDefault()
};
...
$JSCompiler_prototypeAlias$$.$onMouseUp_$ = function $$JSCompiler_prototypeAlias$$$$onMouseUp_$$($aEvent$$21$$) {
  if(this.$selectionMask_$.$initialized_$) {
    ...
    var $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$ = this.$eventManager_$.$eventTransactionHelper$, $uid$$inline_1154$$ = $rflect$cal$events$EventManager$eventUid_$$++;
    $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.$temporaryEvent_$ = new $rflect$cal$events$Event$$($uid$$inline_1154$$);
    $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$ = this.$selectionMask_$.$startDate$;
    this.$eventManager_$.$eventTransactionHelper$.$temporaryEvent_$.$startDate$ = $rflect$date$createDateShim$$($JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getYear(), $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getMonth(), $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getDate(), $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getHours(), $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getMinutes(), 
    $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getSeconds(), $JSCompiler_alias_TRUE$$);
    $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$ = this.$selectionMask_$.$endDate$;
    this.$eventManager_$.$eventTransactionHelper$.$temporaryEvent_$.$endDate$ = $rflect$date$createDateShim$$($JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getYear(), $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getMonth(), $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getDate(), $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getHours(), $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getMinutes(), 
    $JSCompiler_temp_const$$1143_aEndDate$$inline_1050_aStartDate$$inline_1047$$.getSeconds());
...
$JSCompiler_prototypeAlias$$.$onEditDialogButtonSelect_$ = function $$JSCompiler_prototypeAlias$$$$onEditDialogButtonSelect_$$() {
  $_log$$("edit dialog button")
};
$JSCompiler_prototypeAlias$$.$onSaveDialogSave_$ = function $$JSCompiler_prototypeAlias$$$$onSaveDialogSave_$$($JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$) {
  if($JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$.key == this.$saveDialog_$.$buttons_$.$defaultButton_$) {
    ...
    $JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$ = this.$eventManager_$.$eventTransactionHelper$;
    var $JSCompiler_StaticMethods_addEvent$self$$inline_1055$$ = $JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$.$eventManager_$, $aEvent$$inline_1056$$ = $JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$.$temporaryEvent_$, 
    $startDate$$inline_1057$$ = $aEvent$$inline_1056$$.$startDate$, $endDate$$inline_1058$$ = $aEvent$$inline_1056$$.$endDate$, $eventStartMins$$inline_1059$$ = 60 * $startDate$$inline_1057$$.getHours() + $startDate$$inline_1057$$.getMinutes(), $eventEndMins$$inline_1060$$ = 60 * $endDate$$inline_1058$$.getHours() + $endDate$$inline_1058$$.getMinutes(), $currentDate$$inline_1061_weekOfYear$$inline_1171$$ = $startDate$$inline_1057$$.$clone$(), $hasNext$$inline_1062$$ = $JSCompiler_alias_TRUE$$, $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$ = 
    $JSCompiler_alias_FALSE$$, $JSCompiler_StaticMethods_putWeekChip_$self$$inline_1166_hasNextWeek$$inline_1064$$ = $JSCompiler_alias_FALSE$$, $aChip$$inline_1167_hasPrevWeek$$inline_1065$$ = $JSCompiler_alias_FALSE$$, $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$ = $JSCompiler_alias_FALSE$$, $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$ = 0, $aEventId$$inline_1158_dayChipEndMins$$inline_1068$$ = 0, $total$$inline_1071$$ = 
    $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$ = $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$ = 0, $isAllDay$$inline_1072$$ = $aEvent$$inline_1056$$.$allDay$, $tomorrow$$inline_1073$$;
    if($isAllDay$$inline_1072$$) {
      var $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$ = []
    }
    for($JSCompiler_StaticMethods_addEvent$self$$inline_1055$$.$events_$[$aEvent$$inline_1056$$.id] = $aEvent$$inline_1056$$;$hasNext$$inline_1062$$;) {
      $tomorrow$$inline_1073$$ = $rflect$date$getTomorrow$$($currentDate$$inline_1061_weekOfYear$$inline_1171$$);
      $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$ = !$currentDate$$inline_1061_weekOfYear$$inline_1171$$.$equals$($startDate$$inline_1057$$, 7);
      $hasNext$$inline_1062$$ = 0 > $JSCompiler_StaticMethods_compare$$($tomorrow$$inline_1073$$, $endDate$$inline_1058$$, 7) || $tomorrow$$inline_1073$$.$equals$($endDate$$inline_1058$$, 7) && 0 != $eventEndMins$$inline_1060$$;
      $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$ = !$hasNext$$inline_1062$$ || 6 == $JSCompiler_StaticMethods_getWeekday$$($currentDate$$inline_1061_weekOfYear$$inline_1171$$);
      $aChip$$inline_1167_hasPrevWeek$$inline_1065$$ = !$currentDate$$inline_1061_weekOfYear$$inline_1171$$.$equals$($startDate$$inline_1057$$, 128);
      $JSCompiler_StaticMethods_putWeekChip_$self$$inline_1166_hasNextWeek$$inline_1064$$ = $hasNext$$inline_1062$$ && 0 == $JSCompiler_StaticMethods_getWeekday$$($tomorrow$$inline_1073$$);
      if($isAllDay$$inline_1072$$) {
        if($allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$[$total$$inline_1071$$++] = [$currentDate$$inline_1061_weekOfYear$$inline_1171$$.getYear(), $currentDate$$inline_1061_weekOfYear$$inline_1171$$.$getDayOfYear$()], !$hasNext$$inline_1062$$) {
          for(var $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$ = $JSCompiler_StaticMethods_addEvent$self$$inline_1055$$, $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$ = $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$, $aEventId$$inline_1158_dayChipEndMins$$inline_1068$$ = $aEvent$$inline_1056$$.id, $counter$$inline_1159$$ = 0, $length$$inline_1160$$ = 
          $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$.length;$counter$$inline_1159$$ < $length$$inline_1160$$;$counter$$inline_1159$$++) {
            $JSCompiler_StaticMethods_putChip_$$(new $rflect$cal$events$Chip$$($aEventId$$inline_1158_dayChipEndMins$$inline_1068$$, 0, $length$$inline_1160$$ - $counter$$inline_1159$$, 0 != $counter$$inline_1159$$, $JSCompiler_alias_FALSE$$), $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$[$counter$$inline_1159$$][0], $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$[$counter$$inline_1159$$][1], $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$.$allDayChipsByDay_$, 
            $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$.$tracksAllDayChipsByDay_$)
          }
        }
      }else {
        $aEventId$$inline_1158_dayChipEndMins$$inline_1068$$ = $hasNext$$inline_1062$$ ? 1440 : 0 == $eventEndMins$$inline_1060$$ ? 1440 : $eventEndMins$$inline_1060$$, $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$ = $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$ ? 0 : $eventStartMins$$inline_1059$$, 20 > $aEventId$$inline_1158_dayChipEndMins$$inline_1068$$ - $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$ && 
        ($aEventId$$inline_1158_dayChipEndMins$$inline_1068$$ = $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$ + 20), $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$ = new $rflect$cal$events$Chip$$($aEvent$$inline_1056$$.id, $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$, $aEventId$$inline_1158_dayChipEndMins$$inline_1068$$, $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$, 
        $hasNext$$inline_1062$$), $JSCompiler_StaticMethods_putChip_$$($JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$, $currentDate$$inline_1061_weekOfYear$$inline_1171$$.getYear(), $currentDate$$inline_1061_weekOfYear$$inline_1171$$.$getDayOfYear$(), $JSCompiler_StaticMethods_addEvent$self$$inline_1055$$.$chipsByDay_$, $JSCompiler_StaticMethods_addEvent$self$$inline_1055$$.$tracksChipsByDay_$)
      }
      $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$ && ($JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$ = $JSCompiler_StaticMethods_putWeekChip_$self$$inline_1166_hasNextWeek$$inline_1064$$ ? 7 : $JSCompiler_StaticMethods_getWeekday$$($currentDate$$inline_1061_weekOfYear$$inline_1171$$) + 1, $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$ = 
      $aChip$$inline_1167_hasPrevWeek$$inline_1065$$ ? 0 : $JSCompiler_StaticMethods_getWeekday$$($startDate$$inline_1057$$), $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$ = new $rflect$cal$events$Chip$$($aEvent$$inline_1056$$.id, $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$, $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$, 
      $aChip$$inline_1167_hasPrevWeek$$inline_1065$$, $JSCompiler_StaticMethods_putWeekChip_$self$$inline_1166_hasNextWeek$$inline_1064$$), $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$ = $currentDate$$inline_1061_weekOfYear$$inline_1171$$.$firstWeekCutOffDay_$, $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$ = ($cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$ - 
      ($currentDate$$inline_1061_weekOfYear$$inline_1171$$.getDay() + 6) % 7 + 7) % 7, $JSCompiler_StaticMethods_putWeekChip_$self$$inline_1166_hasNextWeek$$inline_1064$$ = $JSCompiler_StaticMethods_addEvent$self$$inline_1055$$, $aChip$$inline_1167_hasPrevWeek$$inline_1065$$ = $JSCompiler_StaticMethods_putAllDayChips_$self$$inline_1156_chip$$inline_1074_hasPrev$$inline_1063_weekChipEndMins$$inline_1070$$, $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$ = 
      $currentDate$$inline_1061_weekOfYear$$inline_1171$$.getYear() + (0 < $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$ - ($currentDate$$inline_1061_weekOfYear$$inline_1171$$.getDay() + 6) % 7 && $currentDate$$inline_1061_weekOfYear$$inline_1171$$.$getDayOfYear$() + $aIndexes$$inline_1157_cutoffAndCurrentDiffAbs$$inline_1077_dayChipStartMins$$inline_1067$$ > ($goog$date$isLeapYear$$($currentDate$$inline_1061_weekOfYear$$inline_1171$$.getFullYear()) ? 
      366 : 365) ? 1 : 0), $currentDate$$inline_1061_weekOfYear$$inline_1171$$ = $currentDate$$inline_1061_weekOfYear$$inline_1171$$.$getWeekNumber$(), $JSCompiler_StaticMethods_putChip_$$($aChip$$inline_1167_hasPrevWeek$$inline_1065$$, $cutoff$$inline_1076_isWeekChip$$inline_1066_weekChipStartMins$$inline_1069_year$$inline_1170$$, $currentDate$$inline_1061_weekOfYear$$inline_1171$$, $JSCompiler_StaticMethods_putWeekChip_$self$$inline_1166_hasNextWeek$$inline_1064$$.$chipsByWeek_$, $JSCompiler_StaticMethods_putWeekChip_$self$$inline_1166_hasNextWeek$$inline_1064$$.$tracksChipsByWeek_$));
      $currentDate$$inline_1061_weekOfYear$$inline_1171$$ = $tomorrow$$inline_1073$$
    }
    $JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$.$temporaryEvent_$ = $JSCompiler_alias_NULL$$;
    this.$eventManager_$.$run$();
    $JSCompiler_StaticMethods_updateBlockManager$$(this);
    this.$selectionMask_$.$isWeek$() && ($allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$ = new $goog$string$StringBuffer$$, $JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$ = this.$mainPaneBuilder_$, $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[81]), 
    $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[82]), $JSCompiler_StaticMethods_buildWeekGridCols_$$($JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$, $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$, 
    82), this.$getDomHelper$().$getElement$("grid-table-wk").innerHTML = $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.toString());
    1 == this.$selectionMask_$.$configuration_$ && ($allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$ = new $goog$string$StringBuffer$$, $JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$ = this.$mainPaneBuilder_$, $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[26]), 
    $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_WEEK_$$[27]), $JSCompiler_StaticMethods_buildWeekGridAdCols_$$($JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$, $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$, 
    27), this.$getDomHelper$().$getElement$("alldayevents-grid").innerHTML = $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.toString());
    3 == this.$selectionMask_$.$configuration_$ && ($allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$ = new $goog$string$StringBuffer$$, $JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$ = this.$mainPaneBuilder_$, $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[48]), 
    $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[49]), $JSCompiler_StaticMethods_buildAllDayGrid$self$$inline_1082_JSCompiler_StaticMethods_buildMonthGrid$self$$inline_1085_JSCompiler_StaticMethods_buildWeekGrid$self$$inline_1079_JSCompiler_StaticMethods_endEventCreation$self$$inline_658_aEvent$$24$$.$buildMonthGridRows_$($allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$, 49), $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.append($rflect$cal$MainPaneBuilder$HTML_PARTS_MONTH_$$[81]), 
    this.$getDomHelper$().$getElement$("grid-table-mn").innerHTML = $allDayIndexes$$inline_1075_sb$$inline_661_sb$$inline_664_sb$$inline_667$$.toString())
  }
};
$JSCompiler_prototypeAlias$$.$onMainPaneScrollableScroll_$ = function $$JSCompiler_prototypeAlias$$$$onMainPaneScrollableScroll_$$($aEvent$$25_scrollable$$) {
  $aEvent$$25_scrollable$$ = $aEvent$$25_scrollable$$.target;
  var $scrollPos$$ = 0;
  $JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$) ? ($scrollPos$$ = $aEvent$$25_scrollable$$.scrollLeft, this.$blockManager_$.$blockPoolWeek$.scrollLeft = $scrollPos$$, this.$dom_$.$getElement$("weekmode-zippies-table").style.left = "-" + $scrollPos$$ + "px", this.$dom_$.$getElement$("weekmode-daynames-table").style.left = "-" + $scrollPos$$ + "px", this.$dom_$.$getElement$("main-pane-header-scrollable").scrollLeft = $scrollPos$$) : $JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$) && 
  ($scrollPos$$ = $aEvent$$25_scrollable$$.scrollTop, this.$blockManager_$.$blockPoolMonth$.scrollTop = $scrollPos$$, this.$dom_$.$getElement$("monthmode-zippies-table").style.top = "-" + $scrollPos$$ + "px")
};
$JSCompiler_prototypeAlias$$.$disposeInternal$ = function $$JSCompiler_prototypeAlias$$$$disposeInternal$$() {
...
function $JSCompiler_StaticMethods_updateEventMap$$($JSCompiler_StaticMethods_updateEventMap$self$$, $aChips$$2$$, $opt_createArrays$$, $opt_arraysLength$$) {
  for(var $counter$$25$$ = 0;$counter$$25$$ < $JSCompiler_StaticMethods_updateEventMap$self$$.$blocksNumber_$;$counter$$25$$++) {
    var $JSCompiler_StaticMethods_computeEventMap$self$$inline_671_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_697$$ = $JSCompiler_StaticMethods_updateEventMap$self$$.$blocks$[$counter$$25$$], $aChips$$inline_672_blobs$$inline_699$$ = $aChips$$2$$[$counter$$25$$], $i$$inline_673_sparseArrays$$inline_700$$ = 0, $aDaysNumber$$inline_698_blobCounter$$inline_702_length$$inline_674$$ = 0, $blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$ = [], $blob$$inline_704_currentBlob$$inline_676$$ = 
    [], $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = 0, $blobEntryCounter$$inline_705_maxCol$$inline_678$$ = 0;
    $aChips$$inline_672_blobs$$inline_699$$.sort($rflect$cal$blocks$Block$sort$$);
    for(var $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ = $JSCompiler_alias_VOID$$, $chip$$inline_708_colEndArray$$inline_680$$ = [], $i$$inline_673_sparseArrays$$inline_700$$ = 0, $aDaysNumber$$inline_698_blobCounter$$inline_702_length$$inline_674$$ = $aChips$$inline_672_blobs$$inline_699$$.length;$i$$inline_673_sparseArrays$$inline_700$$ < $aDaysNumber$$inline_698_blobCounter$$inline_702_length$$inline_674$$;++$i$$inline_673_sparseArrays$$inline_700$$) {
      var $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$ = $aChips$$inline_672_blobs$$inline_699$$[$i$$inline_673_sparseArrays$$inline_700$$], $itemStart$$inline_682_start$$inline_710$$ = $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$.start, $chipCounter$$inline_711_itemEnd$$inline_683$$ = $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$.end;
      $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ || ($blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ = $chipCounter$$inline_711_itemEnd$$inline_683$$);
      $blob$$inline_704_currentBlob$$inline_676$$.length && ($blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ && $itemStart$$inline_682_start$$inline_710$$ >= $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$) && ($blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$.push({blob:$blob$$inline_704_currentBlob$$inline_676$$, $totalCols$:$chip$$inline_708_colEndArray$$inline_680$$.length}), $blob$$inline_704_currentBlob$$inline_676$$ = [], $chip$$inline_708_colEndArray$$inline_680$$ = 
      []);
      for(var $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = $JSCompiler_alias_FALSE$$, $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ = 0, $colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$ = $chip$$inline_708_colEndArray$$inline_680$$.length;$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ < $colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$;++$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$) {
        if($chip$$inline_708_colEndArray$$inline_680$$[$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$].end <= $itemStart$$inline_682_start$$inline_710$$) {
          $chip$$inline_708_colEndArray$$inline_680$$[$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$] = $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$;
          for($chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = Number($end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$) + 1;$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ < $chip$$inline_708_colEndArray$$inline_680$$.length && !($chip$$inline_708_colEndArray$$inline_680$$[$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$].end > 
          $itemStart$$inline_682_start$$inline_710$$);) {
            $chip$$inline_708_colEndArray$$inline_680$$[$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$] = $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$, $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$++
          }
          $blob$$inline_704_currentBlob$$inline_676$$.push({$chip$:$blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$, $startCol$:$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$, colSpan:$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ - $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$});
          $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ > $blobEntryCounter$$inline_705_maxCol$$inline_678$$ && ($blobEntryCounter$$inline_705_maxCol$$inline_678$$ = $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$);
          $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ && $chipCounter$$inline_711_itemEnd$$inline_683$$ > $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ && ($blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ = $chipCounter$$inline_711_itemEnd$$inline_683$$);
          $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = $JSCompiler_alias_TRUE$$;
          break
        }
      }
      if(!$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$) {
        $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ = 1;
        for($colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$ = $chip$$inline_708_colEndArray$$inline_680$$.length;$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ < $colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$;++$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$) {
          if($goog$getUid$$($chip$$inline_708_colEndArray$$inline_680$$[$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$]) == $goog$getUid$$($chip$$inline_708_colEndArray$$inline_680$$[$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ - 1])) {
            for(var $kk$$inline_689_mm$$inline_694$$ = 1, $colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$ = $blob$$inline_704_currentBlob$$inline_676$$.length;$kk$$inline_689_mm$$inline_694$$ < $colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$;++$kk$$inline_689_mm$$inline_694$$) {
              if($goog$getUid$$($blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].$chip$) == $goog$getUid$$($chip$$inline_708_colEndArray$$inline_680$$[$end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$])) {
                $colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$ = $blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].colSpan;
                $blob$$inline_704_currentBlob$$inline_676$$.push({$chip$:$blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$, $startCol$:$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = Number($blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].$startCol$) + 1, colSpan:$colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$ - 1});
                $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ > $blobEntryCounter$$inline_705_maxCol$$inline_678$$ && ($blobEntryCounter$$inline_705_maxCol$$inline_678$$ = $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$);
                for($chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$;$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ < $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ + $colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$ - 
                1;$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$++) {
                  $chip$$inline_708_colEndArray$$inline_680$$[$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$] = $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$
                }
                $blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$] = {$chip$:$blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].$chip$, $startCol$:$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = $blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].$startCol$, colSpan:1};
                $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ > $blobEntryCounter$$inline_705_maxCol$$inline_678$$ && ($blobEntryCounter$$inline_705_maxCol$$inline_678$$ = $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$);
                $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ && $chipCounter$$inline_711_itemEnd$$inline_683$$ > $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ && ($blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ = $chipCounter$$inline_711_itemEnd$$inline_683$$);
                break
              }
        ...
        if(!$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$) {
          $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ = $chip$$inline_708_colEndArray$$inline_680$$.length;
          $kk$$inline_689_mm$$inline_694$$ = 1;
          for($colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$ = $blob$$inline_704_currentBlob$$inline_676$$.length;$kk$$inline_689_mm$$inline_694$$ < $colEndArrayLength$$inline_686_currentBlobLength$$inline_690_spanOfShrunkItem$$inline_691$$;++$kk$$inline_689_mm$$inline_694$$) {
            $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = $blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].$chip$.end, $blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].$startCol$ + $blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].colSpan == $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ && $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ <= 
            $itemStart$$inline_682_start$$inline_710$$ && ($blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$] = {$chip$:$blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].$chip$, $startCol$:$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = $blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].$startCol$, colSpan:$blob$$inline_704_currentBlob$$inline_676$$[$kk$$inline_689_mm$$inline_694$$].colSpan + 
            1}, $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ > $blobEntryCounter$$inline_705_maxCol$$inline_678$$ && ($blobEntryCounter$$inline_705_maxCol$$inline_678$$ = $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$))
          }
          $blob$$inline_704_currentBlob$$inline_676$$.push({$chip$:$blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$, $startCol$:$chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = $chip$$inline_708_colEndArray$$inline_680$$.length, colSpan:1});
          $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ > $blobEntryCounter$$inline_705_maxCol$$inline_678$$ && ($blobEntryCounter$$inline_705_maxCol$$inline_678$$ = $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$);
          $chip$$inline_708_colEndArray$$inline_680$$.push($blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$);
          $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ && $chipCounter$$inline_711_itemEnd$$inline_683$$ > $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ && ($blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ = $chipCounter$$inline_711_itemEnd$$inline_683$$)
        }
      }
    }
    $blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$.push({blob:$blob$$inline_704_currentBlob$$inline_676$$, $totalCols$:$chip$$inline_708_colEndArray$$inline_680$$.length});
    $JSCompiler_StaticMethods_computeEventMap$self$$inline_671_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_697$$.$blobs$ = $blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$;
    if($opt_createArrays$$) {
      $JSCompiler_StaticMethods_computeEventMap$self$$inline_671_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_697$$ = $JSCompiler_StaticMethods_updateEventMap$self$$.$blocks$[$counter$$25$$];
      $aDaysNumber$$inline_698_blobCounter$$inline_702_length$$inline_674$$ = $opt_arraysLength$$ || 0;
      $aChips$$inline_672_blobs$$inline_699$$ = $JSCompiler_StaticMethods_computeEventMap$self$$inline_671_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_697$$.$blobs$;
      $i$$inline_673_sparseArrays$$inline_700$$ = [];
      for($blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$ = 0;$blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$ < $aDaysNumber$$inline_698_blobCounter$$inline_702_length$$inline_674$$;$blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$++) {
        $i$$inline_673_sparseArrays$$inline_700$$[$blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$] = []
      }
      $aDaysNumber$$inline_698_blobCounter$$inline_702_length$$inline_674$$ = 0;
      for($blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$ = $aChips$$inline_672_blobs$$inline_699$$.length;$aDaysNumber$$inline_698_blobCounter$$inline_702_length$$inline_674$$ < $blobLength$$inline_703_blobs$$inline_675_counter$$inline_701$$;$aDaysNumber$$inline_698_blobCounter$$inline_702_length$$inline_674$$++) {
        $blob$$inline_704_currentBlob$$inline_676$$ = $aChips$$inline_672_blobs$$inline_699$$[$aDaysNumber$$inline_698_blobCounter$$inline_702_length$$inline_674$$].blob;
        $blobEntryCounter$$inline_705_maxCol$$inline_678$$ = 0;
        for($blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$ = $blob$$inline_704_currentBlob$$inline_676$$.length;$blobEntryCounter$$inline_705_maxCol$$inline_678$$ < $blobEntriesLength$$inline_706_latestItemEnd$$inline_679$$;$blobEntryCounter$$inline_705_maxCol$$inline_678$$++) {
          $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$ = $blob$$inline_704_currentBlob$$inline_676$$[$blobEntryCounter$$inline_705_maxCol$$inline_678$$];
          $chip$$inline_708_colEndArray$$inline_680$$ = $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$.$chip$;
          $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$ = $blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$.$startCol$;
          $chipCounter$$inline_711_itemEnd$$inline_683$$ = $itemStart$$inline_682_start$$inline_710$$ = $chip$$inline_708_colEndArray$$inline_680$$.start;
          for($end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ = $chip$$inline_708_colEndArray$$inline_680$$.end;$chipCounter$$inline_711_itemEnd$$inline_683$$ < $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$;$chipCounter$$inline_711_itemEnd$$inline_683$$++) {
            $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$ = $chip$$inline_708_colEndArray$$inline_680$$.$clone$(), $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$.$startIsCut$ = $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$.$endIsCut$ = $chipCounter$$inline_711_itemEnd$$inline_683$$ > 
            $itemStart$$inline_682_start$$inline_710$$ && $chipCounter$$inline_711_itemEnd$$inline_683$$ < $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ - 1, $chipCounter$$inline_711_itemEnd$$inline_683$$ == $itemStart$$inline_682_start$$inline_710$$ && 1 < $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ - $itemStart$$inline_682_start$$inline_710$$ && ($chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$.$endIsCut$ = 
            $JSCompiler_alias_TRUE$$), $chipCounter$$inline_711_itemEnd$$inline_683$$ == $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ - 1 && 1 < $end$$inline_712_ii$$inline_685_jj$$inline_688_lastColNum$$inline_693$$ - $itemStart$$inline_682_start$$inline_710$$ && ($chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$.$startIsCut$ = $JSCompiler_alias_TRUE$$), $i$$inline_673_sparseArrays$$inline_700$$[$chipCounter$$inline_711_itemEnd$$inline_683$$][$blobEntry$$inline_707_chip$$inline_681_startCol$$inline_709$$] = 
            $chipClone$$inline_713_lastCol$$inline_687_ll$$inline_692_mmEnd$$inline_695_placedItem$$inline_684_startCol$$inline_677$$
          }
        }
      }
      $JSCompiler_StaticMethods_computeEventMap$self$$inline_671_JSCompiler_StaticMethods_createSparseArraysFromBlobs$self$$inline_697$$.$sparseArrays$ = $i$$inline_673_sparseArrays$$inline_700$$
    }
...
;function $rflect$cal$blocks$BlockManager$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_715_aViewManager$$13$$, $aTimeManager$$10$$, $aEventManager$$8$$) {
  this.$viewManager_$ = $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_715_aViewManager$$13$$;
  ...
  $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_715_aViewManager$$13$$ = this.$blockPoolAllday$;
  $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_715_aViewManager$$13$$.$blocksNumber_$ = 1;
  $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_715_aViewManager$$13$$)
}
$rflect$cal$blocks$BlockManager$$.prototype.update = function $$rflect$cal$blocks$BlockManager$$$$update$() {
  if($JSCompiler_StaticMethods_isInWeekMode$$(this.$viewManager_$)) {
    var $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_718_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_721_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_724$$ = this.$blockPoolWeek$;
    $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_718_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_721_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_724$$.$blocksNumber_$ = this.$timeManager_$.$daySeries$.length;
    $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_718_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_721_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_724$$);
    $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_718_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_721_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_724$$ = this.$blockPoolAllday$;
    $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_718_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_721_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_724$$.$blocksNumber_$ = 1;
    $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_718_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_721_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_724$$);
    ...
    $JSCompiler_StaticMethods_isInMonthMode$$(this.$viewManager_$) && ($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_718_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_721_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_724$$ = this.$blockPoolMonth$, $JSCompiler_StaticMethods_setBlocksNumber$self$$inline_718_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_721_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_724$$.$blocksNumber_$ = this.$timeManager_$.$daySeries$.length / 
    7, $JSCompiler_StaticMethods_updateExpandState_$$($JSCompiler_StaticMethods_setBlocksNumber$self$$inline_718_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_721_JSCompiler_StaticMethods_setBlocksNumber$self$$inline_724$$), $JSCompiler_StaticMethods_updateCollapsedBlocks$$(this.$blockPoolMonth$), $JSCompiler_StaticMethods_updateEventMap$$(this.$blockPoolMonth$, this.$eventManager_$.$weekChips$), $JSCompiler_StaticMethods_updateExpandedBlocks$$(this.$blockPoolMonth$))
  }
};
...
function $rflect$cal$ContainerSizeMonitor$$($aViewManager$$14_outerDiv$$inline_729$$, $aContainer$$2_innerDiv$$inline_730_width$$inline_731$$, $opt_window$$6$$) {
  $goog$dom$ViewportSizeMonitor$$.call(this, $opt_window$$6$$);
  this.$container_$ = $aContainer$$2_innerDiv$$inline_730_width$$inline_731$$;
  this.$containerSize_$ = new $goog$math$Size$$(this.$container_$.clientWidth, this.$container_$.clientHeight);
  $aViewManager$$14_outerDiv$$inline_729$$ = document.createElement("div");
  $aViewManager$$14_outerDiv$$inline_729$$.style.cssText = "overflow:auto;position:absolute;top:0;width:100px;height:100px";
  $aContainer$$2_innerDiv$$inline_730_width$$inline_731$$ = document.createElement("div");
  $goog$style$setSize$$($aContainer$$2_innerDiv$$inline_730_width$$inline_731$$, "200px", "200px");
  $aViewManager$$14_outerDiv$$inline_729$$.appendChild($aContainer$$2_innerDiv$$inline_730_width$$inline_731$$);
  document.body.appendChild($aViewManager$$14_outerDiv$$inline_729$$);
  $aContainer$$2_innerDiv$$inline_730_width$$inline_731$$ = $aViewManager$$14_outerDiv$$inline_729$$.offsetWidth - $aViewManager$$14_outerDiv$$inline_729$$.clientWidth;
  $goog$dom$removeNode$$($aViewManager$$14_outerDiv$$inline_729$$);
  this.$scrollbarWidth$ = $aContainer$$2_innerDiv$$inline_730_width$$inline_731$$
}
...
$JSCompiler_prototypeAlias$$.$checkForSizeChange_$ = function $$JSCompiler_prototypeAlias$$$$checkForSizeChange_$$($aNotActualResize$$) {
  var $containerSize$$inline_734_viewportSize$$ = $goog$dom$getViewportSize_$$(this.$window_$ || window);
  $goog$math$Size$equals$$($containerSize$$inline_734_viewportSize$$, this.$size_$) || (this.$size_$ = $containerSize$$inline_734_viewportSize$$, $containerSize$$inline_734_viewportSize$$ = new $goog$math$Size$$(this.$container_$.clientWidth, this.$container_$.clientHeight), $goog$math$Size$equals$$($containerSize$$inline_734_viewportSize$$, this.$containerSize_$) || (this.$containerSize_$ = $containerSize$$inline_734_viewportSize$$, this.dispatchEvent("resize")), this.$windowSizePollInterval_$ == 
...
$JSCompiler_prototypeAlias$$.$onMainBodyAction_$ = function $$JSCompiler_prototypeAlias$$$$onMainBodyAction_$$($aEvent$$26$$) {
  switch($JSCompiler_StaticMethods_getId$$($aEvent$$26$$.target)) {
    case "nb1":
...
$JSCompiler_prototypeAlias$$.$onDateSelect_$ = function $$JSCompiler_prototypeAlias$$$$onDateSelect_$$($aEvent$$27$$) {
  $_log$$("index is in mask", $aEvent$$27$$.$isInMask$);
  $aEvent$$27$$.$isInMask$ || ($JSCompiler_StaticMethods_shiftToPoint$$(this.$timeManager$, $aEvent$$27$$.$date$), this.$mainBody_$.$miniCal$.$updateBeforeRedraw$(), this.$mainBody_$.$miniCal$.$updateByRedraw$(), this.$mainBody_$.$updateBeforeRedraw$(3, 4, 2), this.$mainBody_$.$updateByRedraw$(3, 4, 2))
};
$JSCompiler_prototypeAlias$$.$onDateDrag_$ = function $$JSCompiler_prototypeAlias$$$$onDateDrag_$$($aEvent$$28$$) {
  this.$timeManager$.$basis$ = 5 == $aEvent$$28$$.$selectionConfiguration$ ? $aEvent$$28$$.$firstDayInMonth$ || new $goog$date$Date$$ : $aEvent$$28$$.$startDate$ || new $goog$date$Date$$;
  this.$timeManager$.$daysNumber$ = $aEvent$$28$$.duration;
  $JSCompiler_StaticMethods_showView$$(this, $aEvent$$28$$.$selectionConfiguration$, $aEvent$$28$$.target)
};
function $JSCompiler_StaticMethods_showView$$($JSCompiler_StaticMethods_showView$self$$, $JSCompiler_StaticMethods_preRender$self$$inline_748_aType$$1$$, $container$$inline_750_opt_caller$$) {
  var $calledByMiniCal$$ = $container$$inline_750_opt_caller$$ == $JSCompiler_StaticMethods_showView$self$$.$mainBody_$.$miniCal$;
  $JSCompiler_StaticMethods_showView$self$$.$currentView$ == $JSCompiler_StaticMethods_preRender$self$$inline_748_aType$$1$$ && $container$$inline_750_opt_caller$$ == $JSCompiler_alias_VOID$$ && !$JSCompiler_StaticMethods_showView$self$$.$isOnStartup_$ || ($JSCompiler_StaticMethods_showView$self$$.$currentView$ = $JSCompiler_StaticMethods_preRender$self$$inline_748_aType$$1$$, $JSCompiler_StaticMethods_showView$self$$.$timeManager$.$configuration$ = $JSCompiler_StaticMethods_showView$self$$.$currentView$, 
  $JSCompiler_StaticMethods_showView$self$$.$timeManager$.$run$(), $JSCompiler_StaticMethods_showView$self$$.$eventManager_$.$run$(), $JSCompiler_StaticMethods_showView$self$$.$isOnStartup_$ ? ($JSCompiler_StaticMethods_preRender$self$$inline_748_aType$$1$$ = $JSCompiler_StaticMethods_showView$self$$.$mainBody_$, $container$$inline_750_opt_caller$$ = $JSCompiler_StaticMethods_preRender$self$$inline_748_aType$$1$$.$dom_$.$document_$.body, $container$$inline_750_opt_caller$$.innerHTML = $rflect$cal$MainBody$HTML_PARTS_$$[0] + 
  $rflect$cal$MainBody$HTML_PARTS_$$[1] + $rflect$cal$MainBody$HTML_PARTS_$$[20] + $rflect$cal$MainBody$HTML_PARTS_$$[21], $JSCompiler_StaticMethods_preRender$self$$inline_748_aType$$1$$.$containerSizeMonitor_$.$checkForSizeChange_$($JSCompiler_alias_TRUE$$), $container$$inline_750_opt_caller$$.innerHTML = "", $JSCompiler_StaticMethods_showView$self$$.$mainBody_$.$updateBeforeRedraw$(), $JSCompiler_StaticMethods_render_$$($JSCompiler_StaticMethods_showView$self$$.$mainBody_$), $JSCompiler_StaticMethods_listen$$($JSCompiler_StaticMethods_showView$self$$, 
...
function $goog$debug$Logger$Level$getPredefinedLevel$$($name$$67$$) {
  if(!$goog$debug$Logger$Level$predefinedLevelsCache_$$) {
    ...
    for(var $i$$inline_756$$ = 0, $level$$inline_757$$;$level$$inline_757$$ = $goog$debug$Logger$Level$PREDEFINED_LEVELS$$[$i$$inline_756$$];$i$$inline_756$$++) {
      $goog$debug$Logger$Level$predefinedLevelsCache_$$[$level$$inline_757$$.value] = $level$$inline_757$$, $goog$debug$Logger$Level$predefinedLevelsCache_$$[$level$$inline_757$$.name] = $level$$inline_757$$
    }
  }
...
$JSCompiler_prototypeAlias$$.log = function $$JSCompiler_prototypeAlias$$$log$($level$$15_logRecord$$inline_760$$, $msg$$5_msg$$inline_1107_target$$inline_761$$, $JSCompiler_StaticMethods_callPublish_$self$$inline_1109_opt_exception$$) {
  if($level$$15_logRecord$$inline_760$$.value >= $JSCompiler_StaticMethods_getEffectiveLevel$$(this).value) {
    $level$$15_logRecord$$inline_760$$ = this.$getLogRecord$($level$$15_logRecord$$inline_760$$, $msg$$5_msg$$inline_1107_target$$inline_761$$, $JSCompiler_StaticMethods_callPublish_$self$$inline_1109_opt_exception$$);
    $msg$$5_msg$$inline_1107_target$$inline_761$$ = "log:" + $level$$15_logRecord$$inline_760$$.$msg_$;
    $goog$global$$.console && ($goog$global$$.console.timeStamp ? $goog$global$$.console.timeStamp($msg$$5_msg$$inline_1107_target$$inline_761$$) : $goog$global$$.console.markTimeline && $goog$global$$.console.markTimeline($msg$$5_msg$$inline_1107_target$$inline_761$$));
    $goog$global$$.msWriteProfilerMark && $goog$global$$.msWriteProfilerMark($msg$$5_msg$$inline_1107_target$$inline_761$$);
    for($msg$$5_msg$$inline_1107_target$$inline_761$$ = this;$msg$$5_msg$$inline_1107_target$$inline_761$$;) {
      $JSCompiler_StaticMethods_callPublish_$self$$inline_1109_opt_exception$$ = $msg$$5_msg$$inline_1107_target$$inline_761$$;
      var $logRecord$$inline_1110$$ = $level$$15_logRecord$$inline_760$$;
      if($JSCompiler_StaticMethods_callPublish_$self$$inline_1109_opt_exception$$.$handlers_$) {
        for(var $i$$inline_1111$$ = 0, $handler$$inline_1112$$ = $JSCompiler_alias_VOID$$;$handler$$inline_1112$$ = $JSCompiler_StaticMethods_callPublish_$self$$inline_1109_opt_exception$$.$handlers_$[$i$$inline_1111$$];$i$$inline_1111$$++) {
          $handler$$inline_1112$$($logRecord$$inline_1110$$)
        }
      }
      $msg$$5_msg$$inline_1107_target$$inline_761$$ = $msg$$5_msg$$inline_1107_target$$inline_761$$.getParent()
    }
  }
};
$JSCompiler_prototypeAlias$$.$getLogRecord$ = function $$JSCompiler_prototypeAlias$$$$getLogRecord$$($level$$16$$, $msg$$6$$, $opt_exception$$1$$) {
  ...
  if($opt_exception$$1$$) {
    ...
    var $opt_fn$$inline_775$$ = arguments.callee.caller;
    try {
      var $e$$inline_776$$;
      var $href$$inline_1115$$ = $goog$getObjectByName$$("window.location.href");
      if($goog$isString$$($opt_exception$$1$$)) {
        $e$$inline_776$$ = {message:$opt_exception$$1$$, name:"Unknown error", lineNumber:"Not available", fileName:$href$$inline_1115$$, stack:"Not available"}
      }else {
        var $lineNumber$$inline_1116$$, $fileName$$inline_1117$$, $threwError$$inline_1118$$ = $JSCompiler_alias_FALSE$$;
        try {
          $lineNumber$$inline_1116$$ = $opt_exception$$1$$.lineNumber || $opt_exception$$1$$.$line$ || "Not available"
        }catch($e$$inline_1119$$) {
          $lineNumber$$inline_1116$$ = "Not available", $threwError$$inline_1118$$ = $JSCompiler_alias_TRUE$$
        }
        try {
          $fileName$$inline_1117$$ = $opt_exception$$1$$.fileName || $opt_exception$$1$$.filename || $opt_exception$$1$$.sourceURL || $goog$global$$.$googDebugFname || $href$$inline_1115$$
        }catch($e$$inline_1120$$) {
          $fileName$$inline_1117$$ = "Not available", $threwError$$inline_1118$$ = $JSCompiler_alias_TRUE$$
        }
        $e$$inline_776$$ = $threwError$$inline_1118$$ || !$opt_exception$$1$$.lineNumber || !$opt_exception$$1$$.fileName || !$opt_exception$$1$$.stack ? {message:$opt_exception$$1$$.message, name:$opt_exception$$1$$.name, lineNumber:$lineNumber$$inline_1116$$, fileName:$fileName$$inline_1117$$, stack:$opt_exception$$1$$.stack || "Not available"} : $opt_exception$$1$$
      }
      $JSCompiler_inline_result$$26$$ = "Message: " + $goog$string$htmlEscape$$($e$$inline_776$$.message) + '\nUrl: <a href="view-source:' + $e$$inline_776$$.fileName + '" target="_new">' + $e$$inline_776$$.fileName + "</a>\nLine: " + $e$$inline_776$$.lineNumber + "\n\nBrowser stack:\n" + $goog$string$htmlEscape$$($e$$inline_776$$.stack + "-> ") + "[end]\n\nJS stack traversal:\n" + $goog$string$htmlEscape$$($goog$debug$getStacktrace$$($opt_fn$$inline_775$$) + "-> ")
    }catch($e2$$inline_777$$) {
      $JSCompiler_inline_result$$26$$ = "Exception trying to expose exception! You win, we lose. " + $e2$$inline_777$$
    }
...
function $goog$debug$LogManager$getLogger$$($name$$70$$) {
  ...
  var $JSCompiler_temp$$4_logger$$inline_783$$;
  if(!($JSCompiler_temp$$4_logger$$inline_783$$ = $goog$debug$LogManager$loggers_$$[$name$$70$$])) {
    $JSCompiler_temp$$4_logger$$inline_783$$ = new $goog$debug$Logger$$($name$$70$$);
    var $lastDotIndex$$inline_784_parentLogger$$inline_786$$ = $name$$70$$.lastIndexOf("."), $leafName$$inline_785$$ = $name$$70$$.substr($lastDotIndex$$inline_784_parentLogger$$inline_786$$ + 1), $lastDotIndex$$inline_784_parentLogger$$inline_786$$ = $goog$debug$LogManager$getLogger$$($name$$70$$.substr(0, $lastDotIndex$$inline_784_parentLogger$$inline_786$$));
    $lastDotIndex$$inline_784_parentLogger$$inline_786$$.$getChildren$()[$leafName$$inline_785$$] = $JSCompiler_temp$$4_logger$$inline_783$$;
    $JSCompiler_temp$$4_logger$$inline_783$$.$parent_$ = $lastDotIndex$$inline_784_parentLogger$$inline_786$$;
    $goog$debug$LogManager$loggers_$$[$name$$70$$] = $JSCompiler_temp$$4_logger$$inline_783$$
  }
  return $JSCompiler_temp$$4_logger$$inline_783$$
}
;function $goog$debug$DebugWindow$$($opt_identifier$$, $opt_prefix$$3$$) {
  ...
  if($JSCompiler_alias_TRUE$$ != this.$isCapturing_$) {
    ...
    $goog$debug$LogManager$initialize$$();
    var $JSCompiler_StaticMethods_addHandler$self$$inline_1130$$ = $goog$debug$LogManager$rootLogger_$$, $handler$$inline_1131$$ = this.$publishHandler_$;
    $JSCompiler_StaticMethods_addHandler$self$$inline_1130$$.$handlers_$ || ($JSCompiler_StaticMethods_addHandler$self$$inline_1130$$.$handlers_$ = []);
    $JSCompiler_StaticMethods_addHandler$self$$inline_1130$$.$handlers_$.push($handler$$inline_1131$$)
  }
...
$JSCompiler_prototypeAlias$$.$addLogRecord$ = function $$JSCompiler_prototypeAlias$$$$addLogRecord$$($logRecord$$8$$) {
  if(!this.$filteredLoggers_$[$logRecord$$8$$.$loggerName_$]) {
    var $JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$ = this.$formatter_$, $className$$inline_797$$;
    switch($logRecord$$8$$.$level_$.value) {
      case $goog$debug$Logger$Level$SHOUT$$.value:
        $className$$inline_797$$ = "dbg-sh";
        break;
      case $goog$debug$Logger$Level$SEVERE$$.value:
        $className$$inline_797$$ = "dbg-sev";
        break;
      case $goog$debug$Logger$Level$WARNING$$.value:
        $className$$inline_797$$ = "dbg-w";
        break;
      case $goog$debug$Logger$Level$INFO$$.value:
        $className$$inline_797$$ = "dbg-i";
        break;
      default:
        $className$$inline_797$$ = "dbg-f"
    }
    var $sb$$inline_798$$ = [];
    $sb$$inline_798$$.push($JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$.$prefix_$, " ");
    if($JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$.$showAbsoluteTime$) {
      var $time$$inline_1134$$ = new Date($logRecord$$8$$.$time_$);
      $sb$$inline_798$$.push("[", $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1134$$.getFullYear() - 2E3) + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1134$$.getMonth() + 1) + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1134$$.getDate()) + " " + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1134$$.getHours()) + ":" + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1134$$.getMinutes()) + ":" + $goog$debug$Formatter$getTwoDigitString_$$($time$$inline_1134$$.getSeconds()) + 
      "." + $goog$debug$Formatter$getTwoDigitString_$$(Math.floor($time$$inline_1134$$.getMilliseconds() / 10)), "] ")
    }
    $JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$.$showRelativeTime$ && $sb$$inline_798$$.push("[", $goog$string$whitespaceEscape$$($goog$debug$Formatter$getRelativeTime_$$($logRecord$$8$$, $JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$.$startTimeProvider_$.get())), "s] ");
    $JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$.$showLoggerName$ && $sb$$inline_798$$.push("[", $goog$string$htmlEscape$$($logRecord$$8$$.$loggerName_$), "] ");
    $JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$.$showSeverityLevel$ && $sb$$inline_798$$.push("[", $goog$string$htmlEscape$$($logRecord$$8$$.$level_$.name), "] ");
    $sb$$inline_798$$.push('<span class="', $className$$inline_797$$, '">', $goog$string$newLineToBr$$($goog$string$whitespaceEscape$$($goog$string$htmlEscape$$($logRecord$$8$$.$msg_$))));
    $JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$.$showExceptionText$ && $logRecord$$8$$.$exception_$ && $sb$$inline_798$$.push("<br>", $goog$string$newLineToBr$$($goog$string$whitespaceEscape$$($logRecord$$8$$.$exceptionText_$ || "")));
    $sb$$inline_798$$.push("</span><br>");
    $JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$ = $sb$$inline_798$$.join("");
    this.$enabled_$ ? ($JSCompiler_StaticMethods_openWindow_$$(this), this.$savedMessages_$.add($JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$), $JSCompiler_StaticMethods_writeToLog_$$(this, $JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$)) : this.$savedMessages_$.add($JSCompiler_StaticMethods_formatRecord$self$$inline_795_html$$inline_801$$);
...
function $JSCompiler_StaticMethods_writeSavedMessages_$$($JSCompiler_StaticMethods_writeSavedMessages_$self$$) {
  for(var $JSCompiler_StaticMethods_getNewestValues$self$$inline_1136_i$$123$$ = $JSCompiler_StaticMethods_writeSavedMessages_$self$$.$savedMessages_$, $l$$inline_1138$$ = $JSCompiler_StaticMethods_getNewestValues$self$$inline_1136_i$$123$$.$buff_$.length, $rv$$inline_1139$$ = [], $i$$inline_1140$$ = $JSCompiler_StaticMethods_getNewestValues$self$$inline_1136_i$$123$$.$buff_$.length - $JSCompiler_StaticMethods_writeSavedMessages_$self$$.$savedMessages_$.$buff_$.length;$i$$inline_1140$$ < $l$$inline_1138$$;$i$$inline_1140$$++) {
    $rv$$inline_1139$$[$i$$inline_1140$$] = $JSCompiler_StaticMethods_getNewestValues$self$$inline_1136_i$$123$$.get($i$$inline_1140$$)
  }
  for($JSCompiler_StaticMethods_getNewestValues$self$$inline_1136_i$$123$$ = 0;$JSCompiler_StaticMethods_getNewestValues$self$$inline_1136_i$$123$$ < $rv$$inline_1139$$.length;$JSCompiler_StaticMethods_getNewestValues$self$$inline_1136_i$$123$$++) {
    $JSCompiler_StaticMethods_writeToLog_$$($JSCompiler_StaticMethods_writeSavedMessages_$self$$, $rv$$inline_1139$$[$JSCompiler_StaticMethods_getNewestValues$self$$inline_1136_i$$123$$])
  }
}
...
function $goog$debug$FancyWindow$$($opt_identifier$$1$$, $opt_prefix$$4$$) {
  if($goog$debug$FancyWindow$HAS_LOCAL_STORE$$) {
    var $logger$$inline_810_loggerName$$inline_809_storedKeys$$inline_807$$ = $goog$debug$FancyWindow$getStoredKeys_$$(), $key$$inline_808$$;
    for($key$$inline_808$$ in $logger$$inline_810_loggerName$$inline_809_storedKeys$$inline_807$$) {
      var $logger$$inline_810_loggerName$$inline_809_storedKeys$$inline_807$$ = $key$$inline_808$$.replace("fancywindow.sel.", ""), $logger$$inline_810_loggerName$$inline_809_storedKeys$$inline_807$$ = $goog$debug$LogManager$getLogger$$($logger$$inline_810_loggerName$$inline_809_storedKeys$$inline_807$$), $curLevel$$inline_811$$ = $logger$$inline_810_loggerName$$inline_809_storedKeys$$inline_807$$.$level_$, $storedLevel$$inline_812$$ = window.localStorage.getItem($key$$inline_808$$).toString();
      (!$curLevel$$inline_811$$ || $curLevel$$inline_811$$.toString() != $storedLevel$$inline_812$$) && $logger$$inline_810_loggerName$$inline_809_storedKeys$$inline_807$$.$setLevel$($goog$debug$Logger$Level$getPredefinedLevel$$($storedLevel$$inline_812$$))
    }
  }
...
$JSCompiler_prototypeAlias$$.$closeOptions_$ = function $$JSCompiler_prototypeAlias$$$$closeOptions_$$() {
  ...
  for(var $loggers$$1_loggers$$inline_816$$ = $goog$debug$FancyWindow$getLoggers_$$(), $dh$$3_storedKeys$$inline_817$$ = this.$dh_$, $i$$127_i$$inline_818$$ = 0;$i$$127_i$$inline_818$$ < $loggers$$1_loggers$$inline_816$$.length;$i$$127_i$$inline_818$$++) {
    var $key$$inline_819_logger$$4$$ = $goog$debug$LogManager$getLogger$$($loggers$$1_loggers$$inline_816$$[$i$$127_i$$inline_818$$]), $level$$18_level$$inline_820_sel$$1$$ = $dh$$3_storedKeys$$inline_817$$.$getElement$("sel" + $loggers$$1_loggers$$inline_816$$[$i$$127_i$$inline_818$$]), $level$$18_level$$inline_820_sel$$1$$ = $level$$18_level$$inline_820_sel$$1$$.options[$level$$18_level$$inline_820_sel$$1$$.selectedIndex].text;
    "INHERIT" == $level$$18_level$$inline_820_sel$$1$$ ? $key$$inline_819_logger$$4$$.$setLevel$($JSCompiler_alias_NULL$$) : $key$$inline_819_logger$$4$$.$setLevel$($goog$debug$Logger$Level$getPredefinedLevel$$($level$$18_level$$inline_820_sel$$1$$))
  }
  if($goog$debug$FancyWindow$HAS_LOCAL_STORE$$) {
    $loggers$$1_loggers$$inline_816$$ = $goog$debug$FancyWindow$getLoggers_$$();
    $dh$$3_storedKeys$$inline_817$$ = $goog$debug$FancyWindow$getStoredKeys_$$();
    for($i$$127_i$$inline_818$$ = 0;$i$$127_i$$inline_818$$ < $loggers$$1_loggers$$inline_816$$.length;$i$$127_i$$inline_818$$++) {
      $key$$inline_819_logger$$4$$ = "fancywindow.sel." + $loggers$$1_loggers$$inline_816$$[$i$$127_i$$inline_818$$], $level$$18_level$$inline_820_sel$$1$$ = $goog$debug$LogManager$getLogger$$($loggers$$1_loggers$$inline_816$$[$i$$127_i$$inline_818$$]).$level_$, $key$$inline_819_logger$$4$$ in $dh$$3_storedKeys$$inline_817$$ ? $level$$18_level$$inline_820_sel$$1$$ ? window.localStorage.getItem($key$$inline_819_logger$$4$$) != $level$$18_level$$inline_820_sel$$1$$.name && window.localStorage.setItem($key$$inline_819_logger$$4$$, 
      $level$$18_level$$inline_820_sel$$1$$.name) : window.localStorage.removeItem($key$$inline_819_logger$$4$$) : $level$$18_level$$inline_820_sel$$1$$ && window.localStorage.setItem($key$$inline_819_logger$$4$$, $level$$18_level$$inline_820_sel$$1$$.name)
    }
  }
  return $JSCompiler_alias_FALSE$$
};
...
function $goog$debug$FancyWindow$getLoggers_$$() {
  var $res$$inline_823$$ = [], $i$$inline_824$$ = 0, $key$$inline_825$$;
  for($key$$inline_825$$ in $goog$debug$LogManager$loggers_$$) {
    $res$$inline_823$$[$i$$inline_824$$++] = $key$$inline_825$$
  }
  $res$$inline_823$$.sort();
  return $res$$inline_823$$
}
